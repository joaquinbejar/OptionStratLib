...
fn test_bull_put_spread_integration() -> Result<(), Box<dyn Error>> {
    ...
    assert_pos_relative_eq!(strategy.get_max_profit()?, pos_or_panic!(143.58), pos_or_panic!(0.0001));
    assert_pos_relative_eq!(strategy.get_total_cost()?, pos_or_panic!(36.12), pos_or_panic!(0.0001));
