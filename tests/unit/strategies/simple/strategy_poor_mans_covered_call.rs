...
fn test_poor_mans_covered_call_integration() -> Result<(), Box<dyn Error>> {
    ...
    assert_pos_relative_eq!(strategy.get_max_profit()?, pos_or_panic!(141.8399), pos_or_panic!(0.0001));
    assert_pos_relative_eq!(strategy.get_max_loss()?, pos_or_panic!(258.16), pos_or_panic!(0.0001));
