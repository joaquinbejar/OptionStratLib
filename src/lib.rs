...
//! # OptionStratLib v0.21.3: Financial Options Library
//!
//! ## Table of Contents
...
//! ```toml
//! [dependencies]
//! optionstratlib = { version = "0.21.3", features = ["plotly"] }
//! ```
//!
...
//! ---
//!
//! **OptionStratLib v0.21.3** - Built with ❤️ in Rust for the financial community
//!
