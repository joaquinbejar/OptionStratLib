...
impl DeltaNeutrality for IronCondor {
    ...
    fn generate_delta_reducing_adjustments(&self) -> Vec<DeltaAdjustment> {
        ...
        vec![
            ...
            DeltaAdjustment::SellOptions {
                quantity: qty_c * self.short_call.option.quantity,
    ...
    fn generate_delta_increasing_adjustments(&self) -> Vec<DeltaAdjustment> {
        ...
        vec![
            ...
            DeltaAdjustment::SellOptions {
                quantity: qty_p * self.short_put.option.quantity,
...
mod tests_iron_condor_delta {
    ...
    fn create_test_reducing_adjustments() {
        ...
        let size = dec!(-0.2124);
        let delta1 = pos!(0.4175977387296559);
        let delta2 = pos!(10.312565341673712647728983917);
        let k1 = pos!(2800.0);
        let k2 = pos!(2560.0);
        assert_decimal_eq!(
    ...
    fn create_test_increasing_adjustments() {
        ...
        let delta1 = pos!(0.3722450887122405);
        let delta2 = pos!(6.6598726493799058);
        let k1 = pos!(2500.0);
        let k2 = pos!(2725.0);
        assert_decimal_eq!(
            strategy.calculate_net_delta().net_delta,
...
mod tests_iron_condor_delta_size {
    ...
    fn create_test_reducing_adjustments() {
        ...
        let delta1 = pos!(0.8293986515885988);
    ...
    fn create_test_increasing_adjustments() {
        ...
        let size = dec!(0.3656);
        let delta1 = pos!(0.7494538055426302);
        let delta2 = pos!(13.074221057885);
        let k1 = pos!(2500.0);
        let k2 = pos!(2725.0);
        assert_decimal_eq!(
            strategy.calculate_net_delta().net_delta,
