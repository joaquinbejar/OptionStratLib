    ...
    match scheme {
        ...
        ColorScheme::Viridis => {
            ...
            let colors = vec![
                ...
                "#3CBB75", "#DCE319", "#404788", "#238A8D", "#55C667", "#FDE725",

                "#46337E", "#1E9C89", "#79D151", "#471365", "#375B8D", "#23A884", "#A1DB32",
                "#45287C", "#307B8E", "#34B778", "#C6DE2F", "#432D7A", "#288A8D", "#42C675",
                "#E3E419", "#3F4889", "#21968A", "#5DC864", "#F0E51B", "#461C74",
            ];
        ...
        ColorScheme::Plasma => {
            ...
            let colors = vec![
                ...
                "#FECE2F", "#7E03A8", "#E16462", "#FCFD35", "#8F0DA4", "#EA7457",

                "#330597", "#B93779", "#F68F46", "#4C02A1", "#CC3F76", "#FBA238", "#6501AB",
                "#DC5267", "#FDC229", "#7B04A7", "#E36159", "#FED330", "#8D0BA2", "#E7704F",
                "#FEE54F", "#9E189B", "#EC7F45", "#FEF06F", "#1C0377", "#AC2294",
            ];
            let color = colors.get(idx % colors.len()).unwrap();
            Some(color.to_string())
        },
        ...
        ColorScheme::HighContrast => {
            let colors = vec![
                ...
                "#FF8C00", "#90EE90", "#ADD8E6", "#FFA07A", "#DA70D6", "#FFD700",

                "#FF1493", "#4B0082", "#006400", "#483D8B", "#CD853F", "#8B4513",
                "#4682B4", "#9ACD32", "#B22222", "#A52A2A", "#6A5ACD", "#778899",
                "#FF6347", "#7CFC00", "#87CEFA", "#FFA500", "#9932CC", "#008B8B",
            ];
            let color = colors.get(idx % colors.len()).unwrap();
            Some(color.to_string())
        },
