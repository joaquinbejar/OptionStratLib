//! `Graph` implementations for the strategies.
//!
//! Every payoff strategy is charted the same way: profit/loss over the
//! strategy's preferred price range, split into positive and negative
//! segments, with a zero line, a marker at the current underlying price
//! and labels at the break-even points. `impl_graph_for_payoff_strategy!`
//! generates that implementation; the invocation at the end of this file
//! covers every concrete strategy. The implementations live here because
