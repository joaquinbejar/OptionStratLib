...
use crate::model::decimal::{d_add, d_div, d_mul, d_sqrt, d_sub, d_sum, finite_decimal, p_sqrt};
...
pub fn constant_volatility(returns: &[Decimal]) -> Result<Positive, VolatilityError> {
    ...
    let std_dev = d_sqrt(variance, "volatility::constant::std_dev").map_err(|_| {
...
pub fn ewma_volatility(
    ...
    let initial_std_dev = d_sqrt(variance, "volatility::ewma::initial_std_dev").map_err(|_| {
        VolatilityError::NumericalFailure {
    ...
    for &return_value in &returns[1..] {
        ...
        let std_dev = d_sqrt(variance, "volatility::ewma::std_dev").map_err(|_| {
            VolatilityError::NumericalFailure {
...
mod tests_implied_volatility {
    ...
    fn test_implied_volatility_zero_dte() {
        ...
        assert_decimal_eq!(vanna, dec!(0.0073826791123684657342819348), dec!(0.0000001));
