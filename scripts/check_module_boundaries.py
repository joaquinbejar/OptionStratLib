...
def self_test() -> int:
    ...
    cases: dict[str, tuple, ] = {
        ...
        "facade may depend on a component": ([("facade/x.rs", "use crate::strategies::Strategy;\n")], 0),
        "a component may not depend on the facade": ([("model/x.rs", "use crate::facade::pricing_engine::PricingEngine;\n")], 1),
