/******************************************************************************
   ...
   Date: 24/12/25
******************************************************************************/
//! Example demonstrating extended delta adjustment functionality for LongButterflySpread.
//!
//! A Long Butterfly Spread is a neutral strategy with limited risk and reward.
...
fn main() -> Result<(), Error> {
    ...
    info!("=== LongButterflySpread Extended Delta Analysis ===");
