/******************************************************************************
   ...
   Date: 24/12/25
******************************************************************************/
//! Example demonstrating extended delta adjustment functionality for ShortButterflySpread.
//!
//! A Short Butterfly Spread profits from large price movements.
...
fn main() -> Result<(), Error> {
    ...
    info!("=== ShortButterflySpread Extended Delta Analysis ===");
