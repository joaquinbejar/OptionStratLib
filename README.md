...
## OptionStratLib v0.21.2: Financial Options Library
...
```toml
[dependencies]
optionstratlib = { version = "0.21.2", features = ["plotly"] }
```
...
**OptionStratLib v0.21.2** - Built with ❤️ in Rust for the financial community
