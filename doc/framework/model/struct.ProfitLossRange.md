...
[[Source](../../src/optionstratlib/model/profit_range.rs.html#16-27){.src}
]{.sub-heading}
::::
...
.field}`lower_bound: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.lower_bound
...
.field}`upper_bound: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.upper_bound
.structfield .section-header}
...
[Source](../../src/optionstratlib/model/profit_range.rs.html#29-183){.src
...
[Source](../../src/optionstratlib/model/profit_range.rs.html#42-59){.src
.rightside}

#### pub fn [new](#method.new){.fn}( lower_bound: [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}\>, upper_bound: [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}\>, probability: [Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> [Result](https://doc.rust-lang.org/1.86.0/core/result/enum.Result.html "enum core::result::Result"){.enum}\<Self, [String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}\> {#pub-fn-new-lower_bound-optionpositive-upper_bound-optionpositive-probability-positive---resultself-string .code-header}
:::
...
[Source](../../src/optionstratlib/model/profit_range.rs.html#115-159){.src
.rightside}

#### pub fn [calculate_probability](#method.calculate_probability){.fn}( &mut self, current_price: [Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, volatility_adj: [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[VolatilityAdjustment](../strategies/probabilities/struct.VolatilityAdjustment.html "struct optionstratlib::strategies::probabilities::VolatilityAdjustment"){.struct}\>, trend: [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[PriceTrend](../strategies/probabilities/struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct}\>, expiration_date: [ExpirationDate](types/enum.ExpirationDate.html "enum optionstratlib::model::types::ExpirationDate"){.enum}, risk_free_rate: [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<Decimal\>, ) -\> [Result](https://doc.rust-lang.org/1.86.0/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[()](https://doc.rust-lang.org/1.86.0/std/primitive.unit.html){.primitive}, [ProbabilityError](../error/probability/enum.ProbabilityError.html "enum optionstratlib::error::probability::ProbabilityError"){.enum}\> {#pub-fn-calculate_probability-mut-self-current_price-positive-volatility_adj-optionvolatilityadjustment-trend-optionpricetrend-expiration_date-expirationdate-risk_free_rate-optiondecimal---result-probabilityerror .code-header}
:::
...
[Source](../../src/optionstratlib/model/profit_range.rs.html#170-182){.src
.rightside}

#### pub fn [contains](#method.contains){.fn}(&self, price: [Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#pub-fn-containsself-price-positive---bool .code-header}
:::
...
[Source](../../src/optionstratlib/model/profit_range.rs.html#15){.src
.rightside}[§](#impl-Clone-for-ProfitLossRange){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-clone-for-profitlossrange .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#fn-cloneself---profitlossrange .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-debug-for-profitlossrange .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-freeze-for-profitlossrange .code-header}
:::

::: {#impl-RefUnwindSafe-for-ProfitLossRange .section .impl}
[§](#impl-RefUnwindSafe-for-ProfitLossRange){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-refunwindsafe-for-profitlossrange .code-header}
:::

::: {#impl-Send-for-ProfitLossRange .section .impl}
[§](#impl-Send-for-ProfitLossRange){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-send-for-profitlossrange .code-header}
:::

::: {#impl-Sync-for-ProfitLossRange .section .impl}
[§](#impl-Sync-for-ProfitLossRange){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-sync-for-profitlossrange .code-header}
:::

::: {#impl-Unpin-for-ProfitLossRange .section .impl}
[§](#impl-Unpin-for-ProfitLossRange){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-unpin-for-profitlossrange .code-header}
:::

::: {#impl-UnwindSafe-for-ProfitLossRange .section .impl}
[§](#impl-UnwindSafe-for-ProfitLossRange){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-unwindsafe-for-profitlossrange .code-header}
:::
:::::::::
