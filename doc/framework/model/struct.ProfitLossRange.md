...
# Struct [ProfitLossRange]{.struct} Copy item path

[[Source](../../src/optionstratlib/model/profit_range.rs.html#20-31){.src}
]{.sub-heading}
::::
...
[[§](#structfield.lower_bound){.anchor
.field}`lower_bound: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.lower_bound
.structfield .section-header}

::: docblock
Lower price boundary of the profitable range None represents negative
infinity
:::

[[§](#structfield.upper_bound){.anchor
.field}`upper_bound: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.upper_bound
.structfield .section-header}

::: docblock
Upper price boundary of the profitable range None represents positive
infinity
:::

[[§](#structfield.probability){.anchor
.field}`probability: `[`Positive`](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.probability
.structfield .section-header}
...
::: {#impl-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#33-192){.src
.rightside}[§](#impl-ProfitLossRange){.anchor}

### impl [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-profitlossrange .code-header}
:::

:::::::::: impl-items
::: {#method.new .section .method}
[Source](../../src/optionstratlib/model/profit_range.rs.html#46-68){.src
.rightside}

#### pub fn [new](#method.new){.fn}( lower_bound: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}\>, upper_bound: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}\>, probability: [Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<Self, [ProbabilityError](../error/probability/enum.ProbabilityError.html "enum optionstratlib::error::probability::ProbabilityError"){.enum}\> {#pub-fn-new-lower_bound-optionpositive-upper_bound-optionpositive-probability-positive---resultself-probabilityerror .code-header}
:::
...
::: {#method.calculate_probability .section .method}
[Source](../../src/optionstratlib/model/profit_range.rs.html#124-168){.src
.rightside}

#### pub fn [calculate_probability](#method.calculate_probability){.fn}( &mut self, current_price: &[Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, volatility_adj: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[VolatilityAdjustment](../strategies/probabilities/struct.VolatilityAdjustment.html "struct optionstratlib::strategies::probabilities::VolatilityAdjustment"){.struct}\>, trend: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[PriceTrend](../strategies/probabilities/struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct}\>, expiration_date: &[ExpirationDate](enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}, risk_free_rate: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}\>, ) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[()](https://doc.rust-lang.org/1.91.1/std/primitive.unit.html){.primitive}, [ProbabilityError](../error/probability/enum.ProbabilityError.html "enum optionstratlib::error::probability::ProbabilityError"){.enum}\> {#pub-fn-calculate_probability-mut-self-current_price-positive-volatility_adj-optionvolatilityadjustment-trend-optionpricetrend-expiration_date-expirationdate-risk_free_rate-optiondecimal---result-probabilityerror .code-header}
:::

:::: docblock
Calculates the probability of an asset's price falling within a
specified range at expiration.

This method computes the probability that the underlying asset's price
will be between the lower and upper bounds of a price range at the
expiration date, based on various market factors and statistical models.

##### [§](#parameters){.doc-anchor}Parameters

- `current_price` - The current market price of the underlying asset.
- `volatility_adj` - Optional adjustment for volatility parameters,
  including base volatility and standard deviation adjustments. If None,
  default volatility settings will be used.
- `trend` - Optional price trend parameters, including drift rate and
  confidence level. If None, no trend assumption will be applied.
- `expiration_date` - The date when the probability calculation applies,
  specified either as days to expiration or an absolute datetime.
- `risk_free_rate` - Optional risk-free interest rate used in
  probability calculations. If None, a default value will be used.

##### [§](#returns-1){.doc-anchor}Returns

- `Result<(), ProbabilityError>` - Returns Ok(()) if the calculation was
  successful, updating the internal probability field. Returns Err with
  a ProbabilityError if the calculation failed, such as due to invalid
  price ranges.
...
- `ProbabilityError::PriceError` - If the lower bound exceeds the upper
  bound.
- Other errors may be propagated from the underlying
  `calculate_single_point_probability` function.
...
::: {#method.contains .section .method}
[Source](../../src/optionstratlib/model/profit_range.rs.html#179-191){.src
.rightside}

#### pub fn [contains](#method.contains){.fn}(&self, price: [Positive](positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#pub-fn-containsself-price-positive---bool .code-header}
:::
...
::: {#impl-Clone-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Clone-for-ProfitLossRange){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-clone-for-profitlossrange .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#fn-cloneself---profitlossrange .code-header}
:::
...
::: {#impl-ComposeSchema-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-ComposeSchema-for-ProfitLossRange){.anchor}

### impl ComposeSchema for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-composeschema-for-profitlossrange .code-header}
:::
...
::: {#impl-Debug-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Debug-for-ProfitLossRange){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-debug-for-profitlossrange .code-header}
:::
...
::: {#impl-Default-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Default-for-ProfitLossRange){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-default-for-profitlossrange .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html#tymethod.default){.fn}() -\> [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#fn-default---profitlossrange .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-ProfitLossRange){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#implde-deserializede-for-profitlossrange .code-header}
:::
...
::: {#impl-Hash-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Hash-for-ProfitLossRange){.anchor}

### impl [Hash](https://doc.rust-lang.org/1.91.1/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-hash-for-profitlossrange .code-header}
:::
...
::: {#impl-Ord-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Ord-for-ProfitLossRange){.anchor}

### impl [Ord](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Ord.html "trait core::cmp::Ord"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-ord-for-profitlossrange .code-header}
:::
...
#### fn [cmp](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Ord.html#tymethod.cmp){.fn}(&self, other: &[ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct}) -\> [Ordering](https://doc.rust-lang.org/1.91.1/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum} {#fn-cmpself-other-profitlossrange---ordering .code-header}
:::
...
::: {#impl-PartialEq-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-PartialEq-for-ProfitLossRange){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-partialeq-for-profitlossrange .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-profitlossrange---bool .code-header}
:::
...
::: {#impl-PartialOrd-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-PartialOrd-for-ProfitLossRange){.anchor}

### impl [PartialOrd](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-partialord-for-profitlossrange .code-header}
:::
...
#### fn [partial_cmp](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp){.fn}(&self, other: &[ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct}) -\> [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Ordering](https://doc.rust-lang.org/1.91.1/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum}\> {#fn-partial_cmpself-other-profitlossrange---optionordering .code-header}
:::
...
::: {#impl-Serialize-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Serialize-for-ProfitLossRange){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-serialize-for-profitlossrange .code-header}
:::
...
::: {#impl-ToSchema-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-ToSchema-for-ProfitLossRange){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-toschema-for-profitlossrange .code-header}
:::
...
::: {#impl-Eq-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-Eq-for-ProfitLossRange){.anchor}

### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-eq-for-profitlossrange .code-header}
:::

::: {#impl-StructuralPartialEq-for-ProfitLossRange .section .impl}
[Source](../../src/optionstratlib/model/profit_range.rs.html#18){.src
.rightside}[§](#impl-StructuralPartialEq-for-ProfitLossRange){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-structuralpartialeq-for-profitlossrange .code-header}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-ProfitLossRange .section .impl}
[§](#impl-Freeze-for-ProfitLossRange){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-freeze-for-profitlossrange .code-header}
:::

::: {#impl-RefUnwindSafe-for-ProfitLossRange .section .impl}
[§](#impl-RefUnwindSafe-for-ProfitLossRange){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-refunwindsafe-for-profitlossrange .code-header}
:::

::: {#impl-Send-for-ProfitLossRange .section .impl}
[§](#impl-Send-for-ProfitLossRange){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-send-for-profitlossrange .code-header}
:::

::: {#impl-Sync-for-ProfitLossRange .section .impl}
[§](#impl-Sync-for-ProfitLossRange){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-sync-for-profitlossrange .code-header}
:::

::: {#impl-Unpin-for-ProfitLossRange .section .impl}
[§](#impl-Unpin-for-ProfitLossRange){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-unpin-for-profitlossrange .code-header}
:::

::: {#impl-UnwindSafe-for-ProfitLossRange .section .impl}
[§](#impl-UnwindSafe-for-ProfitLossRange){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ProfitLossRange](struct.ProfitLossRange.html "struct optionstratlib::model::ProfitLossRange"){.struct} {#impl-unwindsafe-for-profitlossrange .code-header}
:::
:::::::::
