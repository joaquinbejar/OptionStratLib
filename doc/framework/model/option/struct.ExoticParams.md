...
# Struct [ExoticParams]{.struct} Copy item path

[[Source](../../../src/optionstratlib/model/option.rs.html#42-54){.src}
]{.sub-heading}
::::
...
This structure holds specific data required by various exotic option
types such as Asian options (which depend on average prices) and
Lookback options (which depend on minimum/maximum prices during the
option's lifetime).

Each field is optional since different exotic option types require
...
.field}`spot_prices: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>>`]{#structfield.spot_prices
.structfield .section-header}

::: docblock
Historical spot prices, primarily used for Asian options which depend on
the average price of the underlying asset.
:::

[[§](#structfield.spot_min){.anchor
.field}`spot_min: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`>`]{#structfield.spot_min
.structfield .section-header}

::: docblock
Minimum observed spot price during the option's lifetime, used for
lookback option pricing.
:::

[[§](#structfield.spot_max){.anchor
.field}`spot_max: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`>`]{#structfield.spot_max
.structfield .section-header}

::: docblock
Maximum observed spot price during the option's lifetime, used for
lookback option pricing.
:::
...
::: {#impl-Clone-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-Clone-for-ExoticParams){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-clone-for-exoticparams .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#fn-cloneself---exoticparams .code-header}
:::
...
::: {#impl-ComposeSchema-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-ComposeSchema-for-ExoticParams){.anchor}

### impl ComposeSchema for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-composeschema-for-exoticparams .code-header}
:::
...
::: {#impl-Debug-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-Debug-for-ExoticParams){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-debug-for-exoticparams .code-header}
:::
...
::: {#impl-Default-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-Default-for-ExoticParams){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-default-for-exoticparams .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html#tymethod.default){.fn}() -\> [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#fn-default---exoticparams .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-ExoticParams){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#implde-deserializede-for-exoticparams .code-header}
:::
...
::: {#impl-Display-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#67-85){.src
.rightside}[§](#impl-Display-for-ExoticParams){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-display-for-exoticparams .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#68-84){.src
...
::: {#impl-PartialEq-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-PartialEq-for-ExoticParams){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-partialeq-for-exoticparams .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-exoticparams---bool .code-header}
:::
...
::: {#impl-Serialize-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-Serialize-for-ExoticParams){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-serialize-for-exoticparams .code-header}
:::
...
::: {#impl-ToSchema-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-ToSchema-for-ExoticParams){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-toschema-for-exoticparams .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-ExoticParams .section .impl}
[Source](../../../src/optionstratlib/model/option.rs.html#41){.src
.rightside}[§](#impl-StructuralPartialEq-for-ExoticParams){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-structuralpartialeq-for-exoticparams .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-ExoticParams .section .impl}
[§](#impl-Freeze-for-ExoticParams){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-freeze-for-exoticparams .code-header}
:::

::: {#impl-RefUnwindSafe-for-ExoticParams .section .impl}
[§](#impl-RefUnwindSafe-for-ExoticParams){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-refunwindsafe-for-exoticparams .code-header}
:::

::: {#impl-Send-for-ExoticParams .section .impl}
[§](#impl-Send-for-ExoticParams){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-send-for-exoticparams .code-header}
:::

::: {#impl-Sync-for-ExoticParams .section .impl}
[§](#impl-Sync-for-ExoticParams){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-sync-for-exoticparams .code-header}
:::

::: {#impl-Unpin-for-ExoticParams .section .impl}
[§](#impl-Unpin-for-ExoticParams){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-unpin-for-exoticparams .code-header}
:::

::: {#impl-UnwindSafe-for-ExoticParams .section .impl}
[§](#impl-UnwindSafe-for-ExoticParams){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-unwindsafe-for-exoticparams .code-header}
:::
:::::::::
