...
[[Source](../../../src/optionstratlib/model/option.rs.html#36-48){.src}
]{.sub-heading}
::::
...
.field}`spot_prices: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>>`]{#structfield.spot_prices
...
.field}`spot_min: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<Decimal>`]{#structfield.spot_min
.structfield .section-header}
...
.field}`spot_max: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<Decimal>`]{#structfield.spot_max
.structfield .section-header}
...
[Source](../../../src/optionstratlib/model/option.rs.html#35){.src
.rightside}[§](#impl-Clone-for-ExoticParams){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-clone-for-exoticparams .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#fn-cloneself---exoticparams .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-debug-for-exoticparams .code-header}
:::
...
### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-default-for-exoticparams .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html#tymethod.default){.fn}() -\> [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#fn-default---exoticparams .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#implde-deserializede-for-exoticparams .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#69-87){.src
.rightside}[§](#impl-Display-for-ExoticParams){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-display-for-exoticparams .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#70-86){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-partialeq-for-exoticparams .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-serialize-for-exoticparams .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-structuralpartialeq-for-exoticparams .code-header}
:::
::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-freeze-for-exoticparams .code-header}
:::

::: {#impl-RefUnwindSafe-for-ExoticParams .section .impl}
[§](#impl-RefUnwindSafe-for-ExoticParams){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-refunwindsafe-for-exoticparams .code-header}
:::

::: {#impl-Send-for-ExoticParams .section .impl}
[§](#impl-Send-for-ExoticParams){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-send-for-exoticparams .code-header}
:::

::: {#impl-Sync-for-ExoticParams .section .impl}
[§](#impl-Sync-for-ExoticParams){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-sync-for-exoticparams .code-header}
:::

::: {#impl-Unpin-for-ExoticParams .section .impl}
[§](#impl-Unpin-for-ExoticParams){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-unpin-for-exoticparams .code-header}
:::

::: {#impl-UnwindSafe-for-ExoticParams .section .impl}
[§](#impl-UnwindSafe-for-ExoticParams){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ExoticParams](struct.ExoticParams.html "struct optionstratlib::model::option::ExoticParams"){.struct} {#impl-unwindsafe-for-exoticparams .code-header}
:::
:::::::::
