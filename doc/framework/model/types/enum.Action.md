...
[[Source](../../../src/optionstratlib/model/types.rs.html#77-86){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-Clone-for-Action){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-clone-for-action .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#fn-cloneself---action .code-header}
:::
...
::: {#impl-ComposeSchema-for-Action .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-ComposeSchema-for-Action){.anchor}

### impl ComposeSchema for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-composeschema-for-action .code-header}
:::
...
::: {#impl-Debug-for-Action .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-Debug-for-Action){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-debug-for-action .code-header}
:::
...
::: {#impl-Default-for-Action .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-Default-for-Action){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-default-for-action .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html#tymethod.default){.fn}() -\> [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#fn-default---action .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-Action .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-Action){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#implde-deserializede-for-action .code-header}
:::
...
### impl [Hash](https://doc.rust-lang.org/1.91.1/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-hash-for-action .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-partialeq-for-action .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-action---bool .code-header}
:::
...
### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-serialize-for-action .code-header}
:::
...
::: {#impl-ToSchema-for-Action .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#76){.src
.rightside}[§](#impl-ToSchema-for-Action){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-toschema-for-action .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-copy-for-action .code-header}
:::
...
### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-eq-for-action .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-structuralpartialeq-for-action .code-header}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-freeze-for-action .code-header}
:::

::: {#impl-RefUnwindSafe-for-Action .section .impl}
[§](#impl-RefUnwindSafe-for-Action){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-refunwindsafe-for-action .code-header}
:::

::: {#impl-Send-for-Action .section .impl}
[§](#impl-Send-for-Action){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-send-for-action .code-header}
:::

::: {#impl-Sync-for-Action .section .impl}
[§](#impl-Sync-for-Action){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-sync-for-action .code-header}
:::

::: {#impl-Unpin-for-Action .section .impl}
[§](#impl-Unpin-for-Action){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-unpin-for-action .code-header}
:::

::: {#impl-UnwindSafe-for-Action .section .impl}
[§](#impl-UnwindSafe-for-Action){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Action](enum.Action.html "enum optionstratlib::model::types::Action"){.enum} {#impl-unwindsafe-for-action .code-header}
:::
:::::::::
