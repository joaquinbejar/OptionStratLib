...
[[Source](../../../src/optionstratlib/model/types.rs.html#458-466){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#457){.src
.rightside}[§](#impl-Clone-for-Side){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-clone-for-side .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#fn-cloneself---side .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-debug-for-side .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#implde-deserializede-for-side .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#115-122){.src
.rightside}[§](#impl-Display-for-Side){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-display-for-side .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#116-121){.src
...
### impl [Hash](https://doc.rust-lang.org/1.86.0/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-hash-for-side .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-partialeq-for-side .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-side---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-serialize-for-side .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-copy-for-side .code-header}
:::
...
### impl [Eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-eq-for-side .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-structuralpartialeq-for-side .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-freeze-for-side .code-header}
:::

::: {#impl-RefUnwindSafe-for-Side .section .impl}
[§](#impl-RefUnwindSafe-for-Side){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-refunwindsafe-for-side .code-header}
:::

::: {#impl-Send-for-Side .section .impl}
[§](#impl-Send-for-Side){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-send-for-side .code-header}
:::

::: {#impl-Sync-for-Side .section .impl}
[§](#impl-Sync-for-Side){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-sync-for-side .code-header}
:::

::: {#impl-Unpin-for-Side .section .impl}
[§](#impl-Unpin-for-Side){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-unpin-for-side .code-header}
:::

::: {#impl-UnwindSafe-for-Side .section .impl}
[§](#impl-UnwindSafe-for-Side){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-unwindsafe-for-side .code-header}
:::
:::::::::
