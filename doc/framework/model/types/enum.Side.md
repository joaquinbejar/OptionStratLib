...
# Enum [Side]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#97-106){.src}
]{.sub-heading}
::::
...
This enum represents the market sentiment or directional bias of a
position. It indicates whether a trader expects to profit from rising
prices (Long) or falling prices (Short).

`Side` is a fundamental concept in trading that determines how profits
and losses are calculated and affects risk management considerations.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::: variants
::: {#variant.Long .section .variant}
[§](#variant.Long){.anchor}

### Long {#long .code-header}
:::

::: docblock
Represents a position that profits when the underlying asset's price
increases. Long positions involve buying an asset with the expectation
of selling at a higher price.
:::

::: {#variant.Short .section .variant}
[§](#variant.Short){.anchor}

### Short {#short .code-header}
:::

::: docblock
Represents a position that profits when the underlying asset's price
decreases. Short positions involve selling an asset (often borrowed)
with the expectation of buying it back at a lower price.
:::
:::::::
...
::: {#impl-Clone-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Clone-for-Side){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-clone-for-side .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#fn-cloneself---side .code-header}
:::
...
::: {#impl-ComposeSchema-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-ComposeSchema-for-Side){.anchor}

### impl ComposeSchema for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-composeschema-for-side .code-header}
:::
...
::: {#impl-Debug-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#133-140){.src
.rightside}[§](#impl-Debug-for-Side){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-debug-for-side .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#134-139){.src
...
::: {#impl-Default-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Default-for-Side){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-default-for-side .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html#tymethod.default){.fn}() -\> [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#fn-default---side .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-Side){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#implde-deserializede-for-side .code-header}
:::
...
::: {#impl-Display-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#124-131){.src
.rightside}[§](#impl-Display-for-Side){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-display-for-side .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#125-130){.src
...
::: {#impl-Hash-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Hash-for-Side){.anchor}

### impl [Hash](https://doc.rust-lang.org/1.91.1/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-hash-for-side .code-header}
:::
...
::: {#impl-PartialEq-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-PartialEq-for-Side){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-partialeq-for-side .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-side---bool .code-header}
:::
...
::: {#impl-Serialize-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Serialize-for-Side){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-serialize-for-side .code-header}
:::
...
::: {#impl-ToSchema-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-ToSchema-for-Side){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-toschema-for-side .code-header}
:::
...
::: {#impl-Copy-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Copy-for-Side){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-copy-for-side .code-header}
:::

::: {#impl-Eq-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-Eq-for-Side){.anchor}

### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-eq-for-side .code-header}
:::

::: {#impl-StructuralPartialEq-for-Side .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#96){.src
.rightside}[§](#impl-StructuralPartialEq-for-Side){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-structuralpartialeq-for-side .code-header}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-Side .section .impl}
[§](#impl-Freeze-for-Side){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-freeze-for-side .code-header}
:::

::: {#impl-RefUnwindSafe-for-Side .section .impl}
[§](#impl-RefUnwindSafe-for-Side){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-refunwindsafe-for-side .code-header}
:::

::: {#impl-Send-for-Side .section .impl}
[§](#impl-Send-for-Side){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-send-for-side .code-header}
:::

::: {#impl-Sync-for-Side .section .impl}
[§](#impl-Sync-for-Side){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-sync-for-side .code-header}
:::

::: {#impl-Unpin-for-Side .section .impl}
[§](#impl-Unpin-for-Side){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-unpin-for-side .code-header}
:::

::: {#impl-UnwindSafe-for-Side .section .impl}
[§](#impl-UnwindSafe-for-Side){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Side](enum.Side.html "enum optionstratlib::model::types::Side"){.enum} {#impl-unwindsafe-for-side .code-header}
:::
:::::::::
