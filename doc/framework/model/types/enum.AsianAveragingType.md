...
# Enum [AsianAveragingType]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#346-351){.src}
]{.sub-heading}
::::
...
::::::: variants
::: {#variant.Arithmetic .section .variant}
[§](#variant.Arithmetic){.anchor}

### Arithmetic {#arithmetic .code-header}
:::
...
::: {#variant.Geometric .section .variant}
[§](#variant.Geometric){.anchor}

### Geometric {#geometric .code-header}
:::

::: docblock
Geometric averaging takes the nth root of the product of n observed
prices.
:::
:::::::
...
::: {#impl-Clone-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-Clone-for-AsianAveragingType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-clone-for-asianaveragingtype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#fn-cloneself---asianaveragingtype .code-header}
:::
...
::: {#impl-ComposeSchema-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-ComposeSchema-for-AsianAveragingType){.anchor}

### impl ComposeSchema for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-composeschema-for-asianaveragingtype .code-header}
:::
...
::: {#impl-Debug-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-Debug-for-AsianAveragingType){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-debug-for-asianaveragingtype .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-AsianAveragingType){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#implde-deserializede-for-asianaveragingtype .code-header}
:::
...
::: {#impl-Display-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#210-217){.src
.rightside}[§](#impl-Display-for-AsianAveragingType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-display-for-asianaveragingtype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#211-216){.src
...
::: {#impl-PartialEq-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-PartialEq-for-AsianAveragingType){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-partialeq-for-asianaveragingtype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-asianaveragingtype---bool .code-header}
:::
...
::: {#impl-Serialize-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-Serialize-for-AsianAveragingType){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-serialize-for-asianaveragingtype .code-header}
:::
...
::: {#impl-ToSchema-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-ToSchema-for-AsianAveragingType){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-toschema-for-asianaveragingtype .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-AsianAveragingType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#345){.src
.rightside}[§](#impl-StructuralPartialEq-for-AsianAveragingType){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-structuralpartialeq-for-asianaveragingtype .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-AsianAveragingType .section .impl}
[§](#impl-Freeze-for-AsianAveragingType){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-freeze-for-asianaveragingtype .code-header}
:::

::: {#impl-RefUnwindSafe-for-AsianAveragingType .section .impl}
[§](#impl-RefUnwindSafe-for-AsianAveragingType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-refunwindsafe-for-asianaveragingtype .code-header}
:::

::: {#impl-Send-for-AsianAveragingType .section .impl}
[§](#impl-Send-for-AsianAveragingType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-send-for-asianaveragingtype .code-header}
:::

::: {#impl-Sync-for-AsianAveragingType .section .impl}
[§](#impl-Sync-for-AsianAveragingType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-sync-for-asianaveragingtype .code-header}
:::

::: {#impl-Unpin-for-AsianAveragingType .section .impl}
[§](#impl-Unpin-for-AsianAveragingType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-unpin-for-asianaveragingtype .code-header}
:::

::: {#impl-UnwindSafe-for-AsianAveragingType .section .impl}
[§](#impl-UnwindSafe-for-AsianAveragingType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-unwindsafe-for-asianaveragingtype .code-header}
:::
:::::::::
