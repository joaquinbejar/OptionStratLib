...
[[Source](../../../src/optionstratlib/model/types.rs.html#612-619){.src}
]{.sub-heading}
::::
...
::: docblock
Arithmetic averaging calculates the average of the prices in a
straightforward manner. This is the most common type of averaging for
Asian options.
:::
...
This can be less sensitive to extreme values compared to arithmetic
averaging.
:::
:::::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#611){.src
.rightside}[§](#impl-Clone-for-AsianAveragingType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-clone-for-asianaveragingtype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#fn-cloneself---asianaveragingtype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-debug-for-asianaveragingtype .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#implde-deserializede-for-asianaveragingtype .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#202-209){.src
.rightside}[§](#impl-Display-for-AsianAveragingType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-display-for-asianaveragingtype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#203-208){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-partialeq-for-asianaveragingtype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-asianaveragingtype---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-serialize-for-asianaveragingtype .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-freeze-for-asianaveragingtype .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-send-for-asianaveragingtype .code-header}
:::

::: {#impl-Sync-for-AsianAveragingType .section .impl}
[§](#impl-Sync-for-AsianAveragingType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-sync-for-asianaveragingtype .code-header}
:::

::: {#impl-Unpin-for-AsianAveragingType .section .impl}
[§](#impl-Unpin-for-AsianAveragingType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-unpin-for-asianaveragingtype .code-header}
:::

::: {#impl-UnwindSafe-for-AsianAveragingType .section .impl}
[§](#impl-UnwindSafe-for-AsianAveragingType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [AsianAveragingType](enum.AsianAveragingType.html "enum optionstratlib::model::types::AsianAveragingType"){.enum} {#impl-unwindsafe-for-asianaveragingtype .code-header}
:::
:::::::::
