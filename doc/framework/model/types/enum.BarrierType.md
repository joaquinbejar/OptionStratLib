...
[[Source](../../../src/optionstratlib/model/types.rs.html#624-633){.src}
]{.sub-heading}
::::
...
::: docblock
The option becomes active only if the underlying asset price goes above
a certain level.
:::
...
::: docblock
The option becomes active only if the underlying asset price goes below
a certain level.
:::
...
[Source](../../../src/optionstratlib/model/types.rs.html#623){.src
.rightside}[§](#impl-Clone-for-BarrierType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-clone-for-barriertype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#fn-cloneself---barriertype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-debug-for-barriertype .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#implde-deserializede-for-barriertype .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#211-220){.src
.rightside}[§](#impl-Display-for-BarrierType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-display-for-barriertype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#212-219){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-partialeq-for-barriertype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-barriertype---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-serialize-for-barriertype .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-structuralpartialeq-for-barriertype .code-header}
:::
::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-freeze-for-barriertype .code-header}
:::

::: {#impl-RefUnwindSafe-for-BarrierType .section .impl}
[§](#impl-RefUnwindSafe-for-BarrierType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-refunwindsafe-for-barriertype .code-header}
:::

::: {#impl-Send-for-BarrierType .section .impl}
[§](#impl-Send-for-BarrierType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-send-for-barriertype .code-header}
:::

::: {#impl-Sync-for-BarrierType .section .impl}
[§](#impl-Sync-for-BarrierType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-sync-for-barriertype .code-header}
:::

::: {#impl-Unpin-for-BarrierType .section .impl}
[§](#impl-Unpin-for-BarrierType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-unpin-for-barriertype .code-header}
:::

::: {#impl-UnwindSafe-for-BarrierType .section .impl}
[§](#impl-UnwindSafe-for-BarrierType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-unwindsafe-for-barriertype .code-header}
:::
:::::::::
