...
# Enum [BarrierType]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#355-364){.src}
]{.sub-heading}
::::
...
::::::::::: variants
::: {#variant.UpAndIn .section .variant}
[§](#variant.UpAndIn){.anchor}

### UpAndIn {#upandin .code-header}
:::

::: docblock
The option becomes active if the underlying asset price goes above a
certain level.
:::

::: {#variant.UpAndOut .section .variant}
[§](#variant.UpAndOut){.anchor}

### UpAndOut {#upandout .code-header}
:::

::: docblock
The option becomes inactive if the underlying asset price goes above a
certain level.
:::

::: {#variant.DownAndIn .section .variant}
[§](#variant.DownAndIn){.anchor}

### DownAndIn {#downandin .code-header}
:::

::: docblock
The option becomes active if the underlying asset price goes below a
certain level.
:::

::: {#variant.DownAndOut .section .variant}
[§](#variant.DownAndOut){.anchor}

### DownAndOut {#downandout .code-header}
:::

::: docblock
The option becomes inactive if the underlying asset price goes below a
certain level.
:::
:::::::::::
...
::: {#impl-Clone-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-Clone-for-BarrierType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-clone-for-barriertype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#fn-cloneself---barriertype .code-header}
:::
...
::: {#impl-ComposeSchema-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-ComposeSchema-for-BarrierType){.anchor}

### impl ComposeSchema for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-composeschema-for-barriertype .code-header}
:::
...
::: {#impl-Debug-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-Debug-for-BarrierType){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-debug-for-barriertype .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-BarrierType){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#implde-deserializede-for-barriertype .code-header}
:::
...
::: {#impl-Display-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#219-228){.src
.rightside}[§](#impl-Display-for-BarrierType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-display-for-barriertype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#220-227){.src
...
::: {#impl-PartialEq-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-PartialEq-for-BarrierType){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-partialeq-for-barriertype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-barriertype---bool .code-header}
:::
...
::: {#impl-Serialize-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-Serialize-for-BarrierType){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-serialize-for-barriertype .code-header}
:::
...
::: {#impl-ToSchema-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-ToSchema-for-BarrierType){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-toschema-for-barriertype .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-BarrierType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#354){.src
.rightside}[§](#impl-StructuralPartialEq-for-BarrierType){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-structuralpartialeq-for-barriertype .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-BarrierType .section .impl}
[§](#impl-Freeze-for-BarrierType){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-freeze-for-barriertype .code-header}
:::

::: {#impl-RefUnwindSafe-for-BarrierType .section .impl}
[§](#impl-RefUnwindSafe-for-BarrierType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-refunwindsafe-for-barriertype .code-header}
:::

::: {#impl-Send-for-BarrierType .section .impl}
[§](#impl-Send-for-BarrierType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-send-for-barriertype .code-header}
:::

::: {#impl-Sync-for-BarrierType .section .impl}
[§](#impl-Sync-for-BarrierType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-sync-for-barriertype .code-header}
:::

::: {#impl-Unpin-for-BarrierType .section .impl}
[§](#impl-Unpin-for-BarrierType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-unpin-for-barriertype .code-header}
:::

::: {#impl-UnwindSafe-for-BarrierType .section .impl}
[§](#impl-UnwindSafe-for-BarrierType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BarrierType](enum.BarrierType.html "enum optionstratlib::model::types::BarrierType"){.enum} {#impl-unwindsafe-for-barriertype .code-header}
:::
:::::::::
