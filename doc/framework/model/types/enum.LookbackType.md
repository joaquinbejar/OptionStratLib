...
# Enum [LookbackType]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#391-396){.src}
]{.sub-heading}
::::
...
::::::: variants
::: {#variant.FixedStrike .section .variant}
[§](#variant.FixedStrike){.anchor}

### FixedStrike {#fixedstrike .code-header}
:::

::: docblock
The strike price is fixed at the beginning, and the payoff is based on
the maximum or minimum price of the underlying asset during the option's
life.
:::

::: {#variant.FloatingStrike .section .variant}
[§](#variant.FloatingStrike){.anchor}

### FloatingStrike {#floatingstrike .code-header}
:::
...
::: {#impl-Clone-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-Clone-for-LookbackType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-clone-for-lookbacktype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#fn-cloneself---lookbacktype .code-header}
:::
...
::: {#impl-ComposeSchema-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-ComposeSchema-for-LookbackType){.anchor}

### impl ComposeSchema for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-composeschema-for-lookbacktype .code-header}
:::
...
::: {#impl-Debug-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-Debug-for-LookbackType){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-debug-for-lookbacktype .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-LookbackType){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#implde-deserializede-for-lookbacktype .code-header}
:::
...
::: {#impl-Display-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#240-247){.src
.rightside}[§](#impl-Display-for-LookbackType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-display-for-lookbacktype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#241-246){.src
...
::: {#impl-PartialEq-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-PartialEq-for-LookbackType){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-partialeq-for-lookbacktype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-lookbacktype---bool .code-header}
:::
...
::: {#impl-Serialize-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-Serialize-for-LookbackType){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-serialize-for-lookbacktype .code-header}
:::
...
::: {#impl-ToSchema-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-ToSchema-for-LookbackType){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-toschema-for-lookbacktype .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-LookbackType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#390){.src
.rightside}[§](#impl-StructuralPartialEq-for-LookbackType){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-structuralpartialeq-for-lookbacktype .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-LookbackType .section .impl}
[§](#impl-Freeze-for-LookbackType){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-freeze-for-lookbacktype .code-header}
:::

::: {#impl-RefUnwindSafe-for-LookbackType .section .impl}
[§](#impl-RefUnwindSafe-for-LookbackType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-refunwindsafe-for-lookbacktype .code-header}
:::

::: {#impl-Send-for-LookbackType .section .impl}
[§](#impl-Send-for-LookbackType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-send-for-lookbacktype .code-header}
:::

::: {#impl-Sync-for-LookbackType .section .impl}
[§](#impl-Sync-for-LookbackType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-sync-for-lookbacktype .code-header}
:::

::: {#impl-Unpin-for-LookbackType .section .impl}
[§](#impl-Unpin-for-LookbackType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-unpin-for-lookbacktype .code-header}
:::

::: {#impl-UnwindSafe-for-LookbackType .section .impl}
[§](#impl-UnwindSafe-for-LookbackType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-unwindsafe-for-lookbacktype .code-header}
:::
:::::::::
