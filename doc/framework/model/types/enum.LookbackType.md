...
[[Source](../../../src/optionstratlib/model/types.rs.html#648-653){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#647){.src
.rightside}[§](#impl-Clone-for-LookbackType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-clone-for-lookbacktype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#fn-cloneself---lookbacktype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-debug-for-lookbacktype .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#implde-deserializede-for-lookbacktype .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#231-238){.src
.rightside}[§](#impl-Display-for-LookbackType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-display-for-lookbacktype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#232-237){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-partialeq-for-lookbacktype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-lookbacktype---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-serialize-for-lookbacktype .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-structuralpartialeq-for-lookbacktype .code-header}
:::
::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-freeze-for-lookbacktype .code-header}
:::

::: {#impl-RefUnwindSafe-for-LookbackType .section .impl}
[§](#impl-RefUnwindSafe-for-LookbackType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-refunwindsafe-for-lookbacktype .code-header}
:::

::: {#impl-Send-for-LookbackType .section .impl}
[§](#impl-Send-for-LookbackType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-send-for-lookbacktype .code-header}
:::

::: {#impl-Sync-for-LookbackType .section .impl}
[§](#impl-Sync-for-LookbackType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-sync-for-lookbacktype .code-header}
:::

::: {#impl-Unpin-for-LookbackType .section .impl}
[§](#impl-Unpin-for-LookbackType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-unpin-for-lookbacktype .code-header}
:::

::: {#impl-UnwindSafe-for-LookbackType .section .impl}
[§](#impl-UnwindSafe-for-LookbackType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [LookbackType](enum.LookbackType.html "enum optionstratlib::model::types::LookbackType"){.enum} {#impl-unwindsafe-for-lookbacktype .code-header}
:::
:::::::::
