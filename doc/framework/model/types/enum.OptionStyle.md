...
[[Source](../../../src/optionstratlib/model/types.rs.html#477-486){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#476){.src
.rightside}[§](#impl-Clone-for-OptionStyle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-clone-for-optionstyle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#fn-cloneself---optionstyle .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-debug-for-optionstyle .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#implde-deserializede-for-optionstyle .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-display-for-optionstyle .code-header}
:::
...
### impl [Hash](https://doc.rust-lang.org/1.86.0/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-hash-for-optionstyle .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-partialeq-for-optionstyle .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-optionstyle---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-serialize-for-optionstyle .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-copy-for-optionstyle .code-header}
:::
...
### impl [Eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-eq-for-optionstyle .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-structuralpartialeq-for-optionstyle .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-freeze-for-optionstyle .code-header}
:::

::: {#impl-RefUnwindSafe-for-OptionStyle .section .impl}
[§](#impl-RefUnwindSafe-for-OptionStyle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-refunwindsafe-for-optionstyle .code-header}
:::

::: {#impl-Send-for-OptionStyle .section .impl}
[§](#impl-Send-for-OptionStyle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-send-for-optionstyle .code-header}
:::

::: {#impl-Sync-for-OptionStyle .section .impl}
[§](#impl-Sync-for-OptionStyle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-sync-for-optionstyle .code-header}
:::

::: {#impl-Unpin-for-OptionStyle .section .impl}
[§](#impl-Unpin-for-OptionStyle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-unpin-for-optionstyle .code-header}
:::

::: {#impl-UnwindSafe-for-OptionStyle .section .impl}
[§](#impl-UnwindSafe-for-OptionStyle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-unwindsafe-for-optionstyle .code-header}
:::
:::::::::
