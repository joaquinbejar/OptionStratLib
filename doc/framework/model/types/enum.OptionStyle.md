...
# Enum [OptionStyle]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#119-129){.src}
]{.sub-heading}
::::
...
This enum defines the fundamental classification of options contracts
based on their exercise characteristics. The style determines when and
how an option can be exercised.

`OptionStyle` is a critical attribute for options contracts as it
directly affects valuation, pricing models, and exercise strategies.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::: variants
::: {#variant.Call .section .variant}
[§](#variant.Call){.anchor}

### Call {#call .code-header}
:::

::: docblock
Represents a call option, which gives the holder the right (but not
obligation) to buy the underlying asset at the strike price before or at
expiration. Call options typically increase in value when the underlying
asset price rises.
:::

::: {#variant.Put .section .variant}
[§](#variant.Put){.anchor}
...
::: docblock
Represents a put option, which gives the holder the right (but not
obligation) to sell the underlying asset at the strike price before or
at expiration. Put options typically increase in value when the
...
::: {#impl-Clone-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Clone-for-OptionStyle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-clone-for-optionstyle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#fn-cloneself---optionstyle .code-header}
:::
...
::: {#impl-ComposeSchema-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-ComposeSchema-for-OptionStyle){.anchor}

### impl ComposeSchema for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-composeschema-for-optionstyle .code-header}
:::
...
::: {#impl-Debug-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#151-158){.src
.rightside}[§](#impl-Debug-for-OptionStyle){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-debug-for-optionstyle .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#152-157){.src
...
::: {#impl-Default-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Default-for-OptionStyle){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-default-for-optionstyle .code-header}
:::
...
#### fn [default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html#tymethod.default){.fn}() -\> [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#fn-default---optionstyle .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-OptionStyle){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#implde-deserializede-for-optionstyle .code-header}
:::
...
::: {#impl-Display-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#142-149){.src
.rightside}[§](#impl-Display-for-OptionStyle){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-display-for-optionstyle .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#143-148){.src
...
::: {#impl-Hash-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Hash-for-OptionStyle){.anchor}

### impl [Hash](https://doc.rust-lang.org/1.91.1/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-hash-for-optionstyle .code-header}
:::
...
::: {#impl-Ord-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Ord-for-OptionStyle){.anchor}

### impl [Ord](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Ord.html "trait core::cmp::Ord"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-ord-for-optionstyle .code-header}
:::
...
#### fn [cmp](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Ord.html#tymethod.cmp){.fn}(&self, other: &[OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}) -\> [Ordering](https://doc.rust-lang.org/1.91.1/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum} {#fn-cmpself-other-optionstyle---ordering .code-header}
:::
...
::: {#impl-PartialEq-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-PartialEq-for-OptionStyle){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-partialeq-for-optionstyle .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-optionstyle---bool .code-header}
:::
...
::: {#impl-PartialOrd-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-PartialOrd-for-OptionStyle){.anchor}

### impl [PartialOrd](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-partialord-for-optionstyle .code-header}
:::
...
#### fn [partial_cmp](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp){.fn}(&self, other: &[OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}) -\> [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Ordering](https://doc.rust-lang.org/1.91.1/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum}\> {#fn-partial_cmpself-other-optionstyle---optionordering .code-header}
:::
...
::: {#impl-Serialize-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Serialize-for-OptionStyle){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-serialize-for-optionstyle .code-header}
:::
...
::: {#impl-ToSchema-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-ToSchema-for-OptionStyle){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-toschema-for-optionstyle .code-header}
:::
...
::: {#impl-Copy-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Copy-for-OptionStyle){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-copy-for-optionstyle .code-header}
:::

::: {#impl-Eq-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-Eq-for-OptionStyle){.anchor}

### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-eq-for-optionstyle .code-header}
:::

::: {#impl-StructuralPartialEq-for-OptionStyle .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#117){.src
.rightside}[§](#impl-StructuralPartialEq-for-OptionStyle){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-structuralpartialeq-for-optionstyle .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-OptionStyle .section .impl}
[§](#impl-Freeze-for-OptionStyle){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-freeze-for-optionstyle .code-header}
:::

::: {#impl-RefUnwindSafe-for-OptionStyle .section .impl}
[§](#impl-RefUnwindSafe-for-OptionStyle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-refunwindsafe-for-optionstyle .code-header}
:::

::: {#impl-Send-for-OptionStyle .section .impl}
[§](#impl-Send-for-OptionStyle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-send-for-optionstyle .code-header}
:::

::: {#impl-Sync-for-OptionStyle .section .impl}
[§](#impl-Sync-for-OptionStyle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-sync-for-optionstyle .code-header}
:::

::: {#impl-Unpin-for-OptionStyle .section .impl}
[§](#impl-Unpin-for-OptionStyle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-unpin-for-optionstyle .code-header}
:::

::: {#impl-UnwindSafe-for-OptionStyle .section .impl}
[§](#impl-UnwindSafe-for-OptionStyle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptionStyle](enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum} {#impl-unwindsafe-for-optionstyle .code-header}
:::
:::::::::
