...
# Enum [BinaryType]{.enum} Copy item path

[[Source](../../../src/optionstratlib/model/types.rs.html#380-387){.src}
]{.sub-heading}
::::
...
- `CashOrNothing`: The option pays a fixed cash amount if the underlying
  asset's value is above or below a predefined level.

- `AssetOrNothing`: The option pays the value of the underlying asset
  itself if the underlying asset's price is above or below a predefined
  level.

- `Gap`: Pays out based on how far the underlying asset price is above
  the strike price at expiration. The payout is proportional to the
...
::::::::: variants
::: {#variant.CashOrNothing .section .variant}
[§](#variant.CashOrNothing){.anchor}

### CashOrNothing {#cashornothing .code-header}
:::
...
::: {#variant.AssetOrNothing .section .variant}
[§](#variant.AssetOrNothing){.anchor}

### AssetOrNothing {#assetornothing .code-header}
:::

::: docblock
The option pays the value of the underlying asset if it is above or
below a certain level.
:::

::: {#variant.Gap .section .variant}
[§](#variant.Gap){.anchor}
...
expiration, with the payout proportional to how far above the strike it
is.
:::
:::::::::
...
::: {#impl-Clone-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-Clone-for-BinaryType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-clone-for-binarytype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#fn-cloneself---binarytype .code-header}
:::
...
::: {#impl-ComposeSchema-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-ComposeSchema-for-BinaryType){.anchor}

### impl ComposeSchema for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-composeschema-for-binarytype .code-header}
:::
...
::: {#impl-Debug-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-Debug-for-BinaryType){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-debug-for-binarytype .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-BinaryType){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#implde-deserializede-for-binarytype .code-header}
:::
...
::: {#impl-Display-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/format.rs.html#230-238){.src
.rightside}[§](#impl-Display-for-BinaryType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-display-for-binarytype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#231-237){.src
...
::: {#impl-PartialEq-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-PartialEq-for-BinaryType){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-partialeq-for-binarytype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-binarytype---bool .code-header}
:::
...
::: {#impl-Serialize-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-Serialize-for-BinaryType){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-serialize-for-binarytype .code-header}
:::
...
::: {#impl-ToSchema-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-ToSchema-for-BinaryType){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-toschema-for-binarytype .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-BinaryType .section .impl}
[Source](../../../src/optionstratlib/model/types.rs.html#379){.src
.rightside}[§](#impl-StructuralPartialEq-for-BinaryType){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-structuralpartialeq-for-binarytype .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-BinaryType .section .impl}
[§](#impl-Freeze-for-BinaryType){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-freeze-for-binarytype .code-header}
:::

::: {#impl-RefUnwindSafe-for-BinaryType .section .impl}
[§](#impl-RefUnwindSafe-for-BinaryType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-refunwindsafe-for-binarytype .code-header}
:::

::: {#impl-Send-for-BinaryType .section .impl}
[§](#impl-Send-for-BinaryType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-send-for-binarytype .code-header}
:::

::: {#impl-Sync-for-BinaryType .section .impl}
[§](#impl-Sync-for-BinaryType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-sync-for-binarytype .code-header}
:::

::: {#impl-Unpin-for-BinaryType .section .impl}
[§](#impl-Unpin-for-BinaryType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-unpin-for-binarytype .code-header}
:::

::: {#impl-UnwindSafe-for-BinaryType .section .impl}
[§](#impl-UnwindSafe-for-BinaryType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-unwindsafe-for-binarytype .code-header}
:::
:::::::::
