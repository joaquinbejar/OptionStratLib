...
[[Source](../../../src/optionstratlib/model/types.rs.html#638-643){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/model/types.rs.html#637){.src
.rightside}[§](#impl-Clone-for-BinaryType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-clone-for-binarytype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#fn-cloneself---binarytype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-debug-for-binarytype .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#implde-deserializede-for-binarytype .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#222-229){.src
.rightside}[§](#impl-Display-for-BinaryType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-display-for-binarytype .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#223-228){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-partialeq-for-binarytype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-binarytype---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-serialize-for-binarytype .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-structuralpartialeq-for-binarytype .code-header}
:::
::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-freeze-for-binarytype .code-header}
:::

::: {#impl-RefUnwindSafe-for-BinaryType .section .impl}
[§](#impl-RefUnwindSafe-for-BinaryType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-refunwindsafe-for-binarytype .code-header}
:::

::: {#impl-Send-for-BinaryType .section .impl}
[§](#impl-Send-for-BinaryType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-send-for-binarytype .code-header}
:::

::: {#impl-Sync-for-BinaryType .section .impl}
[§](#impl-Sync-for-BinaryType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-sync-for-binarytype .code-header}
:::

::: {#impl-Unpin-for-BinaryType .section .impl}
[§](#impl-Unpin-for-BinaryType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-unpin-for-binarytype .code-header}
:::

::: {#impl-UnwindSafe-for-BinaryType .section .impl}
[§](#impl-UnwindSafe-for-BinaryType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BinaryType](enum.BinaryType.html "enum optionstratlib::model::types::BinaryType"){.enum} {#impl-unwindsafe-for-binarytype .code-header}
:::
:::::::::
