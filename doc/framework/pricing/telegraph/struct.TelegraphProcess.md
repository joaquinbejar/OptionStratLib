...
# Struct [TelegraphProcess]{.struct} Copy item path

[[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#104-116){.src}
]{.sub-heading}
::::

``` {.rust .item-decl}
pub struct TelegraphProcess { /* private fields */ }
```

Expand description

::: docblock
Represents a Telegraph Process, a two-state continuous-time Markov chain
model used to simulate stochastic processes with discrete state
transitions.

The Telegraph Process alternates between two states (-1 and +1),
modeling regime switches or market sentiment changes. State transitions
are governed by Poisson processes with specified rates. This model is
particularly useful for simulating financial markets that exhibit
...
::: {#impl-TelegraphProcess .section .impl}
[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#118-175){.src
.rightside}[§](#impl-TelegraphProcess){.anchor}

### impl [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-telegraphprocess .code-header}
:::

::::::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#129-136){.src
.rightside}

#### pub fn [new](#method.new){.fn}(lambda_up: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, lambda_down: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}) -\> Self {#pub-fn-newlambda_up-decimal-lambda_down-decimal---self .code-header}
:::
...
::: {#method.next_state .section .method}
[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#147-165){.src
.rightside}

#### pub fn [next_state](#method.next_state){.fn}(&mut self, dt: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}) -\> [i8](https://doc.rust-lang.org/1.91.1/std/primitive.i8.html){.primitive} {#pub-fn-next_statemut-self-dt-decimal---i8 .code-header}
:::
...
::: {#method.get_current_state .section .method}
[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#172-174){.src
.rightside}

#### pub fn [get_current_state](#method.get_current_state){.fn}(&self) -\> [i8](https://doc.rust-lang.org/1.91.1/std/primitive.i8.html){.primitive} {#pub-fn-get_current_stateself---i8 .code-header}
:::
...
::: {#impl-Clone-for-TelegraphProcess .section .impl}
[Source](../../../src/optionstratlib/pricing/telegraph.rs.html#103){.src
.rightside}[§](#impl-Clone-for-TelegraphProcess){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-clone-for-telegraphprocess .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#fn-cloneself---telegraphprocess .code-header}
:::
...
::: {#impl-Freeze-for-TelegraphProcess .section .impl}
[§](#impl-Freeze-for-TelegraphProcess){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-freeze-for-telegraphprocess .code-header}
:::

::: {#impl-RefUnwindSafe-for-TelegraphProcess .section .impl}
[§](#impl-RefUnwindSafe-for-TelegraphProcess){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-refunwindsafe-for-telegraphprocess .code-header}
:::

::: {#impl-Send-for-TelegraphProcess .section .impl}
[§](#impl-Send-for-TelegraphProcess){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-send-for-telegraphprocess .code-header}
:::

::: {#impl-Sync-for-TelegraphProcess .section .impl}
[§](#impl-Sync-for-TelegraphProcess){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-sync-for-telegraphprocess .code-header}
:::

::: {#impl-Unpin-for-TelegraphProcess .section .impl}
[§](#impl-Unpin-for-TelegraphProcess){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-unpin-for-telegraphprocess .code-header}
:::

::: {#impl-UnwindSafe-for-TelegraphProcess .section .impl}
[§](#impl-UnwindSafe-for-TelegraphProcess){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-unwindsafe-for-telegraphprocess .code-header}
:::
:::::::::
