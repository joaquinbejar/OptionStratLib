...
#### pub fn [new](#method.new){.fn}(lambda_up: Decimal, lambda_down: Decimal) -\> Self {#pub-fn-newlambda_up-decimal-lambda_down-decimal---self .code-header}
:::
...
#### pub fn [next_state](#method.next_state){.fn}(&mut self, dt: Decimal) -\> [i8](https://doc.rust-lang.org/1.86.0/std/primitive.i8.html){.primitive} {#pub-fn-next_statemut-self-dt-decimal---i8 .code-header}
:::
...
#### pub fn [get_current_state](#method.get_current_state){.fn}(&self) -\> [i8](https://doc.rust-lang.org/1.86.0/std/primitive.i8.html){.primitive} {#pub-fn-get_current_stateself---i8 .code-header}
:::
...
### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-clone-for-telegraphprocess .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#fn-cloneself---telegraphprocess .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-freeze-for-telegraphprocess .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-send-for-telegraphprocess .code-header}
:::

::: {#impl-Sync-for-TelegraphProcess .section .impl}
[§](#impl-Sync-for-TelegraphProcess){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-sync-for-telegraphprocess .code-header}
:::

::: {#impl-Unpin-for-TelegraphProcess .section .impl}
[§](#impl-Unpin-for-TelegraphProcess){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-unpin-for-telegraphprocess .code-header}
:::

::: {#impl-UnwindSafe-for-TelegraphProcess .section .impl}
[§](#impl-UnwindSafe-for-TelegraphProcess){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TelegraphProcess](struct.TelegraphProcess.html "struct optionstratlib::pricing::telegraph::TelegraphProcess"){.struct} {#impl-unwindsafe-for-telegraphprocess .code-header}
:::
:::::::::
