...
.field}`int_rate: Decimal`]{#structfield.int_rate .structfield
.section-header}
...
.field}`no_steps: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#structfield.no_steps
.structfield .section-header}
...
### impl\<\'a\> [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-clone-for-binomialpricingparamsa .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#fn-cloneself---binomialpricingparamsa .code-header}
:::
...
### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-freeze-for-binomialpricingparamsa .code-header}
:::
...
### impl\<\'a\> [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-send-for-binomialpricingparamsa .code-header}
:::

::: {#impl-Sync-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Sync-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-sync-for-binomialpricingparamsa .code-header}
:::

::: {#impl-Unpin-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Unpin-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-unpin-for-binomialpricingparamsa .code-header}
:::

::: {#impl-UnwindSafe-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-unwindsafe-for-binomialpricingparamsa .code-header}
:::
:::::::::
