...
# Struct [BinomialPricingParams]{.struct} Copy item path

[[Source](../../../src/optionstratlib/pricing/binomial_model.rs.html#22-54){.src}
]{.sub-heading}
::::
...
This structure encapsulates all the necessary parameters required to
calculate the price of an option using the binomial pricing model. The
binomial model is a discrete-time, lattice-based approach to option
pricing that can handle various option types and styles.

The model builds a tree of possible future asset prices to determine the
option's value at each node, working backwards from expiration to the
present value. This approach is particularly valuable for American
options or other early-exercise scenarios.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.asset){.anchor
.field}`asset: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.asset
...
.field}`volatility: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.volatility
.structfield .section-header}
...
[[§](#structfield.int_rate){.anchor
.field}`int_rate: `[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.int_rate
.structfield .section-header}
...
[[§](#structfield.expiry){.anchor
.field}`expiry: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.expiry
.structfield .section-header}

::: docblock
The time to expiration of the option in years, represented as a positive
value.
:::

[[§](#structfield.no_steps){.anchor
.field}`no_steps: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#structfield.no_steps
.structfield .section-header}

::: docblock
The number of steps to use in the binomial tree calculation. Higher
values increase accuracy but also computational cost.
:::

[[§](#structfield.option_type){.anchor
.field}`option_type: &'a `[`OptionType`](../../model/types/enum.OptionType.html "enum optionstratlib::model::types::OptionType"){.enum}]{#structfield.option_type
.structfield .section-header}

::: docblock
The type of option (European, American, etc.) which determines when the
option can be exercised.
:::

[[§](#structfield.option_style){.anchor
.field}`option_style: &'a `[`OptionStyle`](../../model/types/enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}]{#structfield.option_style
.structfield .section-header}

::: docblock
The style of the option (Call or Put) which determines whether the
option gives the right to buy or sell the underlying asset.
:::

[[§](#structfield.side){.anchor
.field}`side: &'a `[`Side`](../../model/types/enum.Side.html "enum optionstratlib::model::types::Side"){.enum}]{#structfield.side
.structfield .section-header}
...
::: {#impl-Clone-for-BinomialPricingParams%3C'a%3E .section .impl}
[Source](../../../src/optionstratlib/pricing/binomial_model.rs.html#21){.src
.rightside}[§](#impl-Clone-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-clone-for-binomialpricingparamsa .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#fn-cloneself---binomialpricingparamsa .code-header}
:::
...
::: {#impl-Freeze-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Freeze-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-freeze-for-binomialpricingparamsa .code-header}
:::

::: {#impl-RefUnwindSafe-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-RefUnwindSafe-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-refunwindsafe-for-binomialpricingparamsa .code-header}
:::

::: {#impl-Send-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Send-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-send-for-binomialpricingparamsa .code-header}
:::

::: {#impl-Sync-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Sync-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-sync-for-binomialpricingparamsa .code-header}
:::

::: {#impl-Unpin-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-Unpin-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-unpin-for-binomialpricingparamsa .code-header}
:::

::: {#impl-UnwindSafe-for-BinomialPricingParams%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-BinomialPricingParams%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BinomialPricingParams](struct.BinomialPricingParams.html "struct optionstratlib::pricing::binomial_model::BinomialPricingParams"){.struct}\<\'a\> {#impla-unwindsafe-for-binomialpricingparamsa .code-header}
:::
:::::::::
