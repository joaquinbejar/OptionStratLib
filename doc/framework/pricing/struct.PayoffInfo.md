...
[[Source](../../src/optionstratlib/pricing/payoff.rs.html#71-96){.src}
]{.sub-heading}
::::
...
.field}`spot_prices: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}`>>`]{#structfield.spot_prices
.structfield .section-header}
...
.field}`spot_min: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}`>`]{#structfield.spot_min
.structfield .section-header}
...
.field}`spot_max: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}`>`]{#structfield.spot_max
.structfield .section-header}
...
[Source](../../src/optionstratlib/pricing/payoff.rs.html#112-147){.src
...
[Source](../../src/optionstratlib/pricing/payoff.rs.html#144-146){.src
.rightside}

#### pub fn [spot_prices_len](#method.spot_prices_len){.fn}(&self) -\> [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[usize](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}\> {#pub-fn-spot_prices_lenself---optionusize .code-header}
:::
...
[Source](../../src/optionstratlib/pricing/payoff.rs.html#70){.src
.rightside}[§](#impl-Debug-for-PayoffInfo){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-debug-for-payoffinfo .code-header}
:::
...
[Source](../../src/optionstratlib/pricing/payoff.rs.html#98-110){.src
.rightside}[§](#impl-Default-for-PayoffInfo){.anchor}

### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-default-for-payoffinfo .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/pricing/payoff.rs.html#99-109){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-freeze-for-payoffinfo .code-header}
:::

::: {#impl-RefUnwindSafe-for-PayoffInfo .section .impl}
[§](#impl-RefUnwindSafe-for-PayoffInfo){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-refunwindsafe-for-payoffinfo .code-header}
:::

::: {#impl-Send-for-PayoffInfo .section .impl}
[§](#impl-Send-for-PayoffInfo){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-send-for-payoffinfo .code-header}
:::

::: {#impl-Sync-for-PayoffInfo .section .impl}
[§](#impl-Sync-for-PayoffInfo){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-sync-for-payoffinfo .code-header}
:::

::: {#impl-Unpin-for-PayoffInfo .section .impl}
[§](#impl-Unpin-for-PayoffInfo){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-unpin-for-payoffinfo .code-header}
:::

::: {#impl-UnwindSafe-for-PayoffInfo .section .impl}
[§](#impl-UnwindSafe-for-PayoffInfo){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PayoffInfo](struct.PayoffInfo.html "struct optionstratlib::pricing::PayoffInfo"){.struct} {#impl-unwindsafe-for-payoffinfo .code-header}
:::
:::::::::
