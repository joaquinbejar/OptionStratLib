...
[[Source](../../src/optionstratlib/greeks/equations.rs.html#33-48){.src}
]{.sub-heading}
::::
...
.field}`gamma: Decimal`]{#structfield.gamma .structfield
.section-header}
...
.field}`theta: Decimal`]{#structfield.theta .structfield
.section-header}
...
.field}`vega: Decimal`]{#structfield.vega .structfield .section-header}

::: docblock
Measures sensitivity to changes in implied volatility
:::

[[§](#structfield.rho){.anchor .field}`rho: Decimal`]{#structfield.rho
...
.field}`rho_d: Decimal`]{#structfield.rho_d .structfield
.section-header}
...
.field}`alpha: Decimal`]{#structfield.alpha .structfield
.section-header}
...
[Source](../../src/optionstratlib/greeks/equations.rs.html#32){.src
.rightside}[§](#impl-Debug-for-Greek){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-debug-for-greek .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-partialeq-for-greek .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-greek---bool .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-structuralpartialeq-for-greek .code-header}
:::
::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-freeze-for-greek .code-header}
:::

::: {#impl-RefUnwindSafe-for-Greek .section .impl}
[§](#impl-RefUnwindSafe-for-Greek){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-refunwindsafe-for-greek .code-header}
:::

::: {#impl-Send-for-Greek .section .impl}
[§](#impl-Send-for-Greek){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-send-for-greek .code-header}
:::

::: {#impl-Sync-for-Greek .section .impl}
[§](#impl-Sync-for-Greek){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-sync-for-greek .code-header}
:::

::: {#impl-Unpin-for-Greek .section .impl}
[§](#impl-Unpin-for-Greek){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-unpin-for-greek .code-header}
:::

::: {#impl-UnwindSafe-for-Greek .section .impl}
[§](#impl-UnwindSafe-for-Greek){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-unwindsafe-for-greek .code-header}
:::
:::::::::
