...
# Struct [Greek]{.struct} Copy item path

[[Source](../../src/optionstratlib/greeks/equations.rs.html#36-51){.src}
]{.sub-heading}
::::
...
Option Greeks are essential metrics in options trading and risk
management, each quantifying how the theoretical value of an option
changes with respect to different parameters.

### [§](#fields-1){.doc-anchor}Fields {#fields-1}

Each field represents a specific Greek measure:

- `delta`: Measures the rate of change in the option price relative to
  changes in the underlying asset price
- `gamma`: Measures the rate of change of delta in relation to changes
  in the underlying asset price
- `theta`: Measures the rate of change in the option price with respect
  to time decay (time sensitivity)
- `vega`: Measures the rate of change in the option price with respect
  to changes in implied volatility
- `rho`: Measures the rate of change in the option price with respect to
  the risk-free interest rate
- `rho_d`: Measures the rate of change in the option price with respect
  to the dividend yield
- `alpha`: Represents a measure of an option's excess return relative to
  what would be predicted by models

These metrics help traders understand and manage the various dimensions
of risk in option positions.
:::
...
::: docblock
Measures sensitivity to changes in the underlying asset's price (first
derivative)
:::

[[§](#structfield.gamma){.anchor
.field}`gamma: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.gamma
.structfield .section-header}

::: docblock
Measures the rate of change in delta (second derivative of the option
price)
:::

[[§](#structfield.theta){.anchor
.field}`theta: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.theta
.structfield .section-header}

::: docblock
Measures the time decay of an option's value (sensitivity to the passage
of time)
:::

[[§](#structfield.vega){.anchor
.field}`vega: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.vega
.structfield .section-header}
...
[[§](#structfield.rho){.anchor
.field}`rho: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.rho
.structfield .section-header}
...
[[§](#structfield.rho_d){.anchor
.field}`rho_d: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.rho_d
.structfield .section-header}
...
[[§](#structfield.alpha){.anchor
.field}`alpha: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.alpha
.structfield .section-header}
...
::: {#impl-Clone-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-Clone-for-Greek){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-clone-for-greek .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#fn-cloneself---greek .code-header}
:::
...
::: {#impl-ComposeSchema-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-ComposeSchema-for-Greek){.anchor}

### impl ComposeSchema for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-composeschema-for-greek .code-header}
:::
...
::: {#impl-Debug-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-Debug-for-Greek){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-debug-for-greek .code-header}
:::
...
::: {#impl-Display-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-Display-for-Greek){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-display-for-greek .code-header}
:::
...
::: {#impl-PartialEq-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-PartialEq-for-Greek){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-partialeq-for-greek .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-greek---bool .code-header}
:::
...
::: {#impl-Serialize-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-Serialize-for-Greek){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-serialize-for-greek .code-header}
:::
...
::: {#impl-ToSchema-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-ToSchema-for-Greek){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-toschema-for-greek .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-Greek .section .impl}
[Source](../../src/optionstratlib/greeks/equations.rs.html#35){.src
.rightside}[§](#impl-StructuralPartialEq-for-Greek){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-structuralpartialeq-for-greek .code-header}
:::
::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-Greek .section .impl}
[§](#impl-Freeze-for-Greek){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-freeze-for-greek .code-header}
:::

::: {#impl-RefUnwindSafe-for-Greek .section .impl}
[§](#impl-RefUnwindSafe-for-Greek){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-refunwindsafe-for-greek .code-header}
:::

::: {#impl-Send-for-Greek .section .impl}
[§](#impl-Send-for-Greek){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-send-for-greek .code-header}
:::

::: {#impl-Sync-for-Greek .section .impl}
[§](#impl-Sync-for-Greek){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-sync-for-greek .code-header}
:::

::: {#impl-Unpin-for-Greek .section .impl}
[§](#impl-Unpin-for-Greek){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-unpin-for-greek .code-header}
:::

::: {#impl-UnwindSafe-for-Greek .section .impl}
[§](#impl-UnwindSafe-for-Greek){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Greek](struct.Greek.html "struct optionstratlib::greeks::Greek"){.struct} {#impl-unwindsafe-for-greek .code-header}
:::
:::::::::
