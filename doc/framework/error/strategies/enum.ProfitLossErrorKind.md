...
[[Source](../../../src/optionstratlib/error/strategies.rs.html#237-267){.src}
]{.sub-heading}
::::
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.MaxProfitError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.MaxLossError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ProfitRangeError.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/strategies.rs.html#236){.src
.rightside}[§](#impl-Debug-for-ProfitLossErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-debug-for-profitlosserrorkind .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-display-for-profitlosserrorkind .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-error-for-profitlosserrorkind .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-freeze-for-profitlosserrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-send-for-profitlosserrorkind .code-header}
:::

::: {#impl-Sync-for-ProfitLossErrorKind .section .impl}
[§](#impl-Sync-for-ProfitLossErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-sync-for-profitlosserrorkind .code-header}
:::

::: {#impl-Unpin-for-ProfitLossErrorKind .section .impl}
[§](#impl-Unpin-for-ProfitLossErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProfitLossErrorKind](enum.ProfitLossErrorKind.html "enum optionstratlib::error::strategies::ProfitLossErrorKind"){.enum} {#impl-unpin-for-profitlosserrorkind .code-header}
:::
