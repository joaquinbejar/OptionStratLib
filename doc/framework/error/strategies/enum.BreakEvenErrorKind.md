...
[[Source](../../../src/optionstratlib/error/strategies.rs.html#202-219){.src}
]{.sub-heading}
::::
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.CalculationError.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/strategies.rs.html#201){.src
.rightside}[§](#impl-Debug-for-BreakEvenErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-debug-for-breakevenerrorkind .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-display-for-breakevenerrorkind .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-error-for-breakevenerrorkind .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-freeze-for-breakevenerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-send-for-breakevenerrorkind .code-header}
:::

::: {#impl-Sync-for-BreakEvenErrorKind .section .impl}
[§](#impl-Sync-for-BreakEvenErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-sync-for-breakevenerrorkind .code-header}
:::

::: {#impl-Unpin-for-BreakEvenErrorKind .section .impl}
[§](#impl-Unpin-for-BreakEvenErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-unpin-for-breakevenerrorkind .code-header}
:::
