...
# Enum [BreakEvenErrorKind]{.enum}Copy item path

[[Source](../../../src/optionstratlib/error/strategies.rs.html#196-211){.src}
]{.sub-heading}
::::
...
Break-even points are critical price levels at which an options strategy
neither generates profit nor loss. This enum categorizes the various
errors that might occur when attempting to calculate these points,
providing clear error handling paths for client code.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `CalculationError` - Indicates a failure in the mathematical
  calculation process for break-even points, including the specific
  reason for the failure.

- `NoBreakEvenPoints` - Indicates that no break-even points exist for
  the given strategy. This may occur with certain strategies that are
  always profitable or always unprofitable across all possible price
  ranges.
...
## [§](#related-errors){.doc-anchor}Related Errors

This error type is typically used within the context of `StrategyError`
to provide detailed information about failures in strategy analysis,
particularly when evaluating profit/loss scenarios at different price
points.
::::
...
### CalculationError {#calculationerror .code-header}
:::

::: docblock
Error that occurs when the break-even calculation process fails

The `reason` field provides specific details about why the calculation
failed, which can be useful for debugging or providing user feedback.
:::

::::: {#variant.CalculationError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.CalculationError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.CalculationError.field.reason
.section-header}
...
::: {#variant.NoBreakEvenPoints .section .variant}
[§](#variant.NoBreakEvenPoints){.anchor}

### NoBreakEvenPoints {#nobreakevenpoints .code-header}
:::

::: docblock
Error indicating that no break-even points exist for the given strategy

This typically occurs with strategies that maintain a consistent profit
or loss profile regardless of the underlying asset's price.
:::
::::::::::
...
::: {#impl-Debug-for-BreakEvenErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/strategies.rs.html#195){.src
.rightside}[§](#impl-Debug-for-BreakEvenErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-debug-for-breakevenerrorkind .code-header}
:::
...
::: {#impl-Display-for-BreakEvenErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/strategies.rs.html#284-295){.src
.rightside}[§](#impl-Display-for-BreakEvenErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-display-for-breakevenerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/strategies.rs.html#285-294){.src
...
::: {#impl-Error-for-BreakEvenErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/strategies.rs.html#77){.src
.rightside}[§](#impl-Error-for-BreakEvenErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.86.0/core/error/trait.Error.html "trait core::error::Error"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-error-for-breakevenerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-BreakEvenErrorKind .section .impl}
[§](#impl-Freeze-for-BreakEvenErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-freeze-for-breakevenerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-BreakEvenErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-BreakEvenErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-refunwindsafe-for-breakevenerrorkind .code-header}
:::

::: {#impl-Send-for-BreakEvenErrorKind .section .impl}
[§](#impl-Send-for-BreakEvenErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-send-for-breakevenerrorkind .code-header}
:::

::: {#impl-Sync-for-BreakEvenErrorKind .section .impl}
[§](#impl-Sync-for-BreakEvenErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-sync-for-breakevenerrorkind .code-header}
:::

::: {#impl-Unpin-for-BreakEvenErrorKind .section .impl}
[§](#impl-Unpin-for-BreakEvenErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-unpin-for-breakevenerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-BreakEvenErrorKind .section .impl}
[§](#impl-UnwindSafe-for-BreakEvenErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BreakEvenErrorKind](enum.BreakEvenErrorKind.html "enum optionstratlib::error::strategies::BreakEvenErrorKind"){.enum} {#impl-unwindsafe-for-breakevenerrorkind .code-header}
:::
:::::::::
