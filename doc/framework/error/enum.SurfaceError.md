...
[[Source](../../src/optionstratlib/error/surfaces.rs.html#29-88){.src}
]{.sub-heading}
::::
...
.field}`reason: &'static `[`str`](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}]{#variant.Point3DError.field.reason
.section-header}
...
[Source](../../src/optionstratlib/error/surfaces.rs.html#101-137){.src
...
[Source](../../src/optionstratlib/error/surfaces.rs.html#113-118){.src
.rightside}
...
[Source](../../src/optionstratlib/error/surfaces.rs.html#131-136){.src
.rightside}
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-debug-for-surfaceerror .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-display-for-surfaceerror .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-error-for-surfaceerror .code-header}
:::
...
[Source](../../src/optionstratlib/error/surfaces.rs.html#192-198){.src
...
[Source](../../src/optionstratlib/error/surfaces.rs.html#193-197){.src
...
::: {#impl-From%3CGraphError%3E-for-SurfaceError .section .impl}
[Source](../../src/optionstratlib/error/surfaces.rs.html#186-190){.src
.rightside}[§](#impl-From%3CGraphError%3E-for-SurfaceError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[GraphError](enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum}\> for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-fromgrapherror-for-surfaceerror .code-header}
:::

::::: impl-items
::: {#method.from-6 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/surfaces.rs.html#187-189){.src
...
::: {#impl-From%3CSurfaceError%3E-for-Error .section .impl}
[Source](../../src/optionstratlib/error/unified.rs.html#79){.src
.rightside}[§](#impl-From%3CSurfaceError%3E-for-Error){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum}\> for [Error](unified/enum.Error.html "enum optionstratlib::error::unified::Error"){.enum} {#impl-fromsurfaceerror-for-error .code-header}
:::
...
::: {#impl-From%3CSurfaceError%3E-for-GraphError .section .impl}
[Source](../../src/optionstratlib/error/graph.rs.html#36-40){.src
.rightside}[§](#impl-From%3CSurfaceError%3E-for-GraphError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum}\> for [GraphError](enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum} {#impl-fromsurfaceerror-for-grapherror .code-header}
:::

::::: impl-items
::: {#method.from-8 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/graph.rs.html#37-39){.src
.rightside}[§](#method.from-8){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum}) -\> Self {#fn-fromerr-surfaceerror---self .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum}) -\> Self {#fn-fromsource-surfaceerror---self-1 .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum}) -\> Self {#fn-fromsource-surfaceerror---self-2 .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-freeze-for-surfaceerror .code-header}
:::

::: {#impl-RefUnwindSafe-for-SurfaceError .section .impl}
[§](#impl-RefUnwindSafe-for-SurfaceError){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-refunwindsafe-for-surfaceerror .code-header}
:::

::: {#impl-Send-for-SurfaceError .section .impl}
[§](#impl-Send-for-SurfaceError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-send-for-surfaceerror .code-header}
:::

::: {#impl-Sync-for-SurfaceError .section .impl}
[§](#impl-Sync-for-SurfaceError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-sync-for-surfaceerror .code-header}
:::

::: {#impl-Unpin-for-SurfaceError .section .impl}
[§](#impl-Unpin-for-SurfaceError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-unpin-for-surfaceerror .code-header}
:::

::: {#impl-UnwindSafe-for-SurfaceError .section .impl}
[§](#impl-UnwindSafe-for-SurfaceError){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [SurfaceError](enum.SurfaceError.html "enum optionstratlib::error::SurfaceError"){.enum} {#impl-unwindsafe-for-surfaceerror .code-header}
:::
:::::::::
