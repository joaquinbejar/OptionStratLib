...
[[Source](../../../src/optionstratlib/error/greeks.rs.html#114-158){.src}
]{.sub-heading}
::::
...
.field}`value: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#variant.InvalidDomain.field.value
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidDomain.field.reason
.section-header}
...
.field}`iterations: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.ConvergenceFailure.field.iterations
.section-header}
...
.field}`tolerance: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#variant.ConvergenceFailure.field.tolerance
.section-header}
...
[Source](../../../src/optionstratlib/error/greeks.rs.html#113){.src
.rightside}[§](#impl-Debug-for-MathErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-debug-for-matherrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/greeks.rs.html#321-341){.src
.rightside}[§](#impl-Display-for-MathErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-display-for-matherrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#322-340){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-freeze-for-matherrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-MathErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-MathErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-refunwindsafe-for-matherrorkind .code-header}
:::

::: {#impl-Send-for-MathErrorKind .section .impl}
[§](#impl-Send-for-MathErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-send-for-matherrorkind .code-header}
:::

::: {#impl-Sync-for-MathErrorKind .section .impl}
[§](#impl-Sync-for-MathErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-sync-for-matherrorkind .code-header}
:::

::: {#impl-Unpin-for-MathErrorKind .section .impl}
[§](#impl-Unpin-for-MathErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-unpin-for-matherrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-MathErrorKind .section .impl}
[§](#impl-UnwindSafe-for-MathErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [MathErrorKind](enum.MathErrorKind.html "enum optionstratlib::error::greeks::MathErrorKind"){.enum} {#impl-unwindsafe-for-matherrorkind .code-header}
:::
:::::::::
