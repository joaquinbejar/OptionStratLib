...
[[Source](../../../src/optionstratlib/error/greeks.rs.html#197-259){.src}
]{.sub-heading}
::::
...
.field}`value: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidVolatility.field.value
.section-header}
...
.field}`value: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidPrice.field.value
.section-header}
...
.field}`value: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidRate.field.value
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidRate.field.reason
.section-header}
...
.field}`value: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidStrike.field.value
.section-header}
...
[Source](../../../src/optionstratlib/error/greeks.rs.html#196){.src
.rightside}[§](#impl-Debug-for-InputErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-debug-for-inputerrorkind .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-display-for-inputerrorkind .code-header}
:::
...
::: {#impl-Error-for-InputErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#196){.src
.rightside}[§](#impl-Error-for-InputErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-error-for-inputerrorkind .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-freeze-for-inputerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-InputErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-InputErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-refunwindsafe-for-inputerrorkind .code-header}
:::

::: {#impl-Send-for-InputErrorKind .section .impl}
[§](#impl-Send-for-InputErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-send-for-inputerrorkind .code-header}
:::

::: {#impl-Sync-for-InputErrorKind .section .impl}
[§](#impl-Sync-for-InputErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-sync-for-inputerrorkind .code-header}
:::

::: {#impl-Unpin-for-InputErrorKind .section .impl}
[§](#impl-Unpin-for-InputErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-unpin-for-inputerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-InputErrorKind .section .impl}
[§](#impl-UnwindSafe-for-InputErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [InputErrorKind](enum.InputErrorKind.html "enum optionstratlib::error::greeks::InputErrorKind"){.enum} {#impl-unwindsafe-for-inputerrorkind .code-header}
:::
:::::::::
