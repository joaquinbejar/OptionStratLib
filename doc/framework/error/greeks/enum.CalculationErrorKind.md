...
[[Source](../../../src/optionstratlib/error/greeks.rs.html#259-308){.src}
]{.sub-heading}
::::
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.DeltaError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.GammaError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ThetaError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.RhoError.field.reason
.section-header}
...
### DecimalError {#decimalerror .code-header}
:::
...
::::: {#variant.DecimalError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.DecimalError.field.error){.anchor
.field}`error: `[`DecimalError`](../decimal/enum.DecimalError.html "enum optionstratlib::error::decimal::DecimalError"){.enum}]{#variant.DecimalError.field.error
.section-header}
...
[Source](../../../src/optionstratlib/error/greeks.rs.html#258){.src
.rightside}[§](#impl-Debug-for-CalculationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-debug-for-calculationerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/greeks.rs.html#365-386){.src
.rightside}[§](#impl-Display-for-CalculationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-display-for-calculationerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#366-385){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-freeze-for-calculationerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-send-for-calculationerrorkind .code-header}
:::

::: {#impl-Sync-for-CalculationErrorKind .section .impl}
[§](#impl-Sync-for-CalculationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-sync-for-calculationerrorkind .code-header}
:::

::: {#impl-Unpin-for-CalculationErrorKind .section .impl}
[§](#impl-Unpin-for-CalculationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-unpin-for-calculationerrorkind .code-header}
:::
