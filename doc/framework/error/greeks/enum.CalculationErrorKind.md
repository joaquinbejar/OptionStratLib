...
# Enum [CalculationErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/greeks.rs.html#271-323){.src}
]{.sub-heading}
::::
...
This enum categorizes errors that happen during the calculation of
option Greeks and other financial metrics. Each variant provides
detailed context about what went wrong during the specific calculation,
allowing for precise error handling and debugging.

The enum is designed to be used within a broader error handling system
for options pricing and financial calculations, providing specific error
types for different aspects of the derivatives pricing process.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

:::::::::::::::::::::::::::::: variants
::: {#variant.DeltaError .section .variant}
[§](#variant.DeltaError){.anchor}

### DeltaError {#deltaerror .code-header}
:::
...
::::: {#variant.DeltaError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.DeltaError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.DeltaError.field.reason
.section-header}
...
::: {#variant.GammaError .section .variant}
[§](#variant.GammaError){.anchor}

### GammaError {#gammaerror .code-header}
:::
...
::::: {#variant.GammaError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.GammaError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.GammaError.field.reason
.section-header}
...
::: {#variant.ThetaError .section .variant}
[§](#variant.ThetaError){.anchor}

### ThetaError {#thetaerror .code-header}
:::
...
::::: {#variant.ThetaError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.ThetaError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ThetaError.field.reason
.section-header}
...
::: {#variant.RhoError .section .variant}
[§](#variant.RhoError){.anchor}

### RhoError {#rhoerror .code-header}
:::
...
::::: {#variant.RhoError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.RhoError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.RhoError.field.reason
.section-header}
...
::: {#variant.DecimalError .section .variant}
[§](#variant.DecimalError){.anchor}

### DecimalError([DecimalError](../decimal/enum.DecimalError.html "enum optionstratlib::error::decimal::DecimalError"){.enum}) {#decimalerrordecimalerror .code-header}
:::
...
typically related to precision, arithmetic operations, or invalid
values.
:::
::::::::::::::::::::::::::::::
...
::: {#impl-Debug-for-CalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#270){.src
.rightside}[§](#impl-Debug-for-CalculationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-debug-for-calculationerrorkind .code-header}
:::
...
::: {#impl-Display-for-CalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#270){.src
.rightside}[§](#impl-Display-for-CalculationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-display-for-calculationerrorkind .code-header}
:::
...
::: {#impl-Error-for-CalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/greeks.rs.html#270){.src
.rightside}[§](#impl-Error-for-CalculationErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-error-for-calculationerrorkind .code-header}
:::
...
### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[DecimalError](../decimal/enum.DecimalError.html "enum optionstratlib::error::decimal::DecimalError"){.enum}\> for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-fromdecimalerror-for-calculationerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-CalculationErrorKind .section .impl}
[§](#impl-Freeze-for-CalculationErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-freeze-for-calculationerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-CalculationErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-CalculationErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-refunwindsafe-for-calculationerrorkind .code-header}
:::

::: {#impl-Send-for-CalculationErrorKind .section .impl}
[§](#impl-Send-for-CalculationErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-send-for-calculationerrorkind .code-header}
:::

::: {#impl-Sync-for-CalculationErrorKind .section .impl}
[§](#impl-Sync-for-CalculationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-sync-for-calculationerrorkind .code-header}
:::

::: {#impl-Unpin-for-CalculationErrorKind .section .impl}
[§](#impl-Unpin-for-CalculationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-unpin-for-calculationerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-CalculationErrorKind .section .impl}
[§](#impl-UnwindSafe-for-CalculationErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [CalculationErrorKind](enum.CalculationErrorKind.html "enum optionstratlib::error::greeks::CalculationErrorKind"){.enum} {#impl-unwindsafe-for-calculationerrorkind .code-header}
:::
:::::::::
