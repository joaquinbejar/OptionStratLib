...
.field}`message: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#structfield.message
...
[Source](../../src/optionstratlib/error/transaction.rs.html#15){.src
.rightside}[§](#impl-Debug-for-TransactionError){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-debug-for-transactionerror .code-header}
:::
...
[Source](../../src/optionstratlib/error/transaction.rs.html#21-25){.src
.rightside}[§](#impl-Display-for-TransactionError){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-display-for-transactionerror .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/transaction.rs.html#22-24){.src
...
[Source](../../src/optionstratlib/error/transaction.rs.html#27){.src
.rightside}[§](#impl-Error-for-TransactionError){.anchor}

### impl [Error](https://doc.rust-lang.org/1.86.0/core/error/trait.Error.html "trait core::error::Error"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-error-for-transactionerror .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-freeze-for-transactionerror .code-header}
:::

::: {#impl-RefUnwindSafe-for-TransactionError .section .impl}
[§](#impl-RefUnwindSafe-for-TransactionError){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-refunwindsafe-for-transactionerror .code-header}
:::

::: {#impl-Send-for-TransactionError .section .impl}
[§](#impl-Send-for-TransactionError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-send-for-transactionerror .code-header}
:::

::: {#impl-Sync-for-TransactionError .section .impl}
[§](#impl-Sync-for-TransactionError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-sync-for-transactionerror .code-header}
:::

::: {#impl-Unpin-for-TransactionError .section .impl}
[§](#impl-Unpin-for-TransactionError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-unpin-for-transactionerror .code-header}
:::

::: {#impl-UnwindSafe-for-TransactionError .section .impl}
[§](#impl-UnwindSafe-for-TransactionError){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TransactionError](struct.TransactionError.html "struct optionstratlib::error::TransactionError"){.struct} {#impl-unwindsafe-for-transactionerror .code-header}
:::
:::::::::
