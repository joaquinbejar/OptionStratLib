...
# Enum [MetricsError]{.enum} Copy item path

[[Source](../../src/optionstratlib/error/metrics.rs.html#36-76){.src}
]{.sub-heading}
::::
...
:::: docblock
Error types specifically related to financial and statistical metrics
calculations.

This enum represents various error conditions that can occur during
metrics processing, analysis, and validation within the library's
metrics module. Each variant provides context about the specific type of
error encountered.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `BasicError` - General metrics calculation errors
- `ShapeError` - Errors related to data shape mismatches or incompatible
  dimensions
- `RangeError` - Errors when data falls outside of expected/valid ranges
- `TrendError` - Errors in trend analysis, regression, or pattern
  detection
- `RiskError` - Errors in risk metrics calculations (like VaR, Sharpe
  ratio, etc.)
...
:::::::::::::::::::::: variants
::: {#variant.BasicError .section .variant}
[§](#variant.BasicError){.anchor}

### BasicError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#basicerrorstring .code-header}
:::
...
::: {#variant.ShapeError .section .variant}
[§](#variant.ShapeError){.anchor}

### ShapeError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#shapeerrorstring .code-header}
:::
...
### RangeError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#rangeerrorstring .code-header}
:::

::: docblock
Errors when data falls outside expected or valid ranges. This can
indicate outliers or invalid input values.
:::

::: {#variant.TrendError .section .variant}
[§](#variant.TrendError){.anchor}

### TrendError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#trenderrorstring .code-header}
:::
...
::: {#variant.RiskError .section .variant}
[§](#variant.RiskError){.anchor}

### RiskError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#riskerrorstring .code-header}
:::

::: docblock
Errors specifically related to financial risk metrics calculations, such
as Value at Risk (VaR), Conditional VaR, or Sharpe ratio.
:::
...
::: docblock
Errors in surface modeling or multi-dimensional metrics, such as
volatility surfaces or correlation matrices.
:::
...
::: {#impl-Debug-for-MetricsError .section .impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#35){.src
.rightside}[§](#impl-Debug-for-MetricsError){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-debug-for-metricserror .code-header}
:::
...
::: {#impl-Display-for-MetricsError .section .impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#35){.src
.rightside}[§](#impl-Display-for-MetricsError){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-display-for-metricserror .code-header}
:::
...
::: {#impl-Error-for-MetricsError .section .impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#35){.src
.rightside}[§](#impl-Error-for-MetricsError){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-error-for-metricserror .code-header}
:::
...
::: {#impl-From%3CBox%3Cdyn+Error%3E%3E-for-MetricsError .section .impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#78-84){.src
.rightside}[§](#impl-From%3CBox%3Cdyn+Error%3E%3E-for-MetricsError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[Box](https://doc.rust-lang.org/1.91.1/alloc/boxed/struct.Box.html "struct alloc::boxed::Box"){.struct}\<dyn [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait}\>\> for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-fromboxdyn-error-for-metricserror .code-header}
:::

::::: impl-items
::: {#method.from-3 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#79-83){.src
...
### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[CurveError](curves/enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}\> for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-fromcurveerror-for-metricserror .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [CurveError](curves/enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromsource-curveerror---self .code-header}
:::
...
### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum}\> for [CurveError](curves/enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-frommetricserror-for-curveerror .code-header}
...
::: {#impl-From%3CMetricsError%3E-for-Error .section .impl}
[Source](../../src/optionstratlib/error/unified.rs.html#75){.src
.rightside}[§](#impl-From%3CMetricsError%3E-for-Error){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum}\> for [Error](unified/enum.Error.html "enum optionstratlib::error::unified::Error"){.enum} {#impl-frommetricserror-for-error .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum}) -\> Self {#fn-fromsource-metricserror---self .code-header}
:::
...
[Source](../../src/optionstratlib/error/metrics.rs.html#68){.src
...
::: {#impl-Freeze-for-MetricsError .section .impl}
[§](#impl-Freeze-for-MetricsError){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-freeze-for-metricserror .code-header}
:::

::: {#impl-RefUnwindSafe-for-MetricsError .section .impl}
[§](#impl-RefUnwindSafe-for-MetricsError){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-refunwindsafe-for-metricserror .code-header}
:::

::: {#impl-Send-for-MetricsError .section .impl}
[§](#impl-Send-for-MetricsError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-send-for-metricserror .code-header}
:::

::: {#impl-Sync-for-MetricsError .section .impl}
[§](#impl-Sync-for-MetricsError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-sync-for-metricserror .code-header}
:::

::: {#impl-Unpin-for-MetricsError .section .impl}
[§](#impl-Unpin-for-MetricsError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-unpin-for-metricserror .code-header}
:::

::: {#impl-UnwindSafe-for-MetricsError .section .impl}
[§](#impl-UnwindSafe-for-MetricsError){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-unwindsafe-for-metricserror .code-header}
:::
:::::::::
