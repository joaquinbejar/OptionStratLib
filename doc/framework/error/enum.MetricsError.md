...
[[Source](../../src/optionstratlib/error/metrics.rs.html#39-71){.src}
]{.sub-heading}
::::
...
- `RiskError` - Errors in risk metrics calculations (like VaR, Sharpe
  ratio, etc.)
- `CurveError` - Errors related to curve-fitting or curve-based
  calculations
- `SurfaceError` - Errors in surface modeling or multi-dimensional
  metrics
...
### BasicError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#basicerrorstring .code-header}
:::
...
### ShapeError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#shapeerrorstring .code-header}
:::
...
### RangeError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#rangeerrorstring .code-header}
:::
...
### TrendError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#trenderrorstring .code-header}
:::
...
### RiskError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#riskerrorstring .code-header}
:::
...
::: {#variant.CurveError .section .variant}
[§](#variant.CurveError){.anchor}

### CurveError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#curveerrorstring .code-header}
:::
...
::: {#variant.SurfaceError .section .variant}
[§](#variant.SurfaceError){.anchor}

### SurfaceError([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#surfaceerrorstring .code-header}
:::
...
[Source](../../src/optionstratlib/error/metrics.rs.html#38){.src
.rightside}[§](#impl-Debug-for-MetricsError){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-debug-for-metricserror .code-header}
:::
...
[Source](../../src/optionstratlib/error/metrics.rs.html#73-86){.src
.rightside}[§](#impl-Display-for-MetricsError){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-display-for-metricserror .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/metrics.rs.html#74-85){.src
...
[Source](../../src/optionstratlib/error/metrics.rs.html#10){.src
.rightside}[§](#impl-Error-for-MetricsError){.anchor}

### impl [Error](https://doc.rust-lang.org/1.86.0/core/error/trait.Error.html "trait core::error::Error"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-error-for-metricserror .code-header}
:::
...
[Source](../../src/optionstratlib/error/metrics.rs.html#100-106){.src
...
[Source](../../src/optionstratlib/error/metrics.rs.html#101-105){.src
...
#### fn [from](https://doc.rust-lang.org/1.86.0/core/convert/trait.From.html#tymethod.from){.fn}(err: [CurveError](curves/enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromerr-curveerror---self .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-freeze-for-metricserror .code-header}
:::

::: {#impl-RefUnwindSafe-for-MetricsError .section .impl}
[§](#impl-RefUnwindSafe-for-MetricsError){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-refunwindsafe-for-metricserror .code-header}
:::

::: {#impl-Send-for-MetricsError .section .impl}
[§](#impl-Send-for-MetricsError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-send-for-metricserror .code-header}
:::

::: {#impl-Sync-for-MetricsError .section .impl}
[§](#impl-Sync-for-MetricsError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-sync-for-metricserror .code-header}
:::

::: {#impl-Unpin-for-MetricsError .section .impl}
[§](#impl-Unpin-for-MetricsError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-unpin-for-metricserror .code-header}
:::

::: {#impl-UnwindSafe-for-MetricsError .section .impl}
[§](#impl-UnwindSafe-for-MetricsError){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [MetricsError](enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum} {#impl-unwindsafe-for-metricserror .code-header}
:::
:::::::::
