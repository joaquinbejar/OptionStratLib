...
[[Source](../../src/optionstratlib/error/common.rs.html#49-73){.src}
]{.sub-heading}
::::
...
:::: sub-variant-field
[[§](#variant.NotSupported.field.operation){.anchor
.field}`operation: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.NotSupported.field.operation
.section-header}
...
:::: sub-variant-field
[[§](#variant.NotSupported.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.NotSupported.field.reason
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidParameters.field.operation){.anchor
.field}`operation: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidParameters.field.operation
.section-header}
...
[Source](../../src/optionstratlib/error/common.rs.html#48){.src
.rightside}[§](#impl-Debug-for-OperationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-debug-for-operationerrorkind .code-header}
:::
...
[Source](../../src/optionstratlib/error/common.rs.html#48){.src
.rightside}[§](#impl-Display-for-OperationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-display-for-operationerrorkind .code-header}
:::
...
[Source](../../src/optionstratlib/error/common.rs.html#48){.src
.rightside}[§](#impl-Error-for-OperationErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-error-for-operationerrorkind .code-header}
:::
...
[§](#impl-Freeze-for-OperationErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-freeze-for-operationerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-OperationErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-OperationErrorKind){.anchor}
...
[§](#impl-Send-for-OperationErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-send-for-operationerrorkind .code-header}
:::

::: {#impl-Sync-for-OperationErrorKind .section .impl}
[§](#impl-Sync-for-OperationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-sync-for-operationerrorkind .code-header}
:::

::: {#impl-Unpin-for-OperationErrorKind .section .impl}
[§](#impl-Unpin-for-OperationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-unpin-for-operationerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-OperationErrorKind .section .impl}
[§](#impl-UnwindSafe-for-OperationErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OperationErrorKind](enum.OperationErrorKind.html "enum optionstratlib::error::OperationErrorKind"){.enum} {#impl-unwindsafe-for-operationerrorkind .code-header}
:::
:::::::::
