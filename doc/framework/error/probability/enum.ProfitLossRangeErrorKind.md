...
[[Source](../../../src/optionstratlib/error/probability.rs.html#244-275){.src}
]{.sub-heading}
::::
...
.field}`range: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidProfitRange.field.range
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidProfitRange.field.reason
.section-header}
...
.field}`range: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLossRange.field.range
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLossRange.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidBreakEvenPoints.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/probability.rs.html#243){.src
.rightside}[§](#impl-Debug-for-ProfitLossRangeErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-debug-for-profitlossrangeerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/probability.rs.html#421-435){.src
.rightside}[§](#impl-Display-for-ProfitLossRangeErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-display-for-profitlossrangeerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#422-434){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-freeze-for-profitlossrangeerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-send-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-Sync-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Sync-for-ProfitLossRangeErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-sync-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-Unpin-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Unpin-for-ProfitLossRangeErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-unpin-for-profitlossrangeerrorkind .code-header}
:::
