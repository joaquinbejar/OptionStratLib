...
# Enum [ProfitLossRangeErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/probability.rs.html#253-287){.src}
]{.sub-heading}
::::
...
This enum captures three main categories of errors that can occur when
calculating, validating, or processing profit and loss ranges and
break-even points in financial calculations. It provides structured
error information with detailed descriptions of why the ranges are
invalid.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidProfitRange` - Represents errors related to profit range
  calculations, such as inconsistent boundaries, mathematically
  impossible ranges, or other logical errors in profit projections.

- `InvalidLossRange` - Represents errors related to loss range
  calculations, including boundary issues, logical inconsistencies, or
  other problems that prevent accurate loss estimation.

- `InvalidBreakEvenPoints` - Represents errors in break-even point
  calculations, which can include missing break-even points, multiple
  unexpected points, or other calculation anomalies.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in financial strategy analysis,
particularly in options trading calculations where understanding the
ranges of potential profit and loss is critical for risk assessment and
decision making.
:::
...
:::::::::::::::::::::: variants
::: {#variant.InvalidProfitRange .section .variant}
[§](#variant.InvalidProfitRange){.anchor}

### InvalidProfitRange {#invalidprofitrange .code-header}
:::
...
inconsistencies, or values that don't align with the underlying
strategy.
:::

::::::: {#variant.InvalidProfitRange.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidProfitRange.field.range){.anchor
.field}`range: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidProfitRange.field.range
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidProfitRange.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidProfitRange.field.reason
.section-header}
...
::: {#variant.InvalidLossRange .section .variant}
[§](#variant.InvalidLossRange){.anchor}

### InvalidLossRange {#invalidlossrange .code-header}
:::
...
::::::: {#variant.InvalidLossRange.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidLossRange.field.range){.anchor
.field}`range: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLossRange.field.range
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidLossRange.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLossRange.field.reason
.section-header}
...
::: {#variant.InvalidBreakEvenPoints .section .variant}
[§](#variant.InvalidBreakEvenPoints){.anchor}

### InvalidBreakEvenPoints {#invalidbreakevenpoints .code-header}
:::

::: docblock
Error indicating problems with break-even point calculations

This variant is used when break-even points couldn't be properly
calculated, are missing, or contain unexpected values.
:::

::::: {#variant.InvalidBreakEvenPoints.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidBreakEvenPoints.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidBreakEvenPoints.field.reason
.section-header}
...
::: {#impl-Debug-for-ProfitLossRangeErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#252){.src
.rightside}[§](#impl-Debug-for-ProfitLossRangeErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-debug-for-profitlossrangeerrorkind .code-header}
:::
...
::: {#impl-Display-for-ProfitLossRangeErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#252){.src
.rightside}[§](#impl-Display-for-ProfitLossRangeErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-display-for-profitlossrangeerrorkind .code-header}
:::
...
::: {#impl-Error-for-ProfitLossRangeErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#252){.src
.rightside}[§](#impl-Error-for-ProfitLossRangeErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-error-for-profitlossrangeerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Freeze-for-ProfitLossRangeErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-freeze-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-ProfitLossRangeErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-refunwindsafe-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-Send-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Send-for-ProfitLossRangeErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-send-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-Sync-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Sync-for-ProfitLossRangeErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-sync-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-Unpin-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-Unpin-for-ProfitLossRangeErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-unpin-for-profitlossrangeerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-ProfitLossRangeErrorKind .section .impl}
[§](#impl-UnwindSafe-for-ProfitLossRangeErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ProfitLossRangeErrorKind](enum.ProfitLossRangeErrorKind.html "enum optionstratlib::error::probability::ProfitLossRangeErrorKind"){.enum} {#impl-unwindsafe-for-profitlossrangeerrorkind .code-header}
:::
:::::::::
