...
# Enum [ProbabilityCalculationErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/probability.rs.html#179-225){.src}
]{.sub-heading}
::::
...
This enum represents specific error categories that may arise when
performing probability-related calculations for financial models, risk
assessments, and statistical analysis of market scenarios. It provides
structured error information with detailed context about what caused the
calculation to fail.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidProbability` - Represents errors where a probability value
  falls outside the valid range \[0,1\] or otherwise violates
  mathematical constraints of probability theory.

- `ExpectedValueError` - Represents errors in the calculation of
  expected values, such as invalid inputs, numerical overflow/underflow,
  or unsupported distributions.

- `VolatilityAdjustmentError` - Represents errors that occur when
  attempting to adjust calculations for volatility, including invalid
  volatility inputs or mathematical errors in the adjustment process.

- `TrendError` - Represents errors related to price trend calculations,
  such as insufficient historical data, invalid trend parameters, or
  statistical anomalies.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in financial modeling components that
deal with probabilistic outcomes, such as Monte Carlo simulations, risk
models, and probability-based trading strategies.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::::::::::::: variants
::: {#variant.InvalidProbability .section .variant}
[§](#variant.InvalidProbability){.anchor}

### InvalidProbability {#invalidprobability .code-header}
:::

::: docblock
Error indicating an invalid probability value

This variant is used when a probability calculation produces a result
that violates fundamental probability constraints (e.g., not in range
\[0,1\]) or other mathematical properties required for valid statistical
analysis.
:::

::::::: {#variant.InvalidProbability.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidProbability.field.value){.anchor
.field}`value: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidProbability.field.value
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidProbability.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidProbability.field.reason
.section-header}
...
::: {#variant.ExpectedValueError .section .variant}
[§](#variant.ExpectedValueError){.anchor}

### ExpectedValueError {#expectedvalueerror .code-header}
:::
...
::::: {#variant.ExpectedValueError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.ExpectedValueError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ExpectedValueError.field.reason
.section-header}
...
### TrendError {#trenderror .code-header}
:::
...
::::: {#variant.TrendError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.TrendError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.TrendError.field.reason
.section-header}
...
::: {#impl-Debug-for-ProbabilityCalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#178){.src
.rightside}[§](#impl-Debug-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-debug-for-probabilitycalculationerrorkind .code-header}
:::
...
::: {#impl-Display-for-ProbabilityCalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#178){.src
.rightside}[§](#impl-Display-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-display-for-probabilitycalculationerrorkind .code-header}
:::
...
::: {#impl-Error-for-ProbabilityCalculationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#178){.src
.rightside}[§](#impl-Error-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-error-for-probabilitycalculationerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-Freeze-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-freeze-for-probabilitycalculationerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-ProbabilityCalculationErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-refunwindsafe-for-probabilitycalculationerrorkind .code-header}
:::

::: {#impl-Send-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-Send-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-send-for-probabilitycalculationerrorkind .code-header}
:::

::: {#impl-Sync-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-Sync-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-sync-for-probabilitycalculationerrorkind .code-header}
:::

::: {#impl-Unpin-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-Unpin-for-ProbabilityCalculationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-unpin-for-probabilitycalculationerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-ProbabilityCalculationErrorKind .section .impl}
[§](#impl-UnwindSafe-for-ProbabilityCalculationErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ProbabilityCalculationErrorKind](enum.ProbabilityCalculationErrorKind.html "enum optionstratlib::error::probability::ProbabilityCalculationErrorKind"){.enum} {#impl-unwindsafe-for-probabilitycalculationerrorkind .code-header}
:::
:::::::::
