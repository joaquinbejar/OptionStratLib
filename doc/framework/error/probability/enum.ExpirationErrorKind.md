...
[[Source](../../../src/optionstratlib/error/probability.rs.html#299-319){.src}
]{.sub-heading}
::::
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidExpiration.field.reason
.section-header}
...
.field}`rate: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}`>`]{#variant.InvalidRiskFreeRate.field.rate
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidRiskFreeRate.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/probability.rs.html#298){.src
.rightside}[§](#impl-Debug-for-ExpirationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-debug-for-expirationerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/probability.rs.html#371-387){.src
.rightside}[§](#impl-Display-for-ExpirationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-display-for-expirationerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#372-386){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-freeze-for-expirationerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-send-for-expirationerrorkind .code-header}
:::

::: {#impl-Sync-for-ExpirationErrorKind .section .impl}
[§](#impl-Sync-for-ExpirationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-sync-for-expirationerrorkind .code-header}
:::

::: {#impl-Unpin-for-ExpirationErrorKind .section .impl}
[§](#impl-Unpin-for-ExpirationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-unpin-for-expirationerrorkind .code-header}
:::
