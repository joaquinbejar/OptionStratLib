...
# Enum [ExpirationErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/probability.rs.html#311-333){.src}
]{.sub-heading}
::::
...
::: docblock
Enum representing errors related to expiration dates and interest rates
in options calculations.

This enum captures two main categories of errors that can occur when
validating or processing expiration dates and risk-free rates for
financial calculations. It provides structured error information that
includes detailed reasons for the error occurrence.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidExpiration` - Represents errors related to option expiration
  dates, such as dates in the past, invalid formats, or dates that don't
  align with market standards.

- `InvalidRiskFreeRate` - Represents errors related to risk-free rate
  values, such as negative rates, unreasonably high rates, or other
  invalid inputs that would cause calculation issues.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in option pricing models, risk
assessment, and other financial calculations where expiration dates and
risk-free rates are critical input parameters.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::: variants
::: {#variant.InvalidExpiration .section .variant}
[§](#variant.InvalidExpiration){.anchor}

### InvalidExpiration {#invalidexpiration .code-header}
:::

::: docblock
Error indicating an invalid or problematic expiration date

This variant is used when the provided expiration date doesn't meet the
required criteria for option calculations.
:::

::::: {#variant.InvalidExpiration.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidExpiration.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidExpiration.field.reason
.section-header}
...
::: {#variant.InvalidRiskFreeRate .section .variant}
[§](#variant.InvalidRiskFreeRate){.anchor}

### InvalidRiskFreeRate {#invalidriskfreerate .code-header}
:::
...
::::::: {#variant.InvalidRiskFreeRate.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidRiskFreeRate.field.rate){.anchor
.field}`rate: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}`>`]{#variant.InvalidRiskFreeRate.field.rate
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidRiskFreeRate.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidRiskFreeRate.field.reason
.section-header}
...
::: {#impl-Debug-for-ExpirationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#310){.src
.rightside}[§](#impl-Debug-for-ExpirationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-debug-for-expirationerrorkind .code-header}
:::
...
::: {#impl-Display-for-ExpirationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#310){.src
.rightside}[§](#impl-Display-for-ExpirationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-display-for-expirationerrorkind .code-header}
:::
...
::: {#impl-Error-for-ExpirationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/probability.rs.html#310){.src
.rightside}[§](#impl-Error-for-ExpirationErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-error-for-expirationerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-ExpirationErrorKind .section .impl}
[§](#impl-Freeze-for-ExpirationErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-freeze-for-expirationerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-ExpirationErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-ExpirationErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-refunwindsafe-for-expirationerrorkind .code-header}
:::

::: {#impl-Send-for-ExpirationErrorKind .section .impl}
[§](#impl-Send-for-ExpirationErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-send-for-expirationerrorkind .code-header}
:::

::: {#impl-Sync-for-ExpirationErrorKind .section .impl}
[§](#impl-Sync-for-ExpirationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-sync-for-expirationerrorkind .code-header}
:::

::: {#impl-Unpin-for-ExpirationErrorKind .section .impl}
[§](#impl-Unpin-for-ExpirationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-unpin-for-expirationerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-ExpirationErrorKind .section .impl}
[§](#impl-UnwindSafe-for-ExpirationErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ExpirationErrorKind](enum.ExpirationErrorKind.html "enum optionstratlib::error::probability::ExpirationErrorKind"){.enum} {#impl-unwindsafe-for-expirationerrorkind .code-header}
:::
:::::::::
