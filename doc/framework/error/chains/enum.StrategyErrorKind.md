...
[[Source](../../../src/optionstratlib/error/chains.rs.html#365-390){.src}
]{.sub-heading}
::::
...
.field}`expected: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.InvalidLegs.field.expected
.section-header}
...
.field}`found: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.InvalidLegs.field.found
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLegs.field.reason
.section-header}
...
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidCombination.field.strategy_type
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidCombination.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/chains.rs.html#364){.src
.rightside}[§](#impl-Debug-for-StrategyErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-debug-for-strategyerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#489-515){.src
.rightside}[§](#impl-Display-for-StrategyErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-display-for-strategyerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#490-514){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-partialeq-for-strategyerrorkind .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-strategyerrorkind---bool .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-freeze-for-strategyerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-send-for-strategyerrorkind .code-header}
:::

::: {#impl-Sync-for-StrategyErrorKind .section .impl}
[§](#impl-Sync-for-StrategyErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-sync-for-strategyerrorkind .code-header}
:::

::: {#impl-Unpin-for-StrategyErrorKind .section .impl}
[§](#impl-Unpin-for-StrategyErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-unpin-for-strategyerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-UnwindSafe-for-StrategyErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-unwindsafe-for-strategyerrorkind .code-header}
:::
:::::::::
