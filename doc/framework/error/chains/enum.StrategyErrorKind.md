...
# Enum [StrategyErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/chains.rs.html#383-410){.src}
]{.sub-heading}
::::
...
::: docblock
Enum representing specific error types that can occur in options trading
strategies.

This enum captures errors that may arise during the validation and
execution of options trading strategies. It provides structured error
information including detailed reasons for various strategy-related
failures.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidLegs` - Represents errors when the number of strategy legs
  doesn't match the expected count for a particular strategy type.

- `InvalidCombination` - Represents errors when the combination of
  options in a strategy doesn't meet the required criteria (strike
  prices, expiration dates, option types, etc.).

## [§](#usage){.doc-anchor}Usage

This error type is typically used in strategy validation, construction,
and analysis to provide specific feedback about why a particular options
combination doesn't constitute a valid strategy.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::::::: variants
::: {#variant.InvalidLegs .section .variant}
[§](#variant.InvalidLegs){.anchor}

### InvalidLegs {#invalidlegs .code-header}
:::
...
::::::::: {#variant.InvalidLegs.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidLegs.field.expected){.anchor
.field}`expected: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.InvalidLegs.field.expected
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidLegs.field.found){.anchor
.field}`found: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.InvalidLegs.field.found
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidLegs.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidLegs.field.reason
.section-header}
...
::: {#variant.InvalidCombination .section .variant}
[§](#variant.InvalidCombination){.anchor}

### InvalidCombination {#invalidcombination .code-header}
:::
...
::::::: {#variant.InvalidCombination.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidCombination.field.strategy_type){.anchor
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidCombination.field.strategy_type
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidCombination.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidCombination.field.reason
.section-header}
...
::: {#impl-Debug-for-StrategyErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#382){.src
.rightside}[§](#impl-Debug-for-StrategyErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-debug-for-strategyerrorkind .code-header}
:::
...
::: {#impl-Display-for-StrategyErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#382){.src
.rightside}[§](#impl-Display-for-StrategyErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-display-for-strategyerrorkind .code-header}
:::
...
::: {#impl-Error-for-StrategyErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#382){.src
.rightside}[§](#impl-Error-for-StrategyErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-error-for-strategyerrorkind .code-header}
:::
...
::: {#impl-PartialEq-for-StrategyErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#382){.src
.rightside}[§](#impl-PartialEq-for-StrategyErrorKind){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-partialeq-for-strategyerrorkind .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-strategyerrorkind---bool .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-StrategyErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#382){.src
.rightside}[§](#impl-StructuralPartialEq-for-StrategyErrorKind){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-structuralpartialeq-for-strategyerrorkind .code-header}
:::
::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-StrategyErrorKind .section .impl}
[§](#impl-Freeze-for-StrategyErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-freeze-for-strategyerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-StrategyErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-refunwindsafe-for-strategyerrorkind .code-header}
:::

::: {#impl-Send-for-StrategyErrorKind .section .impl}
[§](#impl-Send-for-StrategyErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-send-for-strategyerrorkind .code-header}
:::

::: {#impl-Sync-for-StrategyErrorKind .section .impl}
[§](#impl-Sync-for-StrategyErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-sync-for-strategyerrorkind .code-header}
:::

::: {#impl-Unpin-for-StrategyErrorKind .section .impl}
[§](#impl-Unpin-for-StrategyErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-unpin-for-strategyerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-UnwindSafe-for-StrategyErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::chains::StrategyErrorKind"){.enum} {#impl-unwindsafe-for-strategyerrorkind .code-header}
:::
:::::::::
