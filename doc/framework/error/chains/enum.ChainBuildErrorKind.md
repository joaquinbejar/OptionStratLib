...
# Enum [ChainBuildErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/chains.rs.html#261-301){.src}
]{.sub-heading}
::::
...
This enum captures three main categories of errors that can arise when
constructing or manipulating option chains. It provides structured error
information with detailed context about what went wrong during the chain
building process.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidParameters` - Represents errors related to invalid input
  parameters provided for chain construction, such as invalid price
  ranges, dates, or configuration settings.

- `VolatilityAdjustmentError` - Represents errors that occur during
  volatility adjustment calculations, typically related to skew factors
  or model parameters that cannot be properly applied.

- `StrikeGenerationError` - Represents errors that occur when generating
  strike prices for an option chain, such as invalid intervals,
  reference prices outside acceptable ranges, or other strike-specific
  issues.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in functions that build or modify
option chains, especially those dealing with strike price generation,
volatility adjustments, and parameter validation.
:::
...
[§](#variant.InvalidParameters){.anchor}
...
This variant is used when one or more input parameters don't meet the
required criteria for option chain construction.
:::
...
:::: sub-variant-field
[[§](#variant.InvalidParameters.field.parameter){.anchor
.field}`parameter: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidParameters.field.parameter
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidParameters.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidParameters.field.reason
.section-header}
...
::: {#variant.VolatilityAdjustmentError .section .variant}
[§](#variant.VolatilityAdjustmentError){.anchor}

### VolatilityAdjustmentError {#volatilityadjustmenterror .code-header}
:::
...
::::::: {#variant.VolatilityAdjustmentError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.VolatilityAdjustmentError.field.smile_curve){.anchor
.field}`smile_curve: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.VolatilityAdjustmentError.field.smile_curve
.section-header}
...
:::: sub-variant-field
[[§](#variant.VolatilityAdjustmentError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.VolatilityAdjustmentError.field.reason
.section-header}
...
::: {#variant.StrikeGenerationError .section .variant}
[§](#variant.StrikeGenerationError){.anchor}

### StrikeGenerationError {#strikegenerationerror .code-header}
:::

::: docblock
Error in strike price generation

This variant is used when the system cannot properly generate strike
prices for the option chain.
:::

::::::::: {#variant.StrikeGenerationError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.StrikeGenerationError.field.reference_price){.anchor
.field}`reference_price: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.StrikeGenerationError.field.reference_price
.section-header}
...
:::: sub-variant-field
[[§](#variant.StrikeGenerationError.field.interval){.anchor
.field}`interval: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.StrikeGenerationError.field.interval
.section-header}
...
:::: sub-variant-field
[[§](#variant.StrikeGenerationError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.StrikeGenerationError.field.reason
.section-header}
...
::: {#impl-Debug-for-ChainBuildErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#260){.src
.rightside}[§](#impl-Debug-for-ChainBuildErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-debug-for-chainbuilderrorkind .code-header}
:::
...
::: {#impl-Display-for-ChainBuildErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#260){.src
.rightside}[§](#impl-Display-for-ChainBuildErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-display-for-chainbuilderrorkind .code-header}
:::
...
::: {#impl-Error-for-ChainBuildErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#260){.src
.rightside}[§](#impl-Error-for-ChainBuildErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-error-for-chainbuilderrorkind .code-header}
:::
...
::: {#impl-Freeze-for-ChainBuildErrorKind .section .impl}
[§](#impl-Freeze-for-ChainBuildErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-freeze-for-chainbuilderrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-ChainBuildErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-ChainBuildErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-refunwindsafe-for-chainbuilderrorkind .code-header}
:::

::: {#impl-Send-for-ChainBuildErrorKind .section .impl}
[§](#impl-Send-for-ChainBuildErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-send-for-chainbuilderrorkind .code-header}
:::

::: {#impl-Sync-for-ChainBuildErrorKind .section .impl}
[§](#impl-Sync-for-ChainBuildErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-sync-for-chainbuilderrorkind .code-header}
:::

::: {#impl-Unpin-for-ChainBuildErrorKind .section .impl}
[§](#impl-Unpin-for-ChainBuildErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-unpin-for-chainbuilderrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-ChainBuildErrorKind .section .impl}
[§](#impl-UnwindSafe-for-ChainBuildErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-unwindsafe-for-chainbuilderrorkind .code-header}
:::
:::::::::
