...
[[Source](../../../src/optionstratlib/error/chains.rs.html#251-286){.src}
]{.sub-heading}
::::
...
.field}`parameter: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidParameters.field.parameter
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.VolatilityAdjustmentError.field.reason
.section-header}
...
.field}`reference_price: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#variant.StrikeGenerationError.field.reference_price
.section-header}
...
.field}`interval: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#variant.StrikeGenerationError.field.interval
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.StrikeGenerationError.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/chains.rs.html#250){.src
.rightside}[§](#impl-Debug-for-ChainBuildErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-debug-for-chainbuilderrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#436-465){.src
.rightside}[§](#impl-Display-for-ChainBuildErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-display-for-chainbuilderrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#437-464){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-freeze-for-chainbuilderrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-send-for-chainbuilderrorkind .code-header}
:::

::: {#impl-Sync-for-ChainBuildErrorKind .section .impl}
[§](#impl-Sync-for-ChainBuildErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-sync-for-chainbuilderrorkind .code-header}
:::

::: {#impl-Unpin-for-ChainBuildErrorKind .section .impl}
[§](#impl-Unpin-for-ChainBuildErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ChainBuildErrorKind](enum.ChainBuildErrorKind.html "enum optionstratlib::error::chains::ChainBuildErrorKind"){.enum} {#impl-unpin-for-chainbuilderrorkind .code-header}
:::
