...
# Enum [FileErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/chains.rs.html#327-360){.src}
]{.sub-heading}
::::
...
This enum captures three main categories of errors that can occur during
file handling operations: I/O errors from the standard library, format
validation errors, and data parsing errors. It provides structured error
information that includes detailed reasons for the error occurrence.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `IOError` - Represents low-level input/output errors from the Rust
  standard library, such as permission issues, file not found, or
  network failures when reading files.

- `InvalidFormat` - Represents errors related to file format validation,
  such as incorrect headers, unsupported format versions, or malformed
  data structures.

- `ParseError` - Represents errors occurring during the parsing of file
  contents, providing context about the specific line and content that
  caused the error.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in file handling operations, data
import/export functionality, and file-based data processing pipelines
where structured error reporting is important for debugging and user
feedback.
:::
...
### IOError([Error](https://doc.rust-lang.org/1.91.1/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}) {#ioerrorerror .code-header}
:::

::: docblock
Error when reading or writing a file

This variant wraps a standard library I/O error and is used for
low-level file system operations that fail.
:::

::: {#variant.InvalidFormat .section .variant}
[§](#variant.InvalidFormat){.anchor}

### InvalidFormat {#invalidformat .code-header}
:::
...
::::::: {#variant.InvalidFormat.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidFormat.field.format){.anchor
.field}`format: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidFormat.field.format
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidFormat.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidFormat.field.reason
.section-header}
...
::: {#variant.ParseError .section .variant}
[§](#variant.ParseError){.anchor}

### ParseError {#parseerror .code-header}
:::
...
::::::::: {#variant.ParseError.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.ParseError.field.line){.anchor
.field}`line: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.ParseError.field.line
.section-header}

::: docblock
The line number where the parsing error occurred (0-based or 1-based,
depending on implementation)
:::
::::

:::: sub-variant-field
[[§](#variant.ParseError.field.content){.anchor
.field}`content: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ParseError.field.content
.section-header}
...
:::: sub-variant-field
[[§](#variant.ParseError.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ParseError.field.reason
.section-header}
...
::: {#impl-Debug-for-FileErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#326){.src
.rightside}[§](#impl-Debug-for-FileErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-debug-for-fileerrorkind .code-header}
:::
...
::: {#impl-Display-for-FileErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#326){.src
.rightside}[§](#impl-Display-for-FileErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-display-for-fileerrorkind .code-header}
:::
...
::: {#impl-Error-for-FileErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#326){.src
.rightside}[§](#impl-Error-for-FileErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-error-for-fileerrorkind .code-header}
:::
...
::: {#impl-From%3CError%3E-for-FileErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#333){.src
.rightside}[§](#impl-From%3CError%3E-for-FileErrorKind){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[Error](https://doc.rust-lang.org/1.91.1/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}\> for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-fromerror-for-fileerrorkind .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [Error](https://doc.rust-lang.org/1.91.1/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}) -\> Self {#fn-fromsource-error---self .code-header}
:::
...
::: {#impl-Freeze-for-FileErrorKind .section .impl}
[§](#impl-Freeze-for-FileErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-freeze-for-fileerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-FileErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-FileErrorKind){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-refunwindsafe-for-fileerrorkind .code-header}
:::

::: {#impl-Send-for-FileErrorKind .section .impl}
[§](#impl-Send-for-FileErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-send-for-fileerrorkind .code-header}
:::

::: {#impl-Sync-for-FileErrorKind .section .impl}
[§](#impl-Sync-for-FileErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-sync-for-fileerrorkind .code-header}
:::

::: {#impl-Unpin-for-FileErrorKind .section .impl}
[§](#impl-Unpin-for-FileErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-unpin-for-fileerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-FileErrorKind .section .impl}
[§](#impl-UnwindSafe-for-FileErrorKind){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-unwindsafe-for-fileerrorkind .code-header}
:::
:::::::::
