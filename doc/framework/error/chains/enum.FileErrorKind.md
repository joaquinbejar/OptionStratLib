...
[[Source](../../../src/optionstratlib/error/chains.rs.html#312-342){.src}
]{.sub-heading}
::::
...
### IOError([Error](https://doc.rust-lang.org/1.86.0/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}) {#ioerrorerror .code-header}
:::
...
.field}`format: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidFormat.field.format
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidFormat.field.reason
.section-header}
...
.field}`line: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.ParseError.field.line
.section-header}
...
.field}`content: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ParseError.field.content
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ParseError.field.reason
.section-header}
...
[Source](../../../src/optionstratlib/error/chains.rs.html#311){.src
.rightside}[§](#impl-Debug-for-FileErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-debug-for-fileerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#467-487){.src
.rightside}[§](#impl-Display-for-FileErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-display-for-fileerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#468-486){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-freeze-for-fileerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-FileErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-FileErrorKind){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-refunwindsafe-for-fileerrorkind .code-header}
:::

::: {#impl-Send-for-FileErrorKind .section .impl}
[§](#impl-Send-for-FileErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-send-for-fileerrorkind .code-header}
:::

::: {#impl-Sync-for-FileErrorKind .section .impl}
[§](#impl-Sync-for-FileErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-sync-for-fileerrorkind .code-header}
:::

::: {#impl-Unpin-for-FileErrorKind .section .impl}
[§](#impl-Unpin-for-FileErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-unpin-for-fileerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-FileErrorKind .section .impl}
[§](#impl-UnwindSafe-for-FileErrorKind){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [FileErrorKind](enum.FileErrorKind.html "enum optionstratlib::error::chains::FileErrorKind"){.enum} {#impl-unwindsafe-for-fileerrorkind .code-header}
:::
:::::::::
