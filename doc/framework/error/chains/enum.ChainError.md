...
[[Source](../../../src/optionstratlib/error/chains.rs.html#92-130){.src}
]{.sub-heading}
::::
...
.field}`message: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.DynError.field.message
.section-header}
...
[Source](../../../src/optionstratlib/error/chains.rs.html#439-543){.src
...
[Source](../../../src/optionstratlib/error/chains.rs.html#453-458){.src
.rightside}

#### pub fn [invalid_strike](#method.invalid_strike){.fn}(strike: [f64](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_strikestrike-f64-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#473-478){.src
.rightside}

#### pub fn [invalid_volatility](#method.invalid_volatility){.fn}(volatility: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[f64](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}\>, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_volatilityvolatility-optionf64-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#494-500){.src
.rightside}

#### pub fn [invalid_prices](#method.invalid_prices){.fn}(bid: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[f64](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}\>, ask: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[f64](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}\>, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_pricesbid-optionf64-ask-optionf64-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#516-522){.src
.rightside}

#### pub fn [invalid_legs](#method.invalid_legs){.fn}(expected: [usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}, found: [usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_legsexpected-usize-found-usize-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#537-542){.src
.rightside}

#### pub fn [invalid_parameters](#method.invalid_parameters){.fn}(parameter: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_parametersparameter-str-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#91){.src
.rightside}[§](#impl-Debug-for-ChainError){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-debug-for-chainerror .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-display-for-chainerror .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-error-for-chainerror .code-header}
:::
...
::: {#impl-From%3C%26str%3E-for-ChainError .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#551-555){.src
.rightside}[§](#impl-From%3C%26str%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<&[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromstr-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-4 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#552-554){.src
...
[Source](../../../src/optionstratlib/error/chains.rs.html#563-569){.src
...
[Source](../../../src/optionstratlib/error/chains.rs.html#564-568){.src
...
::: {#impl-From%3CChainError%3E-for-Error .section .impl}
[Source](../../../src/optionstratlib/error/unified.rs.html#47){.src
.rightside}[§](#impl-From%3CChainError%3E-for-Error){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum}\> for [Error](../unified/enum.Error.html "enum optionstratlib::error::unified::Error"){.enum} {#impl-fromchainerror-for-error .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum}) -\> Self {#fn-fromsource-chainerror---self .code-header}
:::
...
::: {#impl-From%3CCurveError%3E-for-ChainError .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#603-607){.src
.rightside}[§](#impl-From%3CCurveError%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[CurveError](../curves/enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromcurveerror-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-11 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#604-606){.src
...
### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[DecimalError](../decimal/enum.DecimalError.html "enum optionstratlib::error::decimal::DecimalError"){.enum}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromdecimalerror-for-chainerror .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#420-424){.src
.rightside}[§](#impl-From%3CError%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[Error](https://doc.rust-lang.org/1.91.1/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromerror-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#421-423){.src
.rightside}[§](#method.from-1){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(error: [Error](https://doc.rust-lang.org/1.91.1/std/io/error/struct.Error.html "struct std::io::error::Error"){.struct}) -\> Self {#fn-fromerror-error---self .code-header}
:::
...
::: {#impl-From%3CError%3E-for-ChainError-1 .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#571-579){.src
.rightside}[§](#impl-From%3CError%3E-for-ChainError-1){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[Error](../../../csv/error/struct.Error.html "struct csv::error::Error"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromerror-for-chainerror-1 .code-header}
:::

::::: impl-items
::: {#method.from-7 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#572-578){.src
.rightside}[§](#method.from-7){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [Error](../../../csv/error/struct.Error.html "struct csv::error::Error"){.struct}) -\> Self {#fn-fromerr-error---self .code-header}
:::
...
::: {#impl-From%3CError%3E-for-ChainError-2 .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#581-589){.src
.rightside}[§](#impl-From%3CError%3E-for-ChainError-2){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[Error](../../../serde_json/error/struct.Error.html "struct serde_json::error::Error"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromerror-for-chainerror-2 .code-header}
:::

::::: impl-items
::: {#method.from-8 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#582-588){.src
.rightside}[§](#method.from-8){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [Error](../../../serde_json/error/struct.Error.html "struct serde_json::error::Error"){.struct}) -\> Self {#fn-fromerr-error---self-1 .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#557-561){.src
...
[Source](../../../src/optionstratlib/error/chains.rs.html#558-560){.src
.rightside}[§](#method.from-5){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [GreeksError](../greeks/enum.GreeksError.html "enum optionstratlib::error::greeks::GreeksError"){.enum}) -\> Self {#fn-fromerr-greekserror---self .code-header}
:::
...
::: {#impl-From%3CParseError%3E-for-ChainError .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#591-595){.src
.rightside}[§](#impl-From%3CParseError%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[ParseError](../../../chrono/format/struct.ParseError.html "struct chrono::format::ParseError"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromparseerror-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-9 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#592-594){.src
.rightside}[§](#method.from-9){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [ParseError](../../../chrono/format/struct.ParseError.html "struct chrono::format::ParseError"){.struct}) -\> Self {#fn-fromerr-parseerror---self .code-header}
:::
...
::: {#impl-From%3CParseIntError%3E-for-ChainError .section .impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#597-601){.src
.rightside}[§](#impl-From%3CParseIntError%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[ParseIntError](https://doc.rust-lang.org/1.91.1/core/num/error/struct.ParseIntError.html "struct core::num::error::ParseIntError"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromparseinterror-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-10 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#598-600){.src
.rightside}[§](#method.from-10){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [ParseIntError](https://doc.rust-lang.org/1.91.1/core/num/error/struct.ParseIntError.html "struct core::num::error::ParseIntError"){.struct}) -\> Self {#fn-fromerr-parseinterror---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/chains.rs.html#545-549){.src
.rightside}[§](#impl-From%3CString%3E-for-ChainError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}\> for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromstring-for-chainerror .code-header}
:::

::::: impl-items
::: {#method.from-3 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/chains.rs.html#546-548){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-freeze-for-chainerror .code-header}
:::

::: {#impl-RefUnwindSafe-for-ChainError .section .impl}
[§](#impl-RefUnwindSafe-for-ChainError){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-refunwindsafe-for-chainerror .code-header}
:::

::: {#impl-Send-for-ChainError .section .impl}
[§](#impl-Send-for-ChainError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-send-for-chainerror .code-header}
:::

::: {#impl-Sync-for-ChainError .section .impl}
[§](#impl-Sync-for-ChainError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-sync-for-chainerror .code-header}
:::

::: {#impl-Unpin-for-ChainError .section .impl}
[§](#impl-Unpin-for-ChainError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-unpin-for-chainerror .code-header}
:::

::: {#impl-UnwindSafe-for-ChainError .section .impl}
[§](#impl-UnwindSafe-for-ChainError){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ChainError](enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-unwindsafe-for-chainerror .code-header}
:::
:::::::::
