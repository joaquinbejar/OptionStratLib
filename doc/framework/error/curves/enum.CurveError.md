...
[[Source](../../../src/optionstratlib/error/curves.rs.html#94-163){.src}
]{.sub-heading}
::::
...
.field}`reason: &'static `[`str`](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}]{#variant.Point2DError.field.reason
.section-header}
...
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.StdError.field.reason
.section-header}
...
### InterpolationError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#interpolationerrorstring .code-header}
:::
...
.field}`0: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InterpolationError.field.0
.section-header}
...
### ConstructionError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#constructionerrorstring .code-header}
:::
...
.field}`0: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.ConstructionError.field.0
.section-header}
...
### AnalysisError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#analysiserrorstring .code-header}
:::
...
.field}`0: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.AnalysisError.field.0
.section-header}
...
### MetricsError([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#metricserrorstring .code-header}
:::
...
.field}`0: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.MetricsError.field.0
.section-header}
...
::: {#variant.InterpolationOp .section .variant}
[§](#variant.InterpolationOp){.anchor}

### InterpolationOp([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#interpolationopstring .code-header}
:::
...
::: {#variant.Graph .section .variant}
[§](#variant.Graph){.anchor}

### Graph([Box](https://doc.rust-lang.org/1.91.1/alloc/boxed/struct.Box.html "struct alloc::boxed::Box"){.struct}\<[GraphError](../enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum}\>) {#graphboxgrapherror .code-header}
:::
...
[Source](../../../src/optionstratlib/error/curves.rs.html#176-212){.src
...
[Source](../../../src/optionstratlib/error/curves.rs.html#188-193){.src
.rightside}

#### pub fn [operation_not_supported](#method.operation_not_supported){.fn}(operation: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-operation_not_supportedoperation-str-reason-str---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/curves.rs.html#206-211){.src
.rightside}

#### pub fn [invalid_parameters](#method.invalid_parameters){.fn}(operation: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}, reason: &[str](https://doc.rust-lang.org/1.91.1/std/primitive.str.html){.primitive}) -\> Self {#pub-fn-invalid_parametersoperation-str-reason-str---self .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-debug-for-curveerror .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-display-for-curveerror .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-error-for-curveerror .code-header}
:::
...
[Source](../../../src/optionstratlib/error/curves.rs.html#295-301){.src
...
[Source](../../../src/optionstratlib/error/curves.rs.html#296-300){.src
...
### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}\> for [ChainError](../chains/enum.ChainError.html "enum optionstratlib::error::chains::ChainError"){.enum} {#impl-fromcurveerror-for-chainerror .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromerr-curveerror---self .code-header}
:::
...
::: {#impl-From%3CCurveError%3E-for-Error .section .impl}
[Source](../../../src/optionstratlib/error/unified.rs.html#63){.src
.rightside}[§](#impl-From%3CCurveError%3E-for-Error){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}\> for [Error](../unified/enum.Error.html "enum optionstratlib::error::unified::Error"){.enum} {#impl-fromcurveerror-for-error .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromsource-curveerror---self .code-header}
:::
...
::: {#impl-From%3CCurveError%3E-for-GraphError .section .impl}
[Source](../../../src/optionstratlib/error/graph.rs.html#30-34){.src
.rightside}[§](#impl-From%3CCurveError%3E-for-GraphError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}\> for [GraphError](../enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum} {#impl-fromcurveerror-for-grapherror .code-header}
:::

::::: impl-items
::: {#method.from-10 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/graph.rs.html#31-33){.src
.rightside}[§](#method.from-10){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromerr-curveerror---self-1 .code-header}
:::
...
#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromerr-curveerror---self-2 .code-header}
:::
...
[Source](../../../src/optionstratlib/error/metrics.rs.html#63){.src
...
[Source](../../../src/optionstratlib/error/metrics.rs.html#35){.src
.rightside}[§](#method.from-9){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(source: [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum}) -\> Self {#fn-fromsource-curveerror---self-1 .code-header}
:::
...
::: {#impl-From%3CGraphError%3E-for-CurveError .section .impl}
[Source](../../../src/optionstratlib/error/curves.rs.html#289-293){.src
.rightside}[§](#impl-From%3CGraphError%3E-for-CurveError){.anchor}

### impl [From](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html "trait core::convert::From"){.trait}\<[GraphError](../enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum}\> for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-fromgrapherror-for-curveerror .code-header}
:::

::::: impl-items
::: {#method.from-6 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/curves.rs.html#290-292){.src
.rightside}[§](#method.from-6){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [GraphError](../enum.GraphError.html "enum optionstratlib::error::GraphError"){.enum}) -\> Self {#fn-fromerr-grapherror---self .code-header}
:::
...
[Source](../../../src/optionstratlib/error/curves.rs.html#154){.src
...
[Source](../../../src/optionstratlib/error/curves.rs.html#277-281){.src
...
[Source](../../../src/optionstratlib/error/curves.rs.html#278-280){.src
.rightside}[§](#method.from-4){.anchor}

#### fn [from](https://doc.rust-lang.org/1.91.1/core/convert/trait.From.html#tymethod.from){.fn}(err: [MetricsError](../enum.MetricsError.html "enum optionstratlib::error::MetricsError"){.enum}) -\> Self {#fn-fromerr-metricserror---self .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-freeze-for-curveerror .code-header}
:::

::: {#impl-RefUnwindSafe-for-CurveError .section .impl}
[§](#impl-RefUnwindSafe-for-CurveError){.anchor}

### impl \![RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-refunwindsafe-for-curveerror .code-header}
:::

::: {#impl-Send-for-CurveError .section .impl}
[§](#impl-Send-for-CurveError){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-send-for-curveerror .code-header}
:::

::: {#impl-Sync-for-CurveError .section .impl}
[§](#impl-Sync-for-CurveError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-sync-for-curveerror .code-header}
:::

::: {#impl-Unpin-for-CurveError .section .impl}
[§](#impl-Unpin-for-CurveError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-unpin-for-curveerror .code-header}
:::

::: {#impl-UnwindSafe-for-CurveError .section .impl}
[§](#impl-UnwindSafe-for-CurveError){.anchor}

### impl \![UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [CurveError](enum.CurveError.html "enum optionstratlib::error::curves::CurveError"){.enum} {#impl-unwindsafe-for-curveerror .code-header}
:::
:::::::::
