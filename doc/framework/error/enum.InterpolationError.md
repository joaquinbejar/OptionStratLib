...
[[Source](../../src/optionstratlib/error/interpolation.rs.html#19-49){.src}
]{.sub-heading}
::::
...
### Linear([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#linearstring .code-header}
:::
...
### Bilinear([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#bilinearstring .code-header}
:::
...
### Cubic([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#cubicstring .code-header}
:::
...
### Spline([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#splinestring .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-debug-for-interpolationerror .code-header}
:::
...
[Source](../../src/optionstratlib/error/interpolation.rs.html#53-63){.src
.rightside}[§](#impl-Display-for-InterpolationError){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-display-for-interpolationerror .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/error/interpolation.rs.html#54-62){.src
...
[Source](../../src/optionstratlib/error/interpolation.rs.html#51){.src
.rightside}[§](#impl-Error-for-InterpolationError){.anchor}

### impl [Error](https://doc.rust-lang.org/1.86.0/core/error/trait.Error.html "trait core::error::Error"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-error-for-interpolationerror .code-header}
:::
...
[Source](../../src/optionstratlib/error/interpolation.rs.html#83-87){.src
...
[Source](../../src/optionstratlib/error/interpolation.rs.html#84-86){.src
...
#### fn [from](https://doc.rust-lang.org/1.86.0/core/convert/trait.From.html#tymethod.from){.fn}(err: [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum}) -\> Self {#fn-fromerr-interpolationerror---self-1 .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-freeze-for-interpolationerror .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-send-for-interpolationerror .code-header}
:::

::: {#impl-Sync-for-InterpolationError .section .impl}
[§](#impl-Sync-for-InterpolationError){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-sync-for-interpolationerror .code-header}
:::

::: {#impl-Unpin-for-InterpolationError .section .impl}
[§](#impl-Unpin-for-InterpolationError){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-unpin-for-interpolationerror .code-header}
:::

::: {#impl-UnwindSafe-for-InterpolationError .section .impl}
[§](#impl-UnwindSafe-for-InterpolationError){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [InterpolationError](enum.InterpolationError.html "enum optionstratlib::error::InterpolationError"){.enum} {#impl-unwindsafe-for-interpolationerror .code-header}
:::
:::::::::
