...
# Enum [PositionLimitErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/position.rs.html#279-305){.src}
]{.sub-heading}
::::
...
This enum captures different types of limit violations that can occur
when managing trading positions, such as exceeding the maximum number of
allowed positions or reaching the maximum exposure threshold for a
portfolio.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `MaxPositionsReached` - Error indicating that the maximum number of
  allowed positions has been reached, preventing the creation of
  additional positions.

- `MaxExposureReached` - Error indicating that the maximum allowed
  financial exposure has been reached, preventing positions that would
  increase exposure.

## [§](#usage){.doc-anchor}Usage

This error type is typically used in position management systems, risk
control mechanisms, and trading platforms to enforce safety limits and
...
::::::::::::::::: variants
::: {#variant.MaxPositionsReached .section .variant}
[§](#variant.MaxPositionsReached){.anchor}

### MaxPositionsReached {#maxpositionsreached .code-header}
:::
...
::::::: {#variant.MaxPositionsReached.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.MaxPositionsReached.field.current){.anchor
.field}`current: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.MaxPositionsReached.field.current
.section-header}
...
:::: sub-variant-field
[[§](#variant.MaxPositionsReached.field.maximum){.anchor
.field}`maximum: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.MaxPositionsReached.field.maximum
.section-header}
...
::: {#variant.MaxExposureReached .section .variant}
[§](#variant.MaxExposureReached){.anchor}

### MaxExposureReached {#maxexposurereached .code-header}
:::

::: docblock
Error indicating the maximum allowed exposure has been reached

This variant is triggered when a new position or modification would
cause the total portfolio exposure to exceed the configured maximum risk
threshold. Exposure is typically measured in monetary terms based on
position value or risk.
:::

::::::: {#variant.MaxExposureReached.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.MaxExposureReached.field.current_exposure){.anchor
.field}`current_exposure: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.MaxExposureReached.field.current_exposure
.section-header}
...
:::: sub-variant-field
[[§](#variant.MaxExposureReached.field.max_exposure){.anchor
.field}`max_exposure: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.MaxExposureReached.field.max_exposure
.section-header}
...
::: {#impl-Debug-for-PositionLimitErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#278){.src
.rightside}[§](#impl-Debug-for-PositionLimitErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-debug-for-positionlimiterrorkind .code-header}
:::
...
::: {#impl-Display-for-PositionLimitErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#278){.src
.rightside}[§](#impl-Display-for-PositionLimitErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-display-for-positionlimiterrorkind .code-header}
:::
...
::: {#impl-Error-for-PositionLimitErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#278){.src
.rightside}[§](#impl-Error-for-PositionLimitErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-error-for-positionlimiterrorkind .code-header}
:::
...
::: {#impl-Freeze-for-PositionLimitErrorKind .section .impl}
[§](#impl-Freeze-for-PositionLimitErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-freeze-for-positionlimiterrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-PositionLimitErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-PositionLimitErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-refunwindsafe-for-positionlimiterrorkind .code-header}
:::

::: {#impl-Send-for-PositionLimitErrorKind .section .impl}
[§](#impl-Send-for-PositionLimitErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-send-for-positionlimiterrorkind .code-header}
:::

::: {#impl-Sync-for-PositionLimitErrorKind .section .impl}
[§](#impl-Sync-for-PositionLimitErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-sync-for-positionlimiterrorkind .code-header}
:::

::: {#impl-Unpin-for-PositionLimitErrorKind .section .impl}
[§](#impl-Unpin-for-PositionLimitErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-unpin-for-positionlimiterrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-PositionLimitErrorKind .section .impl}
[§](#impl-UnwindSafe-for-PositionLimitErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PositionLimitErrorKind](enum.PositionLimitErrorKind.html "enum optionstratlib::error::position::PositionLimitErrorKind"){.enum} {#impl-unwindsafe-for-positionlimiterrorkind .code-header}
:::
:::::::::
