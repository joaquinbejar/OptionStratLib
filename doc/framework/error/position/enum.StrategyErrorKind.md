...
[[Source](../../../src/optionstratlib/error/position.rs.html#132-163){.src}
]{.sub-heading}
::::
...
These errors typically occur during strategy management operations such
as adding positions, updating configurations, or executing trades.
...
Used when validating and executing strategy operations to provide
detailed error information about why an operation could not be
completed.
:::
...
::::::::::::::::::: variants
::: {#variant.UnsupportedOperation .section .variant}
[§](#variant.UnsupportedOperation){.anchor}

### UnsupportedOperation {#unsupportedoperation .code-header}
:::
...
::::::: {#variant.UnsupportedOperation.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.UnsupportedOperation.field.strategy_type){.anchor
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.UnsupportedOperation.field.strategy_type
.section-header}
...
:::: sub-variant-field
[[§](#variant.UnsupportedOperation.field.operation){.anchor
.field}`operation: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.UnsupportedOperation.field.operation
.section-header}
...
::: {#variant.StrategyFull .section .variant}
[§](#variant.StrategyFull){.anchor}

### StrategyFull {#strategyfull .code-header}
:::
...
::::::: {#variant.StrategyFull.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.StrategyFull.field.strategy_type){.anchor
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.StrategyFull.field.strategy_type
.section-header}
...
:::: sub-variant-field
[[§](#variant.StrategyFull.field.max_positions){.anchor
.field}`max_positions: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.StrategyFull.field.max_positions
.section-header}
...
::: {#variant.InvalidConfiguration .section .variant}
[§](#variant.InvalidConfiguration){.anchor}

### InvalidConfiguration([String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#invalidconfigurationstring .code-header}
:::

::: docblock
Invalid strategy configuration

Occurs when the strategy's configuration parameters are invalid or
inconsistent.
:::
:::::::::::::::::::
...
[Source](../../../src/optionstratlib/error/position.rs.html#131){.src
.rightside}[§](#impl-Debug-for-StrategyErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-debug-for-strategyerrorkind .code-header}
:::
...
### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-display-for-strategyerrorkind .code-header}
:::
...
### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-error-for-strategyerrorkind .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-freeze-for-strategyerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-StrategyErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-refunwindsafe-for-strategyerrorkind .code-header}
:::

::: {#impl-Send-for-StrategyErrorKind .section .impl}
[§](#impl-Send-for-StrategyErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-send-for-strategyerrorkind .code-header}
:::

::: {#impl-Sync-for-StrategyErrorKind .section .impl}
[§](#impl-Sync-for-StrategyErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-sync-for-strategyerrorkind .code-header}
:::

::: {#impl-Unpin-for-StrategyErrorKind .section .impl}
[§](#impl-Unpin-for-StrategyErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-unpin-for-strategyerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-UnwindSafe-for-StrategyErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-unwindsafe-for-strategyerrorkind .code-header}
:::
:::::::::
