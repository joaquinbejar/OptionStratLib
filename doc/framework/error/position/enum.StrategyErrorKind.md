...
[[Source](../../../src/optionstratlib/error/position.rs.html#129-157){.src}
]{.sub-heading}
::::
...
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.UnsupportedOperation.field.strategy_type
.section-header}
...
.field}`operation: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.UnsupportedOperation.field.operation
.section-header}
...
.field}`strategy_type: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.StrategyFull.field.strategy_type
.section-header}
...
.field}`max_positions: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.StrategyFull.field.max_positions
.section-header}
...
### InvalidConfiguration([String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) {#invalidconfigurationstring .code-header}
:::
...
[Source](../../../src/optionstratlib/error/position.rs.html#128){.src
.rightside}[§](#impl-Debug-for-StrategyErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-debug-for-strategyerrorkind .code-header}
:::
...
[Source](../../../src/optionstratlib/error/position.rs.html#305-333){.src
.rightside}[§](#impl-Display-for-StrategyErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-display-for-strategyerrorkind .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/error/position.rs.html#306-332){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-freeze-for-strategyerrorkind .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-send-for-strategyerrorkind .code-header}
:::

::: {#impl-Sync-for-StrategyErrorKind .section .impl}
[§](#impl-Sync-for-StrategyErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-sync-for-strategyerrorkind .code-header}
:::

::: {#impl-Unpin-for-StrategyErrorKind .section .impl}
[§](#impl-Unpin-for-StrategyErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-unpin-for-strategyerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyErrorKind .section .impl}
[§](#impl-UnwindSafe-for-StrategyErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyErrorKind](enum.StrategyErrorKind.html "enum optionstratlib::error::position::StrategyErrorKind"){.enum} {#impl-unwindsafe-for-strategyerrorkind .code-header}
:::
:::::::::
