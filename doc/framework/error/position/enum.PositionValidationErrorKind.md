...
# Enum [PositionValidationErrorKind]{.enum} Copy item path

[[Source](../../../src/optionstratlib/error/position.rs.html#190-256){.src}
]{.sub-heading}
::::
...
This enum represents errors that can occur during position validation
checks. These errors typically happen when attempting to create or
modify a position with invalid or incompatible parameters.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `InvalidSize` - The position size is invalid (e.g., zero, negative, or
  too large).

- `InvalidPrice` - The position price is invalid (e.g., negative or
  unrealistic).

- `IncompatibleSide` - The position side (long/short) is incompatible
  with the strategy.

- `IncompatibleStyle` - The option style is incompatible with the
  strategy.

- `InvalidPosition` - The position is invalid for other specific
  reasons.
...
Used when validating positions to ensure they meet all requirements
before being added to a strategy or executed in a trading system.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::::::::::::::::::::::::::::: variants
::: {#variant.InvalidSize .section .variant}
[§](#variant.InvalidSize){.anchor}

### InvalidSize {#invalidsize .code-header}
:::
...
::::::: {#variant.InvalidSize.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidSize.field.size){.anchor
.field}`size: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidSize.field.size
.section-header}
...
:::: sub-variant-field
[[§](#variant.InvalidSize.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidSize.field.reason
.section-header}
...
Occurs when the specified price violates price constraints or is
unrealistic.
:::
...
.field}`price: `[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}]{#variant.InvalidPrice.field.price
.section-header}
...
::: {#variant.IncompatibleSide .section .variant}
[§](#variant.IncompatibleSide){.anchor}

### IncompatibleSide {#incompatibleside .code-header}
:::

::: docblock
Position type is incompatible with strategy

Occurs when the position side (long/short) conflicts with strategy
requirements.
:::

::::::: {#variant.IncompatibleSide.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.IncompatibleSide.field.position_side){.anchor
.field}`position_side: `[`Side`](../../model/types/enum.Side.html "enum optionstratlib::model::types::Side"){.enum}]{#variant.IncompatibleSide.field.position_side
.section-header}
...
:::: sub-variant-field
[[§](#variant.IncompatibleSide.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.IncompatibleSide.field.reason
.section-header}
...
::: {#variant.IncompatibleStyle .section .variant}
[§](#variant.IncompatibleStyle){.anchor}

### IncompatibleStyle {#incompatiblestyle .code-header}
:::

::: docblock
Option style is incompatible with strategy

Occurs when the option style (American/European) conflicts with strategy
requirements.
:::

::::::: {#variant.IncompatibleStyle.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.IncompatibleStyle.field.style){.anchor
.field}`style: `[`OptionStyle`](../../model/types/enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}]{#variant.IncompatibleStyle.field.style
.section-header}
...
:::: sub-variant-field
[[§](#variant.IncompatibleStyle.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.IncompatibleStyle.field.reason
.section-header}
...
::: {#variant.InvalidPosition .section .variant}
[§](#variant.InvalidPosition){.anchor}

### InvalidPosition {#invalidposition .code-header}
:::

::: docblock
Position is invalid for other reasons

A general error for positions that fail validation for reasons not
covered by other variants.
:::

::::: {#variant.InvalidPosition.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.InvalidPosition.field.reason){.anchor
.field}`reason: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#variant.InvalidPosition.field.reason
.section-header}
...
::: {#impl-Debug-for-PositionValidationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#189){.src
.rightside}[§](#impl-Debug-for-PositionValidationErrorKind){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-debug-for-positionvalidationerrorkind .code-header}
:::
...
::: {#impl-Display-for-PositionValidationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#189){.src
.rightside}[§](#impl-Display-for-PositionValidationErrorKind){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-display-for-positionvalidationerrorkind .code-header}
:::
...
::: {#impl-Error-for-PositionValidationErrorKind .section .impl}
[Source](../../../src/optionstratlib/error/position.rs.html#189){.src
.rightside}[§](#impl-Error-for-PositionValidationErrorKind){.anchor}

### impl [Error](https://doc.rust-lang.org/1.91.1/core/error/trait.Error.html "trait core::error::Error"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-error-for-positionvalidationerrorkind .code-header}
:::
...
::: {#impl-Freeze-for-PositionValidationErrorKind .section .impl}
[§](#impl-Freeze-for-PositionValidationErrorKind){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-freeze-for-positionvalidationerrorkind .code-header}
:::

::: {#impl-RefUnwindSafe-for-PositionValidationErrorKind .section .impl}
[§](#impl-RefUnwindSafe-for-PositionValidationErrorKind){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-refunwindsafe-for-positionvalidationerrorkind .code-header}
:::

::: {#impl-Send-for-PositionValidationErrorKind .section .impl}
[§](#impl-Send-for-PositionValidationErrorKind){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-send-for-positionvalidationerrorkind .code-header}
:::

::: {#impl-Sync-for-PositionValidationErrorKind .section .impl}
[§](#impl-Sync-for-PositionValidationErrorKind){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-sync-for-positionvalidationerrorkind .code-header}
:::

::: {#impl-Unpin-for-PositionValidationErrorKind .section .impl}
[§](#impl-Unpin-for-PositionValidationErrorKind){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-unpin-for-positionvalidationerrorkind .code-header}
:::

::: {#impl-UnwindSafe-for-PositionValidationErrorKind .section .impl}
[§](#impl-UnwindSafe-for-PositionValidationErrorKind){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PositionValidationErrorKind](enum.PositionValidationErrorKind.html "enum optionstratlib::error::position::PositionValidationErrorKind"){.enum} {#impl-unwindsafe-for-positionvalidationerrorkind .code-header}
:::
:::::::::
