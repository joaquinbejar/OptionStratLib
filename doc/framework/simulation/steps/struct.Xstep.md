...
#### pub fn [new](#method.new){.fn}(value: T, time_unit: [TimeFrame](../../utils/time/enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum}, datetime: [ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}) -\> Self {#pub-fn-newvalue-t-time_unit-timeframe-datetime-expirationdate---self .code-header}
:::
...
#### pub fn [index](#method.index){.fn}(&self) -\> &[i32](https://doc.rust-lang.org/1.91.1/std/primitive.i32.html){.primitive} {#pub-fn-indexself---i32 .code-header}
:::
...
#### pub fn [step_size_in_time](#method.step_size_in_time){.fn}(&self) -\> [&T](https://doc.rust-lang.org/1.91.1/std/primitive.reference.html){.primitive} {#pub-fn-step_size_in_timeself---t .code-header}
:::
...
#### pub fn [datetime](#method.datetime){.fn}(&self) -\> &[ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum} {#pub-fn-datetimeself---expirationdate .code-header}
:::
...
#### pub fn [days_left](#method.days_left){.fn}(&self) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, [SimulationError](../../error/simulation/enum.SimulationError.html "enum optionstratlib::error::simulation::SimulationError"){.enum}\> {#pub-fn-days_leftself---resultpositive-simulationerror .code-header}
:::
...
- `Result<Positive, SimulationError>` - A positive decimal value
...
#### pub fn [next](#method.next){.fn}(&self) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<Self, [SimulationError](../../error/simulation/enum.SimulationError.html "enum optionstratlib::error::simulation::SimulationError"){.enum}\> {#pub-fn-nextself---resultself-simulationerror .code-header}
:::
...
#### pub fn [previous](#method.previous){.fn}(&self) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<Self, [SimulationError](../../error/simulation/enum.SimulationError.html "enum optionstratlib::error::simulation::SimulationError"){.enum}\> {#pub-fn-previousself---resultself-simulationerror .code-header}
:::
...
### impl\<T\> [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-clone-for-xstept .code-header}
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#fn-cloneself---xstept .code-header}
:::
...
### impl\<T\> [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-debug-for-xstept .code-header}
...
### impl\<T\> [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-display-for-xstept .code-header}
...
### impl\<T\> [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-serialize-for-xstept .code-header}
...
### impl\<T\> [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-copy-for-xstept .code-header}
...
### impl\<T\> [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-freeze-for-xstept .code-header}
...
### impl\<T\> [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-refunwindsafe-for-xstept .code-header}
...
### impl\<T\> [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-send-for-xstept .code-header}
...
### impl\<T\> [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-sync-for-xstept .code-header}
...
### impl\<T\> [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-unpin-for-xstept .code-header}
...
### impl\<T\> [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Xstep](struct.Xstep.html "struct optionstratlib::simulation::steps::Xstep"){.struct}\<T\> {#implt-unwindsafe-for-xstept .code-header}
