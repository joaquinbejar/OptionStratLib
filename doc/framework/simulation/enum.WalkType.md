...
[[Source](../../src/optionstratlib/simulation/model.rs.html#10-164){.src}
]{.sub-heading}
::::
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Brownian.field.drift
.section-header}
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.GeometricBrownian.field.drift
.section-header}
...
.field}`expected_return: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.LogReturns.field.expected_return
.section-header}
...
.field}`autocorrelation: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`>`]{#variant.LogReturns.field.autocorrelation
.section-header}
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.JumpDiffusion.field.drift
.section-header}
...
.field}`jump_mean: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.JumpDiffusion.field.jump_mean
.section-header}
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Garch.field.drift
.section-header}
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Heston.field.drift
.section-header}
...
.field}`rho: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Heston.field.rho
.section-header}
...
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Custom.field.drift
.section-header}
...
::: {#variant.Telegraph .section .variant}
[§](#variant.Telegraph){.anchor}

### Telegraph {#telegraph .code-header}
:::
...
::::::::::::::::: {#variant.Telegraph.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.Telegraph.field.dt){.anchor
.field}`dt: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#variant.Telegraph.field.dt
.section-header}
...
:::: sub-variant-field
[[§](#variant.Telegraph.field.drift){.anchor
.field}`drift: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.Telegraph.field.drift
.section-header}
...
:::: sub-variant-field
[[§](#variant.Telegraph.field.volatility){.anchor
.field}`volatility: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#variant.Telegraph.field.volatility
.section-header}
...
:::: sub-variant-field
[[§](#variant.Telegraph.field.lambda_up){.anchor
.field}`lambda_up: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#variant.Telegraph.field.lambda_up
.section-header}
...
:::: sub-variant-field
[[§](#variant.Telegraph.field.lambda_down){.anchor
.field}`lambda_down: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#variant.Telegraph.field.lambda_down
.section-header}

::: docblock
Transition rate from state +1 to -1 (intensity of downward regime
changes)
:::
::::

:::: sub-variant-field
[[§](#variant.Telegraph.field.vol_multiplier_up){.anchor
.field}`vol_multiplier_up: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#variant.Telegraph.field.vol_multiplier_up
.section-header}
...
:::: sub-variant-field
[[§](#variant.Telegraph.field.vol_multiplier_down){.anchor
.field}`vol_multiplier_down: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#variant.Telegraph.field.vol_multiplier_down
.section-header}
...
.field}`prices: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#variant.Historical.field.prices
.section-header}
...
:::: sub-variant-field
[[§](#variant.Historical.field.symbol){.anchor
.field}`symbol: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>`]{#variant.Historical.field.symbol
.section-header}

::: docblock
A field representing an optional symbol.

This field stores an optional `String` that can represent a symbol. It
can hold a `Some(String)` value if a symbol is provided, or `None` if no
symbol is specified.

##### [§](#use-case){.doc-anchor}Use Case

This field can be utilized in scenarios where a symbol (e.g., stock
ticker, identifier) may or may not be required.
:::
::::
:::::::::
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
[Source](../../src/optionstratlib/simulation/model.rs.html#9){.src
.rightside}[§](#impl-Clone-for-WalkType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-clone-for-walktype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#fn-cloneself---walktype .code-header}
:::
...
::: {#impl-ComposeSchema-for-WalkType .section .impl}
[Source](../../src/optionstratlib/simulation/model.rs.html#9){.src
.rightside}[§](#impl-ComposeSchema-for-WalkType){.anchor}

### impl ComposeSchema for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-composeschema-for-walktype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-debug-for-walktype .code-header}
:::
...
### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#implde-deserializede-for-walktype .code-header}
:::
...
[Source](../../src/optionstratlib/simulation/model.rs.html#166-269){.src
.rightside}[§](#impl-Display-for-WalkType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-display-for-walktype .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/simulation/model.rs.html#167-268){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-partialeq-for-walktype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-walktype---bool .code-header}
:::
...
### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-serialize-for-walktype .code-header}
:::
...
::: {#impl-ToSchema-for-WalkType .section .impl}
[Source](../../src/optionstratlib/simulation/model.rs.html#9){.src
.rightside}[§](#impl-ToSchema-for-WalkType){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-toschema-for-walktype .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-structuralpartialeq-for-walktype .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-freeze-for-walktype .code-header}
:::

::: {#impl-RefUnwindSafe-for-WalkType .section .impl}
[§](#impl-RefUnwindSafe-for-WalkType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-refunwindsafe-for-walktype .code-header}
:::

::: {#impl-Send-for-WalkType .section .impl}
[§](#impl-Send-for-WalkType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-send-for-walktype .code-header}
:::

::: {#impl-Sync-for-WalkType .section .impl}
[§](#impl-Sync-for-WalkType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-sync-for-walktype .code-header}
:::

::: {#impl-Unpin-for-WalkType .section .impl}
[§](#impl-Unpin-for-WalkType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-unpin-for-walktype .code-header}
:::

::: {#impl-UnwindSafe-for-WalkType .section .impl}
[§](#impl-UnwindSafe-for-WalkType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [WalkType](enum.WalkType.html "enum optionstratlib::simulation::WalkType"){.enum} {#impl-unwindsafe-for-walktype .code-header}
:::
:::::::::
