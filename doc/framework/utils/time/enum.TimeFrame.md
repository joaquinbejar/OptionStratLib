...
[[Source](../../../src/optionstratlib/utils/time.rs.html#40-63){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/utils/time.rs.html#65-111){.src
...
[Source](../../../src/optionstratlib/utils/time.rs.html#92-110){.src
.rightside}
...
[Source](../../../src/optionstratlib/utils/time.rs.html#39){.src
.rightside}[§](#impl-Clone-for-TimeFrame){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-clone-for-timeframe .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#fn-cloneself---timeframe .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-debug-for-timeframe .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#implde-deserializede-for-timeframe .code-header}
:::
...
[Source](../../../src/optionstratlib/utils/time.rs.html#113-129){.src
.rightside}[§](#impl-Display-for-TimeFrame){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-display-for-timeframe .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#114-128){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-partialeq-for-timeframe .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-timeframe---bool .code-header}
:::
...
### impl [PartialOrd](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-partialord-for-timeframe .code-header}
:::
...
#### fn [partial_cmp](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp){.fn}(&self, other: &[TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum}) -\> [Option](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Ordering](https://doc.rust-lang.org/1.86.0/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum}\> {#fn-partial_cmpself-other-timeframe---optionordering .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-serialize-for-timeframe .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-copy-for-timeframe .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-structuralpartialeq-for-timeframe .code-header}
:::
:::::::::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-freeze-for-timeframe .code-header}
:::

::: {#impl-RefUnwindSafe-for-TimeFrame .section .impl}
[§](#impl-RefUnwindSafe-for-TimeFrame){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-refunwindsafe-for-timeframe .code-header}
:::

::: {#impl-Send-for-TimeFrame .section .impl}
[§](#impl-Send-for-TimeFrame){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-send-for-timeframe .code-header}
:::

::: {#impl-Sync-for-TimeFrame .section .impl}
[§](#impl-Sync-for-TimeFrame){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-sync-for-timeframe .code-header}
:::

::: {#impl-Unpin-for-TimeFrame .section .impl}
[§](#impl-Unpin-for-TimeFrame){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-unpin-for-timeframe .code-header}
:::

::: {#impl-UnwindSafe-for-TimeFrame .section .impl}
[§](#impl-UnwindSafe-for-TimeFrame){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-unwindsafe-for-timeframe .code-header}
:::
:::::::::
