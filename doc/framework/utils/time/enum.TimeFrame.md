...
# Enum [TimeFrame]{.enum} Copy item path

[[Source](../../../src/optionstratlib/utils/time.rs.html#41-64){.src}
]{.sub-heading}
::::
...
used in financial calculations, including common periods like days,
weeks, months, and years, as well as custom periods defined by the user.

The `TimeFrame` enum is used throughout the library to specify the
timeframe for calculations like volatility, returns, and other
...
::::::::::::::::::::::::: variants
::: {#variant.Microsecond .section .variant}
[§](#variant.Microsecond){.anchor}

### Microsecond {#microsecond .code-header}
:::
...
::: {#variant.Millisecond .section .variant}
[§](#variant.Millisecond){.anchor}

### Millisecond {#millisecond .code-header}
:::
...
::: {#variant.Second .section .variant}
[§](#variant.Second){.anchor}

### Second {#second .code-header}
:::
...
::: {#variant.Minute .section .variant}
[§](#variant.Minute){.anchor}

### Minute {#minute .code-header}
:::
...
::: {#variant.Hour .section .variant}
[§](#variant.Hour){.anchor}

### Hour {#hour .code-header}
:::
...
::: {#variant.Week .section .variant}
[§](#variant.Week){.anchor}

### Week {#week .code-header}
:::
...
::: {#variant.Month .section .variant}
[§](#variant.Month){.anchor}

### Month {#month .code-header}
:::
...
::: {#variant.Quarter .section .variant}
[§](#variant.Quarter){.anchor}

### Quarter {#quarter .code-header}
:::
...
::: {#variant.Year .section .variant}
[§](#variant.Year){.anchor}

### Year {#year .code-header}
:::
...
### Custom([Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}) {#custompositive .code-header}
:::
...
::: {#impl-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#66-112){.src
.rightside}[§](#impl-TimeFrame){.anchor}

### impl [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-timeframe .code-header}
:::

:::::: impl-items
::: {#method.periods_per_year .section .method}
[Source](../../../src/optionstratlib/utils/time.rs.html#93-111){.src
.rightside}

#### pub fn [periods_per_year](#method.periods_per_year){.fn}(&self) -\> [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct} {#pub-fn-periods_per_yearself---positive .code-header}
:::

:::: docblock
Returns the number of periods in a trading year for this timeframe.

This function calculates the number of periods that occur within a
trading year based on the chosen `TimeFrame`. A trading year is assumed
to have 252 days and 6.5 trading hours per day.

For custom timeframes, the number of periods is directly specified by
the user.
...
::: {#impl-Clone-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-Clone-for-TimeFrame){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-clone-for-timeframe .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#fn-cloneself---timeframe .code-header}
:::
...
::: {#impl-ComposeSchema-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-ComposeSchema-for-TimeFrame){.anchor}

### impl ComposeSchema for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-composeschema-for-timeframe .code-header}
:::
...
::: {#impl-Debug-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-Debug-for-TimeFrame){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-debug-for-timeframe .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-TimeFrame){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#implde-deserializede-for-timeframe .code-header}
:::
...
::: {#impl-Display-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#114-130){.src
.rightside}[§](#impl-Display-for-TimeFrame){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-display-for-timeframe .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#115-129){.src
...
::: {#impl-PartialEq-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-PartialEq-for-TimeFrame){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-partialeq-for-timeframe .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-timeframe---bool .code-header}
:::
...
::: {#impl-PartialOrd-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-PartialOrd-for-TimeFrame){.anchor}

### impl [PartialOrd](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-partialord-for-timeframe .code-header}
:::
...
#### fn [partial_cmp](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp){.fn}(&self, other: &[TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum}) -\> [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Ordering](https://doc.rust-lang.org/1.91.1/core/cmp/enum.Ordering.html "enum core::cmp::Ordering"){.enum}\> {#fn-partial_cmpself-other-timeframe---optionordering .code-header}
:::
...
::: {#impl-Serialize-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-Serialize-for-TimeFrame){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-serialize-for-timeframe .code-header}
:::
...
::: {#impl-ToSchema-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-ToSchema-for-TimeFrame){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-toschema-for-timeframe .code-header}
:::
...
::: {#impl-Copy-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-Copy-for-TimeFrame){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-copy-for-timeframe .code-header}
:::

::: {#impl-StructuralPartialEq-for-TimeFrame .section .impl}
[Source](../../../src/optionstratlib/utils/time.rs.html#40){.src
.rightside}[§](#impl-StructuralPartialEq-for-TimeFrame){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-structuralpartialeq-for-timeframe .code-header}
:::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-TimeFrame .section .impl}
[§](#impl-Freeze-for-TimeFrame){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-freeze-for-timeframe .code-header}
:::

::: {#impl-RefUnwindSafe-for-TimeFrame .section .impl}
[§](#impl-RefUnwindSafe-for-TimeFrame){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-refunwindsafe-for-timeframe .code-header}
:::

::: {#impl-Send-for-TimeFrame .section .impl}
[§](#impl-Send-for-TimeFrame){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-send-for-timeframe .code-header}
:::

::: {#impl-Sync-for-TimeFrame .section .impl}
[§](#impl-Sync-for-TimeFrame){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-sync-for-timeframe .code-header}
:::

::: {#impl-Unpin-for-TimeFrame .section .impl}
[§](#impl-Unpin-for-TimeFrame){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-unpin-for-timeframe .code-header}
:::

::: {#impl-UnwindSafe-for-TimeFrame .section .impl}
[§](#impl-UnwindSafe-for-TimeFrame){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TimeFrame](enum.TimeFrame.html "enum optionstratlib::utils::time::TimeFrame"){.enum} {#impl-unwindsafe-for-timeframe .code-header}
:::
:::::::::
