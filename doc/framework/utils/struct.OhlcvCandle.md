...
# Struct [OhlcvCandle]{.struct} Copy item path

[[Source](../../src/optionstratlib/utils/csv.rs.html#13-28){.src}
]{.sub-heading}
::::
...
.field}`date: `[`NaiveDate`](../../chrono/naive/date/struct.NaiveDate.html "struct chrono::naive::date::NaiveDate"){.struct}]{#structfield.date
...
[[§](#structfield.time){.anchor
.field}`time: `[`String`](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#structfield.time
.structfield .section-header}
...
[[§](#structfield.open){.anchor
.field}`open: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.open
.structfield .section-header}
...
[[§](#structfield.high){.anchor
.field}`high: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.high
.structfield .section-header}
...
[[§](#structfield.low){.anchor
.field}`low: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.low
.structfield .section-header}
...
[[§](#structfield.close){.anchor
.field}`close: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.close
.structfield .section-header}
...
.field}`volume: `[`u64`](https://doc.rust-lang.org/1.91.1/std/primitive.u64.html){.primitive}]{#structfield.volume
.structfield .section-header}
...
::: {#impl-Clone-for-OhlcvCandle .section .impl}
[Source](../../src/optionstratlib/utils/csv.rs.html#12){.src
.rightside}[§](#impl-Clone-for-OhlcvCandle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-clone-for-ohlcvcandle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#fn-cloneself---ohlcvcandle .code-header}
:::
...
::: {#impl-Debug-for-OhlcvCandle .section .impl}
[Source](../../src/optionstratlib/utils/csv.rs.html#12){.src
.rightside}[§](#impl-Debug-for-OhlcvCandle){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-debug-for-ohlcvcandle .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-OhlcvCandle .section .impl}
[Source](../../src/optionstratlib/utils/csv.rs.html#12){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-OhlcvCandle){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#implde-deserializede-for-ohlcvcandle .code-header}
:::
...
::: {#impl-Serialize-for-OhlcvCandle .section .impl}
[Source](../../src/optionstratlib/utils/csv.rs.html#12){.src
.rightside}[§](#impl-Serialize-for-OhlcvCandle){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-serialize-for-ohlcvcandle .code-header}
:::
...
::: {#impl-Freeze-for-OhlcvCandle .section .impl}
[§](#impl-Freeze-for-OhlcvCandle){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-freeze-for-ohlcvcandle .code-header}
:::

::: {#impl-RefUnwindSafe-for-OhlcvCandle .section .impl}
[§](#impl-RefUnwindSafe-for-OhlcvCandle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-refunwindsafe-for-ohlcvcandle .code-header}
:::

::: {#impl-Send-for-OhlcvCandle .section .impl}
[§](#impl-Send-for-OhlcvCandle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-send-for-ohlcvcandle .code-header}
:::

::: {#impl-Sync-for-OhlcvCandle .section .impl}
[§](#impl-Sync-for-OhlcvCandle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-sync-for-ohlcvcandle .code-header}
:::

::: {#impl-Unpin-for-OhlcvCandle .section .impl}
[§](#impl-Unpin-for-OhlcvCandle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-unpin-for-ohlcvcandle .code-header}
:::

::: {#impl-UnwindSafe-for-OhlcvCandle .section .impl}
[§](#impl-UnwindSafe-for-OhlcvCandle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-unwindsafe-for-ohlcvcandle .code-header}
:::
:::::::::
