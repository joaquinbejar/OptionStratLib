...
[[Source](../../src/optionstratlib/utils/csv.rs.html#12-27){.src}
]{.sub-heading}
::::
...
.field}`date: `[`NaiveDate`](https://docs.rs/chrono/latest/chrono/naive/date/struct.NaiveDate.html "struct chrono::naive::date::NaiveDate"){.struct}]{#structfield.date
...
.field}`time: `[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}]{#structfield.time
.structfield .section-header}
...
.field}`open: Decimal`]{#structfield.open .structfield .section-header}
...
.field}`high: Decimal`]{#structfield.high .structfield .section-header}

::: docblock
Highest price during the period
:::

[[§](#structfield.low){.anchor .field}`low: Decimal`]{#structfield.low
.structfield .section-header}
...
.field}`close: Decimal`]{#structfield.close .structfield
.section-header}
...
.field}`volume: `[`u64`](https://doc.rust-lang.org/1.86.0/std/primitive.u64.html){.primitive}]{#structfield.volume
.structfield .section-header}
...
[Source](../../src/optionstratlib/utils/csv.rs.html#11){.src
.rightside}[§](#impl-Clone-for-OhlcvCandle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-clone-for-ohlcvcandle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#fn-cloneself---ohlcvcandle .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-debug-for-ohlcvcandle .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#implde-deserializede-for-ohlcvcandle .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-serialize-for-ohlcvcandle .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-freeze-for-ohlcvcandle .code-header}
:::

::: {#impl-RefUnwindSafe-for-OhlcvCandle .section .impl}
[§](#impl-RefUnwindSafe-for-OhlcvCandle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-refunwindsafe-for-ohlcvcandle .code-header}
:::

::: {#impl-Send-for-OhlcvCandle .section .impl}
[§](#impl-Send-for-OhlcvCandle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-send-for-ohlcvcandle .code-header}
:::

::: {#impl-Sync-for-OhlcvCandle .section .impl}
[§](#impl-Sync-for-OhlcvCandle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-sync-for-ohlcvcandle .code-header}
:::

::: {#impl-Unpin-for-OhlcvCandle .section .impl}
[§](#impl-Unpin-for-OhlcvCandle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-unpin-for-ohlcvcandle .code-header}
:::

::: {#impl-UnwindSafe-for-OhlcvCandle .section .impl}
[§](#impl-UnwindSafe-for-OhlcvCandle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OhlcvCandle](struct.OhlcvCandle.html "struct optionstratlib::utils::OhlcvCandle"){.struct} {#impl-unwindsafe-for-ohlcvcandle .code-header}
:::
:::::::::
