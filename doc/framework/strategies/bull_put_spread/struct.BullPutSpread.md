...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../../index.html)::[strategies](../index.html)::[bull_put_spread](index.html)
:::

# Struct [BullPutSpread]{.struct} Copy item path

[[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#78-97){.src}
]{.sub-heading}
::::
...
A Bull Put Spread consists of buying a put option with a lower strike
price (long put) and selling a put option with a higher strike price
(short put), both with the same expiration date. This strategy is used
when an investor is moderately bullish on the underlying asset and wants
to generate income with limited risk.

## [§](#characteristics){.doc-anchor}Characteristics

- Limited profit potential (difference between premiums received and
  paid)
- Limited risk (difference between strike prices minus net premium
  received)
- Bullish outlook (profits when the underlying price stays above the
  short put strike)
...
::: docblock
The price points at which the strategy breaks even (typically a single
point) representing the short put strike minus the net premium received
:::
...
::: docblock
The short put position (higher strike price) that generates premium
income
:::
...
::: {#impl-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#99-235){.src
.rightside}[§](#impl-BullPutSpread){.anchor}

### impl [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-bullputspread .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#140-234){.src
.rightside}
...
A Bull Put Spread is created by buying a put option with a lower strike
price and simultaneously selling a put option with a higher strike
price, both with the same expiration date. This strategy is used when
you expect a moderate increase in the underlying asset's price.

##### [§](#parameters){.doc-anchor}Parameters

- `underlying_symbol` - Symbol of the underlying asset (e.g., stock
  ticker).
- `underlying_price` - Current price of the underlying asset.
- `long_strike` - Strike price for the long put option. Defaults to
  `underlying_price` if set to zero.
- `short_strike` - Strike price for the short put option. Defaults to
  `underlying_price` if set to zero.
...
- `open_fee_long_put` - Transaction fee for opening the long put
  position.
- `close_fee_long_put` - Transaction fee for closing the long put
  position.
- `open_fee_short_put` - Transaction fee for opening the short put
  position.
- `close_fee_short_put` - Transaction fee for closing the short put
  position.
...
- Maximum profit: Limited to the net credit received (premium
  difference)
- Maximum loss: Limited to the difference between strike prices minus
  the net credit
...
::: {#impl-BasicAble-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#467-580){.src
.rightside}[§](#impl-BasicAble-for-BullPutSpread){.anchor}

### impl [BasicAble](../base/trait.BasicAble.html "trait optionstratlib::strategies::base::BasicAble"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-basicable-for-bullputspread .code-header}
:::

::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#468-480){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#481-499){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#500-526){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#527-547){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#548-550){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#551-553){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#554-561){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#562-570){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#571-579){.src
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-breakevenable-for-bullputspread .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#334-336){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#338-348){.src
...
::: {#impl-Clone-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-Clone-for-BullPutSpread){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-clone-for-bullputspread .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#fn-cloneself---bullputspread .code-header}
:::
...
::: {#impl-ComposeSchema-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-ComposeSchema-for-BullPutSpread){.anchor}

### impl ComposeSchema for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-composeschema-for-bullputspread .code-header}
:::
...
::: {#impl-Debug-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-Debug-for-BullPutSpread){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-debug-for-bullputspread .code-header}
:::
...
::: {#impl-Default-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#40-52){.src
.rightside}[§](#impl-Default-for-BullPutSpread){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-default-for-bullputspread .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#41-51){.src
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-deltaneutrality-for-bullputspread .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-BullPutSpread){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#implde-deserializede-for-bullputspread .code-header}
:::
...
::: {#impl-Display-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-Display-for-BullPutSpread){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-display-for-bullputspread .code-header}
:::
...
### impl [Graph](../../visualization/trait.Graph.html "trait optionstratlib::visualization::Graph"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-graph-for-bullputspread .code-header}
:::
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-greeks-for-bullputspread .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#922-924){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-optimizable-for-bullputspread .code-header}
:::

:::::::::::::::::::: impl-items
::: {#method.filter_combinations .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#747-784){.src
...
This function generates pairs of options from the `OptionChain` and
applies a series of filters and validations to ensure the results
conform to the specified trading strategy requirements. Each returned
pair (`long`, `short`) represents options that are suitable for building
a strategy, such as a "bull put spread".

##### [§](#parameters-1){.doc-anchor}Parameters

- `option_chain`: A reference to the `OptionChain` containing the option
  data.
- `side`: The `FindOptimalSide` specifying the filtering condition based
  on the strike price range relative to the underlying price.

##### [§](#returns-3){.doc-anchor}Returns {#returns-3}

An iterator over pairs of references to `OptionData` that meet the
selection criteria. Each pair satisfies:

- Both options are valid according to the `is_valid_optimal_side`
  method.
- Both options have valid bid/ask prices for the put options (`put_ask`
  for long and `put_bid` for short must be greater than zero).
- The strategy created using the pair passes validation checks and
  successfully calculates `max_profit` and `max_loss`.
...
3.  Uses the `option_chain.get_double_iter()` method to generate all
    possible pairs of options for evaluation.
4.  Filters the pairs based on combination validity, pricing
    constraints, and strategy feasibility:
    - Ensures the options are on the correct `FindOptimalSide` relative
      to the underlying price.
    - Ensures the `put_ask` and `put_bid` prices meet the conditions.
    - Ensures the strategy created with the options is valid and has
      calculable profit and loss parameters.
...
- This function assumes that the `OptionChain` data structure is
  well-formed and contains valid `OptionData`.
- It is intended for strategies requiring combinations of two legs, like
  spreads. For strategies requiring more legs, an alternative method may
  be needed.

##### [§](#see-also){.doc-anchor}See Also

- [`OptionChain::get_double_iter`](../../chains/chain/struct.OptionChain.html#method.get_double_iter "method optionstratlib::chains::chain::OptionChain::get_double_iter")
- [`OptionData::is_valid_optimal_side`](../../chains/struct.OptionData.html#method.is_valid_optimal_side "method optionstratlib::chains::OptionData::is_valid_optimal_side")
- [`BullPutSpread::validate`](struct.BullPutSpread.html#method.validate "method optionstratlib::strategies::bull_put_spread::BullPutSpread::validate")
::::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#type-strategy-bullputspread .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#786-821){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#823-847){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-pnlcalculator-for-bullputspread .code-header}
:::

::::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#930-942){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#944-954){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-positionable-for-bullputspread .code-header}
:::

::::::::::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#379-405){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#415-454){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#352-363){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#365-367){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-probabilityanalysis-for-bullputspread .code-header}
:::

::::::::::::::::: impl-items
::: {#method.get_profit_ranges .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#858-887){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#889-918){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-profit-for-bullputspread .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#851-854){.src
...
::: {#impl-Serialize-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-Serialize-for-BullPutSpread){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-serialize-for-bullputspread .code-header}
:::
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-strategable-for-bullputspread .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#458-464){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-strategies-for-bullputspread .code-header}
:::

::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_max_profit .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#583-594){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#595-608){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#609-617){.src
...
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#618-626){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-strategyconstructor-for-bullputspread .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#238-330){.src
...
::: {#impl-ToSchema-for-BullPutSpread .section .impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#77){.src
.rightside}[§](#impl-ToSchema-for-BullPutSpread){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-toschema-for-bullputspread .code-header}
:::
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-validable-for-bullputspread .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/bull_put_spread.rs.html#630-644){.src
...
::: {#impl-Freeze-for-BullPutSpread .section .impl}
[§](#impl-Freeze-for-BullPutSpread){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-freeze-for-bullputspread .code-header}
:::

::: {#impl-RefUnwindSafe-for-BullPutSpread .section .impl}
[§](#impl-RefUnwindSafe-for-BullPutSpread){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-refunwindsafe-for-bullputspread .code-header}
:::

::: {#impl-Send-for-BullPutSpread .section .impl}
[§](#impl-Send-for-BullPutSpread){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-send-for-bullputspread .code-header}
:::

::: {#impl-Sync-for-BullPutSpread .section .impl}
[§](#impl-Sync-for-BullPutSpread){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-sync-for-bullputspread .code-header}
:::

::: {#impl-Unpin-for-BullPutSpread .section .impl}
[§](#impl-Unpin-for-BullPutSpread){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-unpin-for-bullputspread .code-header}
:::

::: {#impl-UnwindSafe-for-BullPutSpread .section .impl}
[§](#impl-UnwindSafe-for-BullPutSpread){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BullPutSpread](struct.BullPutSpread.html "struct optionstratlib::strategies::bull_put_spread::BullPutSpread"){.struct} {#impl-unwindsafe-for-bullputspread .code-header}
:::
:::::::::
