...
[[Source](../../../src/optionstratlib/strategies/base.rs.html#242-267){.src}
]{.sub-heading}
::::
...
.field}`legs: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Position`](../../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}`>`]{#structfield.legs
.structfield .section-header}
...
.field}`max_profit: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}`>`]{#structfield.max_profit
.structfield .section-header}
...
.field}`max_loss: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.91.1/std/primitive.f64.html){.primitive}`>`]{#structfield.max_loss
.structfield .section-header}
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#301-346){.src
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#335-345){.src
.rightside}

#### pub fn [new](#method.new){.fn}(name: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, kind: [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum}, description: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}) -\> Self {#pub-fn-newname-string-kind-strategytype-description-string---self .code-header}
:::
...
[Source](../../../src/optionstratlib/model/format.rs.html#295-307){.src
.rightside}[§](#impl-Debug-for-Strategy){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-debug-for-strategy .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#296-306){.src
...
[Source](../../../src/optionstratlib/model/format.rs.html#272-293){.src
.rightside}[§](#impl-Display-for-Strategy){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-display-for-strategy .code-header}
:::

::::: impl-items
::: {#method.fmt .section .method .trait-impl}
[Source](../../../src/optionstratlib/model/format.rs.html#273-292){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-freeze-for-strategy .code-header}
:::

::: {#impl-RefUnwindSafe-for-Strategy .section .impl}
[§](#impl-RefUnwindSafe-for-Strategy){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-refunwindsafe-for-strategy .code-header}
:::

::: {#impl-Send-for-Strategy .section .impl}
[§](#impl-Send-for-Strategy){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-send-for-strategy .code-header}
:::

::: {#impl-Sync-for-Strategy .section .impl}
[§](#impl-Sync-for-Strategy){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-sync-for-strategy .code-header}
:::

::: {#impl-Unpin-for-Strategy .section .impl}
[§](#impl-Unpin-for-Strategy){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-unpin-for-strategy .code-header}
:::

::: {#impl-UnwindSafe-for-Strategy .section .impl}
[§](#impl-UnwindSafe-for-Strategy){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [Strategy](struct.Strategy.html "struct optionstratlib::strategies::base::Strategy"){.struct} {#impl-unwindsafe-for-strategy .code-header}
:::
:::::::::
