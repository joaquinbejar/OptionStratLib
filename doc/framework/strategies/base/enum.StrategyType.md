...
[[Source](../../../src/optionstratlib/strategies/base.rs.html#112-157){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#191-212){.src
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#209-211){.src
.rightside}

#### pub fn [is_valid](#method.is_valid){.fn}(strategy: &[str](https://doc.rust-lang.org/1.86.0/std/primitive.str.html){.primitive}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#pub-fn-is_validstrategy-str---bool .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#111){.src
.rightside}[§](#impl-Clone-for-StrategyType){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-clone-for-strategytype .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#fn-cloneself---strategytype .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-debug-for-strategytype .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#implde-deserializede-for-strategytype .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#213-226){.src
.rightside}[§](#impl-Display-for-StrategyType){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-display-for-strategytype .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/base.rs.html#223-225){.src
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#159-189){.src
.rightside}[§](#impl-FromStr-for-StrategyType){.anchor}

### impl [FromStr](https://doc.rust-lang.org/1.86.0/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-fromstr-for-strategytype .code-header}
:::

::::::: impl-items
::: {#associatedtype.Err .section .associatedtype .trait-impl}
[Source](../../../src/optionstratlib/strategies/base.rs.html#160){.src
.rightside}[§](#associatedtype.Err){.anchor}

#### type [Err](https://doc.rust-lang.org/1.86.0/core/str/traits/trait.FromStr.html#associatedtype.Err){.associatedtype} = [()](https://doc.rust-lang.org/1.86.0/std/primitive.unit.html){.primitive} {#type-err .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/base.rs.html#162-188){.src
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-partialeq-for-strategytype .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-strategytype---bool .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-serialize-for-strategytype .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-structuralpartialeq-for-strategytype .code-header}
:::
::::::::::::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-freeze-for-strategytype .code-header}
:::

::: {#impl-RefUnwindSafe-for-StrategyType .section .impl}
[§](#impl-RefUnwindSafe-for-StrategyType){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-refunwindsafe-for-strategytype .code-header}
:::

::: {#impl-Send-for-StrategyType .section .impl}
[§](#impl-Send-for-StrategyType){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-send-for-strategytype .code-header}
:::

::: {#impl-Sync-for-StrategyType .section .impl}
[§](#impl-Sync-for-StrategyType){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-sync-for-strategytype .code-header}
:::

::: {#impl-Unpin-for-StrategyType .section .impl}
[§](#impl-Unpin-for-StrategyType){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-unpin-for-strategytype .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyType .section .impl}
[§](#impl-UnwindSafe-for-StrategyType){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyType](enum.StrategyType.html "enum optionstratlib::strategies::base::StrategyType"){.enum} {#impl-unwindsafe-for-strategytype .code-header}
:::
:::::::::
