...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../../index.html)::[strategies](../index.html)::[poor_mans_covered_call](index.html)
:::

# Struct [PoorMansCoveredCall]{.struct} Copy item path

[[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#112-125){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#poormanscoveredcall){.doc-anchor}PoorMansCoveredCall

Represents a Poor Man's Covered Call options trading strategy. This
strategy is a cost-effective alternative to the traditional covered
call, using a deep in-the-money long-term call option instead of owning
the underlying stock, while selling shorter-term out-of-the-money call
options.

A Poor Man's Covered Call (also known as a PMCC or Diagonal Debit Call
Spread) requires less capital than a standard covered call while still
providing similar profit potential and risk profile.

### [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `name`: A descriptive name for the specific strategy instance.
- `kind`: The type of strategy, which is
...
- `long_call`: The long call position (typically a LEAP - Long-Term
  Equity Anticipation Security).
- `short_call`: The short call position (shorter-term, out-of-the-money
  call).

### [§](#risk-and-reward){.doc-anchor}Risk and Reward

The maximum risk in this strategy is limited to the net debit paid (cost
of the long call minus the premium received for the short call).

The maximum profit is capped and occurs when the underlying price at
expiration of the short call equals or exceeds the strike price of the
short call.

### [§](#break-even-point){.doc-anchor}Break-Even Point

The break-even point at expiration of the short call is approximately
the strike price of the long call plus the net debit paid for the
spread.

### [§](#strategy-usage){.doc-anchor}Strategy Usage

This strategy is typically used when:

- The trader is moderately to strongly bullish on the underlying asset
- The trader wants to generate income while still participating in
  potential upside movement
- The trader wants to implement a covered call strategy with less
  capital investment
- Implied volatility is relatively high for near-term options

### [§](#management-considerations){.doc-anchor}Management Considerations

- The strategy often involves rolling the short call forward to continue
  generating income
- The long call should have sufficient time value to avoid assignment
  complications
- Ideally implemented when the underlying asset has a strong positive
...
::: {#impl-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#127-258){.src
.rightside}[§](#impl-PoorMansCoveredCall){.anchor}

### impl [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-poormanscoveredcall .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#177-257){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, long_call_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, short_call_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, long_call_expiration: [ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}, short_call_expiration: [ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-long_call_strike-positive-short_call_strike-positive-long_call_expiration-expirationdate-short_call_expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_long_call-positive-premium_short_call-positive-open_fee_long_call-positive-close_fee_long_call-positive-open_fee_short_call-positive-close_fee_short_call-positive---self .code-header}
:::

::: docblock
##### [§](#creates-a-new-poor-mans-covered-call-strategy-instance){.doc-anchor}Creates a new Poor Man's Covered Call strategy instance

This function constructs and initializes a Poor Man's Covered Call
(PMCC) options strategy, which simulates a covered call using a
long-term deep in-the-money call option (LEAPS) instead of owning the
underlying stock, paired with selling a shorter-term out-of-the-money
call.
...
- `short_call_expiration`: Expiration date for the short-term call
  option
- `implied_volatility`: Implied volatility used for options pricing
- `risk_free_rate`: Risk-free interest rate used in options pricing
  models
...
A fully initialized `PoorMansCoveredCall` instance with both option
positions and calculated break-even points.
...
This strategy provides similar benefits to a traditional covered call
but requires less capital, as purchasing a LEAPS call option is less
expensive than buying 100 shares of the underlying stock.

###### [§](#risk-reward-profile){.doc-anchor}Risk-Reward Profile

- Maximum profit: Limited to the short call's strike price minus the
  long call's strike price, plus the net credit received (or minus the
  net debit paid)
- Maximum loss: Limited to the net debit paid for the position (long
  call premium minus short call premium) plus transaction fees
- Break-even point: Long call strike price plus the net debit paid

###### [§](#ideal-market-conditions){.doc-anchor}Ideal Market Conditions

This strategy is optimal when:

- The investor is moderately bullish on the underlying asset
- The investor wants to generate income from the short calls while
  maintaining upside potential
- The investor seeks a capital-efficient alternative to traditional
  covered calls
:::
:::::
:::::::
...
::: {#impl-BasicAble-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#488-609){.src
.rightside}[§](#impl-BasicAble-for-PoorMansCoveredCall){.anchor}

### impl [BasicAble](../base/trait.BasicAble.html "trait optionstratlib::strategies::base::BasicAble"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-basicable-for-poormanscoveredcall .code-header}
:::

::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#489-501){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#502-520){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#521-547){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#548-568){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#569-571){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#572-574){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#575-582){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#583-595){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#596-608){.src
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-breakevenable-for-poormanscoveredcall .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#346-348){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#350-359){.src
...
::: {#impl-Clone-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-Clone-for-PoorMansCoveredCall){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-clone-for-poormanscoveredcall .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#fn-cloneself---poormanscoveredcall .code-header}
:::
...
::: {#impl-ComposeSchema-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-ComposeSchema-for-PoorMansCoveredCall){.anchor}

### impl ComposeSchema for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-composeschema-for-poormanscoveredcall .code-header}
:::
...
::: {#impl-Debug-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-Debug-for-PoorMansCoveredCall){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-debug-for-poormanscoveredcall .code-header}
:::
...
::: {#impl-Default-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#170-181){.src
.rightside}[§](#impl-Default-for-PoorMansCoveredCall){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-default-for-poormanscoveredcall .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#171-180){.src
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-deltaneutrality-for-poormanscoveredcall .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-PoorMansCoveredCall){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#implde-deserializede-for-poormanscoveredcall .code-header}
:::
...
::: {#impl-Display-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-Display-for-PoorMansCoveredCall){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-display-for-poormanscoveredcall .code-header}
:::
...
### impl [Graph](../../visualization/trait.Graph.html "trait optionstratlib::visualization::Graph"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-graph-for-poormanscoveredcall .code-header}
:::
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-greeks-for-poormanscoveredcall .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#818-820){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-optimizable-for-poormanscoveredcall .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#type-strategy-poormanscoveredcall .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#660-720){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#722-748){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-pnlcalculator-for-poormanscoveredcall .code-header}
:::

::::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#826-838){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#840-850){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-positionable-for-poormanscoveredcall .code-header}
:::

::::::::::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#400-426){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#436-475){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#369-384){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#386-388){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-probabilityanalysis-for-poormanscoveredcall .code-header}
:::

::::::::::::::::: impl-items
::: {#method.get_profit_ranges .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#762-787){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#789-814){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-profit-for-poormanscoveredcall .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#752-758){.src
...
::: {#impl-Serialize-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-Serialize-for-PoorMansCoveredCall){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-serialize-for-poormanscoveredcall .code-header}
:::
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-strategable-for-poormanscoveredcall .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#479-485){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-strategies-for-poormanscoveredcall .code-header}
:::

::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_max_profit .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#612-623){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#625-636){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#638-646){.src
...
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#648-654){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-strategyconstructor-for-poormanscoveredcall .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#261-342){.src
...
::: {#impl-ToSchema-for-PoorMansCoveredCall .section .impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#111){.src
.rightside}[§](#impl-ToSchema-for-PoorMansCoveredCall){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-toschema-for-poormanscoveredcall .code-header}
:::
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-validable-for-poormanscoveredcall .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/poor_mans_covered_call.rs.html#363-365){.src
...
::: {#impl-Freeze-for-PoorMansCoveredCall .section .impl}
[§](#impl-Freeze-for-PoorMansCoveredCall){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-freeze-for-poormanscoveredcall .code-header}
:::

::: {#impl-RefUnwindSafe-for-PoorMansCoveredCall .section .impl}
[§](#impl-RefUnwindSafe-for-PoorMansCoveredCall){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-refunwindsafe-for-poormanscoveredcall .code-header}
:::

::: {#impl-Send-for-PoorMansCoveredCall .section .impl}
[§](#impl-Send-for-PoorMansCoveredCall){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-send-for-poormanscoveredcall .code-header}
:::

::: {#impl-Sync-for-PoorMansCoveredCall .section .impl}
[§](#impl-Sync-for-PoorMansCoveredCall){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-sync-for-poormanscoveredcall .code-header}
:::

::: {#impl-Unpin-for-PoorMansCoveredCall .section .impl}
[§](#impl-Unpin-for-PoorMansCoveredCall){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-unpin-for-poormanscoveredcall .code-header}
:::

::: {#impl-UnwindSafe-for-PoorMansCoveredCall .section .impl}
[§](#impl-UnwindSafe-for-PoorMansCoveredCall){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PoorMansCoveredCall](struct.PoorMansCoveredCall.html "struct optionstratlib::strategies::poor_mans_covered_call::PoorMansCoveredCall"){.struct} {#impl-unwindsafe-for-poormanscoveredcall .code-header}
:::
:::::::::
