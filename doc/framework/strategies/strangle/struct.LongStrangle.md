...
# Struct [LongStrangle]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1119-1132){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#longstrangle){.doc-anchor}LongStrangle

Represents a Long Strangle options trading strategy.

A Long Strangle strategy involves simultaneously buying an
out-of-the-money call option and an out-of-the-money put option on the
same underlying asset with the same expiration date but different strike
prices. This strategy benefits from significant price movements in
either direction.

### [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `name` - Custom name identifier for this specific strategy instance
- `kind` - The type of strategy (always `StrategyType::LongStrangle` for
  this struct)
- `description` - Detailed description of this specific strategy
  instance
- `break_even_points` - Vector containing the price points where the
  strategy breaks even (typically two points: call strike + call premium
  and put strike - put premium)
...
- Maximum Loss: Limited to the total premium paid (call premium + put
  premium + fees)
- Maximum Profit: Theoretically unlimited on the upside; on the
  downside, limited to the put strike price minus total premium paid
- Break-even Points: Upper break-even is call strike plus total premium
  paid; lower break-even is put strike minus total premium paid

### [§](#typical-usage){.doc-anchor}Typical Usage

Used when an investor expects significant price movement in the
underlying asset but is uncertain about the direction of the move. This
strategy is often employed:

- Ahead of major market events with uncertain outcomes (earnings
  reports, regulatory decisions)
...
If the underlying asset is trading at \$100, a long strangle might
involve:

- Buying a put with a strike price of \$90 for a premium of \$2
- Buying a call with a strike price of \$110 for a premium of \$2

Total cost: \$4 per share (\$400 per contract) Break-even points: \$86
and \$114

### [§](#advantages-and-disadvantages){.doc-anchor}Advantages and Disadvantages
...
- Generally more expensive than directional strategies due to purchasing
  two options
:::
...
::: {#impl-LongStrangle .section .impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1134-1256){.src
.rightside}[§](#impl-LongStrangle){.anchor}

### impl [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-longstrangle .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1168-1255){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, call_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, put_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, expiration: [ExpirationDate](../../model/types/enum.ExpirationDate.html "enum optionstratlib::model::types::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: Decimal, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-call_strike-positive-put_strike-positive-expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_long_call-positive-premium_long_put-positive-open_fee_long_call-positive-close_fee_long_call-positive-open_fee_long_put-positive-close_fee_long_put-positive---self .code-header}
:::

::: docblock
###### [§](#creation){.doc-anchor}Creation

Creates a new Long Strangle strategy with two positions:

1.  A long call option with strike typically above the current
    underlying price (OTM)
2.  A long put option with strike typically below the current underlying
    price (OTM)

If strike prices are not explicitly provided (passed as zero), the
constructor will automatically set:
...
- `call_strike` - Strike price for the call option (will be set to 110%
  of underlying price if zero)
- `put_strike` - Strike price for the put option (will be set to 90% of
...
Returns a fully initialized `LongStrangle` strategy with properly
configured positions and calculated break-even points.
:::
:::::
:::::::
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-breakevenable-for-longstrangle .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1360-1362){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1364-1381){.src
...
::: {#impl-Clone-for-LongStrangle .section .impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1118){.src
.rightside}[§](#impl-Clone-for-LongStrangle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-clone-for-longstrangle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#fn-cloneself---longstrangle .code-header}
:::
...
::: {#impl-Debug-for-LongStrangle .section .impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1118){.src
.rightside}[§](#impl-Debug-for-LongStrangle){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-debug-for-longstrangle .code-header}
:::
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-deltaneutrality-for-longstrangle .code-header}
:::
...
### impl [Graph](../../visualization/utils/trait.Graph.html "trait optionstratlib::visualization::utils::Graph"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-graph-for-longstrangle .code-header}
:::

::::::::::::::: impl-items
::: {#method.title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1712-1724){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1726-1729){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1731-1750){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1752-1831){.src
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-greeks-for-longstrangle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1915-1917){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-optimizable-for-longstrangle .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#type-strategy-longstrangle .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1583-1629){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1631-1666){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1668-1675){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1677-1701){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-pnlcalculator-for-longstrangle .code-header}
:::

::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1923-1935){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1937-1947){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1949-2028){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-positionable-for-longstrangle .code-header}
:::

::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1416-1442){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1452-1485){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1385-1400){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1402-1404){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-probabilityanalysis-for-longstrangle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_expiration .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1835-1838){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1840-1842){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1844-1882){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1884-1911){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-profit-for-longstrangle .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1705-1708){.src
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-strategable-for-longstrangle .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1489-1495){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-strategies-for-longstrangle .code-header}
:::

::::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_underlying_price .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1499-1501){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1503-1513){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1515-1518){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1520-1522){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1524-1526){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1528-1542){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1544-1553){.src
...
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1555-1569){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-strategyconstructor-for-longstrangle .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1259-1356){.src
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-validable-for-longstrangle .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/strangle.rs.html#1573-1577){.src
...
::: {#impl-Freeze-for-LongStrangle .section .impl}
[§](#impl-Freeze-for-LongStrangle){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-freeze-for-longstrangle .code-header}
:::

::: {#impl-RefUnwindSafe-for-LongStrangle .section .impl}
[§](#impl-RefUnwindSafe-for-LongStrangle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-refunwindsafe-for-longstrangle .code-header}
:::

::: {#impl-Send-for-LongStrangle .section .impl}
[§](#impl-Send-for-LongStrangle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-send-for-longstrangle .code-header}
:::

::: {#impl-Sync-for-LongStrangle .section .impl}
[§](#impl-Sync-for-LongStrangle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-sync-for-longstrangle .code-header}
:::

::: {#impl-Unpin-for-LongStrangle .section .impl}
[§](#impl-Unpin-for-LongStrangle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-unpin-for-longstrangle .code-header}
:::

::: {#impl-UnwindSafe-for-LongStrangle .section .impl}
[§](#impl-UnwindSafe-for-LongStrangle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [LongStrangle](struct.LongStrangle.html "struct optionstratlib::strategies::strangle::LongStrangle"){.struct} {#impl-unwindsafe-for-longstrangle .code-header}
:::
:::::::::
