...
# Struct [PriceTrend]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/probabilities/utils.rs.html#27-32){.src}
]{.sub-heading}
::::
...
[[§](#structfield.drift_rate){.anchor
.field}`drift_rate: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#structfield.drift_rate
...
[[§](#structfield.confidence){.anchor
.field}`confidence: `[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}]{#structfield.confidence
.structfield .section-header}
...
::: {#impl-Clone-for-PriceTrend .section .impl}
[Source](../../../src/optionstratlib/strategies/probabilities/utils.rs.html#26){.src
.rightside}[§](#impl-Clone-for-PriceTrend){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-clone-for-pricetrend .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#fn-cloneself---pricetrend .code-header}
:::
...
::: {#impl-Debug-for-PriceTrend .section .impl}
[Source](../../../src/optionstratlib/strategies/probabilities/utils.rs.html#26){.src
.rightside}[§](#impl-Debug-for-PriceTrend){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-debug-for-pricetrend .code-header}
:::
...
::: {#impl-Freeze-for-PriceTrend .section .impl}
[§](#impl-Freeze-for-PriceTrend){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-freeze-for-pricetrend .code-header}
:::

::: {#impl-RefUnwindSafe-for-PriceTrend .section .impl}
[§](#impl-RefUnwindSafe-for-PriceTrend){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-refunwindsafe-for-pricetrend .code-header}
:::

::: {#impl-Send-for-PriceTrend .section .impl}
[§](#impl-Send-for-PriceTrend){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-send-for-pricetrend .code-header}
:::

::: {#impl-Sync-for-PriceTrend .section .impl}
[§](#impl-Sync-for-PriceTrend){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-sync-for-pricetrend .code-header}
:::

::: {#impl-Unpin-for-PriceTrend .section .impl}
[§](#impl-Unpin-for-PriceTrend){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-unpin-for-pricetrend .code-header}
:::

::: {#impl-UnwindSafe-for-PriceTrend .section .impl}
[§](#impl-UnwindSafe-for-PriceTrend){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PriceTrend](struct.PriceTrend.html "struct optionstratlib::strategies::probabilities::PriceTrend"){.struct} {#impl-unwindsafe-for-pricetrend .code-header}
:::
:::::::::
