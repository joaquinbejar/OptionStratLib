...
[[Source](../../../src/optionstratlib/strategies/custom.rs.html#51-87){.src}
]{.sub-heading}
::::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#89-341){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#115-147){.src
.rightside}

#### pub fn [new](#method.new){.fn}( name: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, symbol: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, description: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, positions: [Vec](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}\<[Position](../../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}\>, epsilon: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, max_iterations: [u32](https://doc.rust-lang.org/1.91.1/std/primitive.u32.html){.primitive}, step_by: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-name-string-symbol-string-description-string-underlying_price-positive-positions-vecposition-epsilon-positive-max_iterations-u32-step_by-positive---self .code-header}
:::
...
::: {#impl-BasicAble-for-CustomStrategy .section .impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#522-600){.src
.rightside}[§](#impl-BasicAble-for-CustomStrategy){.anchor}

### impl [BasicAble](../base/trait.BasicAble.html "trait optionstratlib::strategies::base::BasicAble"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-basicable-for-customstrategy .code-header}
:::

::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#523-525){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#527-538){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#540-552){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#554-566){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#568-570){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#572-574){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#576-584){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#586-592){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#594-599){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#359-361){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#363-384){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#50){.src
.rightside}[§](#impl-Clone-for-CustomStrategy){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-clone-for-customstrategy .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#fn-cloneself---customstrategy .code-header}
:::
...
::: {#impl-ComposeSchema-for-CustomStrategy .section .impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#50){.src
.rightside}[§](#impl-ComposeSchema-for-CustomStrategy){.anchor}

### impl ComposeSchema for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-composeschema-for-customstrategy .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-debug-for-customstrategy .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-CustomStrategy .section .impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#50){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-CustomStrategy){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#implde-deserializede-for-customstrategy .code-header}
:::
...
### impl [Graph](../../visualization/trait.Graph.html "trait optionstratlib::visualization::Graph"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-graph-for-customstrategy .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#919-925){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#770-823){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#931-946){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#948-961){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#963-972){.src
.rightside}[§](#method.adjustments_pnl){.anchor}

#### fn [adjustments_pnl](../../pnl/trait.PnLCalculator.html#method.adjustments_pnl){.fn}( &self, adjustment: &[DeltaAdjustment](../delta_neutral/enum.DeltaAdjustment.html "enum optionstratlib::strategies::delta_neutral::DeltaAdjustment"){.enum}, ) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[PnL](../../pnl/utils/struct.PnL.html "struct optionstratlib::pnl::utils::PnL"){.struct}, [PricingError](../../error/pricing/enum.PricingError.html "enum optionstratlib::error::pricing::PricingError"){.enum}\> {#fn-adjustments_pnl-self-adjustment-deltaadjustment---resultpnl-pricingerror .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#388-397){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#399-401){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#403-427){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#429-453){.src
.rightside}[§](#method.get_position_unique){.anchor}

#### fn [get_position_unique](../base/trait.Positionable.html#method.get_position_unique){.fn}( &mut self, option_style: &[OptionStyle](../../model/types/enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}, side: &[Side](../../model/types/enum.Side.html "enum optionstratlib::model::types::Side"){.enum}, ) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<&mut [Position](../../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}, [PositionError](../../error/position/enum.PositionError.html "enum optionstratlib::error::position::PositionError"){.enum}\> {#fn-get_position_unique-mut-self-option_style-optionstyle-side-side---resultmut-position-positionerror .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#455-462){.src
.rightside}[§](#method.get_option_unique){.anchor}

#### fn [get_option_unique](../base/trait.Positionable.html#method.get_option_unique){.fn}( &mut self, option_style: &[OptionStyle](../../model/types/enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}, side: &[Side](../../model/types/enum.Side.html "enum optionstratlib::model::types::Side"){.enum}, ) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<&mut [Options](../../model/option/struct.Options.html "struct optionstratlib::model::option::Options"){.struct}, [PositionError](../../error/position/enum.PositionError.html "enum optionstratlib::error::position::PositionError"){.enum}\> {#fn-get_option_unique-mut-self-option_style-optionstyle-side-side---resultmut-options-positionerror .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#464-478){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#480-509){.src
.rightside}[§](#method.replace_position){.anchor}

#### fn [replace_position](../base/trait.Positionable.html#method.replace_position){.fn}(&mut self, position: &[Position](../../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[()](https://doc.rust-lang.org/1.91.1/std/primitive.unit.html){.primitive}, [PositionError](../../error/position/enum.PositionError.html "enum optionstratlib::error::position::PositionError"){.enum}\> {#fn-replace_positionmut-self-position-position---result-positionerror .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#839-876){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#878-915){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#827-833){.src
...
::: {#impl-Serialize-for-CustomStrategy .section .impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#50){.src
.rightside}[§](#impl-Serialize-for-CustomStrategy){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-serialize-for-customstrategy .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#513-519){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#603-609){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#611-641){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#643-673){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#675-700){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#702-716){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#718-729){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#731-734){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#736-739){.src
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#344-355){.src
...
::: {#impl-ToSchema-for-CustomStrategy .section .impl}
[Source](../../../src/optionstratlib/strategies/custom.rs.html#50){.src
.rightside}[§](#impl-ToSchema-for-CustomStrategy){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-toschema-for-customstrategy .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/custom.rs.html#743-764){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-freeze-for-customstrategy .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-send-for-customstrategy .code-header}
:::

::: {#impl-Sync-for-CustomStrategy .section .impl}
[§](#impl-Sync-for-CustomStrategy){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-sync-for-customstrategy .code-header}
:::

::: {#impl-Unpin-for-CustomStrategy .section .impl}
[§](#impl-Unpin-for-CustomStrategy){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-unpin-for-customstrategy .code-header}
:::

::: {#impl-UnwindSafe-for-CustomStrategy .section .impl}
[§](#impl-UnwindSafe-for-CustomStrategy){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [CustomStrategy](struct.CustomStrategy.html "struct optionstratlib::strategies::custom::CustomStrategy"){.struct} {#impl-unwindsafe-for-customstrategy .code-header}
:::
:::::::::
