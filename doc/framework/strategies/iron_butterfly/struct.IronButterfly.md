...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../../index.html)::[strategies](../index.html)::[iron_butterfly](index.html)
:::

# Struct [IronButterfly]{.struct} Copy item path

[[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#102-119){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#ironbutterfly){.doc-anchor}IronButterfly

Represents an Iron Butterfly options trading strategy. This strategy
involves four options positions: a short call and short put at the same
middle strike price, along with a long call at a higher strike and a
long put at a lower strike, all with the same expiration date.

An Iron Butterfly is a neutral options strategy that profits from low
volatility, where the underlying asset price remains close to the middle
...
- `short_call`: The short call position component at the middle strike
  price.
- `short_put`: The short put position component at the same middle
  strike price.
- `long_call`: The long call position component at a higher strike
  price.
- `long_put`: The long put position component at a lower strike price.

### [§](#risk-profile){.doc-anchor}Risk Profile

An Iron Butterfly has limited risk and limited profit potential. The
maximum risk is defined by the difference between the middle strike and
either wing strike, minus the net premium received.

### [§](#maximum-profit){.doc-anchor}Maximum Profit

The maximum profit is achieved when the underlying asset price at
expiration equals exactly the middle strike price. In this scenario, all
options expire worthless except the short positions, and the trader
keeps the full premium collected.

### [§](#maximum-loss){.doc-anchor}Maximum Loss

The maximum loss is limited and occurs when the price of the underlying
asset moves beyond either the upper or lower strike price. The
worst-case scenario loss is the difference between strike prices minus
...
- The trader wants defined risk/reward parameters compared to a short
  straddle
:::
...
::: {#impl-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#121-316){.src
.rightside}[§](#impl-IronButterfly){.anchor}

### impl [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-ironbutterfly .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#170-315){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, short_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, long_call_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, long_put_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, expiration: [ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_short_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-short_strike-positive-long_call_strike-positive-long_put_strike-positive-expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_short_call-positive-premium_short_put-positive-premium_long_call-positive-premium_long_put-positive-open_fee-positive-close_fee-positive---self .code-header}
:::

::: docblock
##### [§](#iron-butterfly-strategy-constructor){.doc-anchor}Iron Butterfly Strategy Constructor

Creates a new Iron Butterfly options trading strategy instance. An Iron
Butterfly is a neutral options strategy that combines selling an
at-the-money put and call while buying an out-of-the-money call and an
...
- `short_strike` - Strike price for both short call and short put
  options
- `long_call_strike` - Strike price for the long call option (higher
  than the short strike)
- `long_put_strike` - Strike price for the long put option (lower than
  the short strike)
...
Returns a fully configured `IronButterfly` strategy instance with all
positions established and break-even points calculated.

###### [§](#strategy-characteristics){.doc-anchor}Strategy Characteristics

- **Maximum Profit**: Achieved when the underlying asset price equals
  the short strike price at expiration. The maximum profit equals the
  net credit received (premiums from short options minus premiums paid
  for long options).

- **Maximum Risk**: Limited and defined by the difference between
  adjacent strike prices minus the net credit received.
...
- **Ideal Market Outlook**: Neutral, expecting low volatility with the
  underlying price remaining near the short strike price.
:::
:::::
:::::::
...
::: {#impl-BasicAble-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#607-769){.src
.rightside}[§](#impl-BasicAble-for-IronButterfly){.anchor}

### impl [BasicAble](../base/trait.BasicAble.html "trait optionstratlib::strategies::base::BasicAble"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-basicable-for-ironbutterfly .code-header}
:::

::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#608-625){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#626-658){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#659-693){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#694-716){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#717-719){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#720-722){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#723-730){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#731-749){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#750-768){.src
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-breakevenable-for-ironbutterfly .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#439-441){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#443-456){.src
...
::: {#impl-Clone-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-Clone-for-IronButterfly){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-clone-for-ironbutterfly .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#fn-cloneself---ironbutterfly .code-header}
:::
...
::: {#impl-ComposeSchema-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-ComposeSchema-for-IronButterfly){.anchor}

### impl ComposeSchema for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-composeschema-for-ironbutterfly .code-header}
:::
...
::: {#impl-Debug-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-Debug-for-IronButterfly){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-debug-for-ironbutterfly .code-header}
:::
...
::: {#impl-Default-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#108-121){.src
.rightside}[§](#impl-Default-for-IronButterfly){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-default-for-ironbutterfly .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/default.rs.html#109-120){.src
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-deltaneutrality-for-ironbutterfly .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-IronButterfly){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#implde-deserializede-for-ironbutterfly .code-header}
:::
...
::: {#impl-Display-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-Display-for-IronButterfly){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-display-for-ironbutterfly .code-header}
:::
...
### impl [Graph](../../visualization/trait.Graph.html "trait optionstratlib::visualization::Graph"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-graph-for-ironbutterfly .code-header}
:::
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-greeks-for-ironbutterfly .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#1044-1051){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-optimizable-for-ironbutterfly .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#type-strategy-ironbutterfly .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#830-879){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#881-918){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#920-951){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-pnlcalculator-for-ironbutterfly .code-header}
:::

::::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#1057-1075){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#1077-1093){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-positionable-for-ironbutterfly .code-header}
:::

::::::::::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#518-548){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#558-594){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#478-497){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#499-506){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-probabilityanalysis-for-ironbutterfly .code-header}
:::

::::::::::::::::: impl-items
::: {#method.get_profit_ranges .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#965-996){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#998-1040){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-profit-for-ironbutterfly .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#955-961){.src
...
::: {#impl-Serialize-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-Serialize-for-IronButterfly){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-serialize-for-ironbutterfly .code-header}
:::
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-strategable-for-ironbutterfly .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#598-604){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-strategies-for-ironbutterfly .code-header}
:::

::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_max_profit .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#772-786){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#788-799){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#801-814){.src
...
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#816-824){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-strategyconstructor-for-ironbutterfly .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#319-435){.src
...
::: {#impl-ToSchema-for-IronButterfly .section .impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#101){.src
.rightside}[§](#impl-ToSchema-for-IronButterfly){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-toschema-for-ironbutterfly .code-header}
:::
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-validable-for-ironbutterfly .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/iron_butterfly.rs.html#460-474){.src
...
::: {#impl-Freeze-for-IronButterfly .section .impl}
[§](#impl-Freeze-for-IronButterfly){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-freeze-for-ironbutterfly .code-header}
:::

::: {#impl-RefUnwindSafe-for-IronButterfly .section .impl}
[§](#impl-RefUnwindSafe-for-IronButterfly){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-refunwindsafe-for-ironbutterfly .code-header}
:::

::: {#impl-Send-for-IronButterfly .section .impl}
[§](#impl-Send-for-IronButterfly){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-send-for-ironbutterfly .code-header}
:::

::: {#impl-Sync-for-IronButterfly .section .impl}
[§](#impl-Sync-for-IronButterfly){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-sync-for-ironbutterfly .code-header}
:::

::: {#impl-Unpin-for-IronButterfly .section .impl}
[§](#impl-Unpin-for-IronButterfly){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-unpin-for-ironbutterfly .code-header}
:::

::: {#impl-UnwindSafe-for-IronButterfly .section .impl}
[§](#impl-UnwindSafe-for-IronButterfly){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [IronButterfly](struct.IronButterfly.html "struct optionstratlib::strategies::iron_butterfly::IronButterfly"){.struct} {#impl-unwindsafe-for-ironbutterfly .code-header}
:::
:::::::::
