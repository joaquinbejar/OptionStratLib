...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../../index.html)::[strategies](../index.html)::[butterfly_spread](index.html)
:::

# Struct [ShortButterflySpread]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1034-1049){.src}
]{.sub-heading}
::::
...
A Short Butterfly Spread involves selling two options at the middle
strike price and buying one option each at the lower and upper strike
prices. This strategy profits when the underlying asset price moves
significantly in either direction, with maximum loss occurring when the
price stays near the middle strike at expiration.

The strategy consists of:

- Long call at the lowest strike price
- Two short calls at the middle strike price (represented as
  `short_call_low` and `short_call_high`)
...
::: docblock
A textual description of the strategy, including relevant details like
strike prices
:::
...
::: docblock
The price points at which the strategy breaks even (typically two
points)
:::
...
::: {#impl-ShortButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1051-1192){.src
.rightside}[§](#impl-ShortButterflySpread){.anchor}

### impl [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-shortbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1085-1191){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, low_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, middle_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, high_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, expiration: [ExpirationDate](../../model/types/enum.ExpirationDate.html "enum optionstratlib::model::types::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: Decimal, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_middle: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_short_call_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_short_call_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_short_call_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_short_call_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-low_strike-positive-middle_strike-positive-high_strike-positive-expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_low-positive-premium_middle-positive-premium_high-positive-open_fee_long_call-positive-close_fee_long_call-positive-open_fee_short_call_low-positive-close_fee_short_call_low-positive-open_fee_short_call_high-positive-close_fee_short_call_high-positive---self .code-header}
:::

::: docblock
Creates a new Short Butterfly Spread options strategy.

A Short Butterfly Spread is created by selling one call at a lower
strike price, buying two calls at a middle strike price, and selling one
call at a higher strike price, all with the same expiration date. This
strategy profits when the underlying price moves significantly away from
the middle strike price in either direction.
...
- `implied_volatility` - The implied volatility used for pricing the
  options.
- `risk_free_rate` - The risk-free interest rate as a decimal.
- `dividend_yield` - The dividend yield of the underlying asset.
- `quantity` - The quantity of contracts for each leg (except middle
  strike which uses 2x quantity).
...
- `open_fee_short_call_low` - The fee to open the lower strike short
  call position.
- `close_fee_short_call_low` - The fee to close the lower strike short
  call position.
- `open_fee_short_call_high` - The fee to open the higher strike short
  call position.
- `close_fee_short_call_high` - The fee to close the higher strike short
  call position.

##### [§](#returns){.doc-anchor}Returns

A fully initialized `ShortButterflySpread` strategy with calculated
break-even points.
:::
:::::
:::::::
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-breakevenable-for-shortbutterflyspread .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1306-1308){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1310-1331){.src
...
::: {#impl-Clone-for-ShortButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1033){.src
.rightside}[§](#impl-Clone-for-ShortButterflySpread){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-clone-for-shortbutterflyspread .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#fn-cloneself---shortbutterflyspread .code-header}
:::
...
::: {#impl-Debug-for-ShortButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1033){.src
.rightside}[§](#impl-Debug-for-ShortButterflySpread){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-debug-for-shortbutterflyspread .code-header}
:::
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-deltaneutrality-for-shortbutterflyspread .code-header}
:::
...
### impl [Graph](../../visualization/utils/trait.Graph.html "trait optionstratlib::visualization::utils::Graph"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-graph-for-shortbutterflyspread .code-header}
:::

::::::::::::::: impl-items
::: {#method.title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1709-1734){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1736-1739){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1741-1755){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1757-1841){.src
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-greeks-for-shortbutterflyspread .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1934-1940){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-optimizable-for-shortbutterflyspread .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#type-strategy-shortbutterflyspread .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1569-1622){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1624-1660){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1662-1696){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-pnlcalculator-for-shortbutterflyspread .code-header}
:::

::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1946-1965){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1967-1980){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-positionable-for-shortbutterflyspread .code-header}
:::

::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1409-1441){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1451-1496){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1372-1389){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1391-1397){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-probabilityanalysis-for-shortbutterflyspread .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_expiration .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1845-1847){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1849-1851){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1853-1901){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1903-1930){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-profit-for-shortbutterflyspread .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1700-1705){.src
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-strategable-for-shortbutterflyspread .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1500-1506){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-strategies-for-shortbutterflyspread .code-header}
:::

::::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_underlying_price .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1510-1512){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1514-1527){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1529-1540){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1542-1553){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1555-1563){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-strategyconstructor-for-shortbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1195-1302){.src
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-validable-for-shortbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1335-1368){.src
...
::: {#impl-Freeze-for-ShortButterflySpread .section .impl}
[§](#impl-Freeze-for-ShortButterflySpread){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-freeze-for-shortbutterflyspread .code-header}
:::

::: {#impl-RefUnwindSafe-for-ShortButterflySpread .section .impl}
[§](#impl-RefUnwindSafe-for-ShortButterflySpread){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-refunwindsafe-for-shortbutterflyspread .code-header}
:::

::: {#impl-Send-for-ShortButterflySpread .section .impl}
[§](#impl-Send-for-ShortButterflySpread){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-send-for-shortbutterflyspread .code-header}
:::

::: {#impl-Sync-for-ShortButterflySpread .section .impl}
[§](#impl-Sync-for-ShortButterflySpread){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-sync-for-shortbutterflyspread .code-header}
:::

::: {#impl-Unpin-for-ShortButterflySpread .section .impl}
[§](#impl-Unpin-for-ShortButterflySpread){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-unpin-for-shortbutterflyspread .code-header}
:::

::: {#impl-UnwindSafe-for-ShortButterflySpread .section .impl}
[§](#impl-UnwindSafe-for-ShortButterflySpread){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ShortButterflySpread](struct.ShortButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::ShortButterflySpread"){.struct} {#impl-unwindsafe-for-shortbutterflyspread .code-header}
:::
:::::::::
