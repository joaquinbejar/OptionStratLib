...
# Struct [LongButterflySpread]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#59-74){.src}
]{.sub-heading}
::::
...
A Long Butterfly Spread is created by combining three positions with the
same expiration date: buying a lower strike call, selling two middle
strike calls, and buying a higher strike call. This strategy has limited
risk and limited profit potential, typically used when an investor
...
- Maximum profit occurs when the underlying price equals the middle
...
::: {#impl-LongButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#76-216){.src
.rightside}[§](#impl-LongButterflySpread){.anchor}

### impl [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-longbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#108-215){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, low_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, middle_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, high_strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, expiration: [ExpirationDate](../../model/types/enum.ExpirationDate.html "enum optionstratlib::model::types::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: Decimal, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_middle: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_short_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call_low: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call_high: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-low_strike-positive-middle_strike-positive-high_strike-positive-expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_low-positive-premium_middle-positive-premium_high-positive-open_fee_short_call-positive-close_fee_short_call-positive-open_fee_long_call_low-positive-close_fee_long_call_low-positive-open_fee_long_call_high-positive-close_fee_long_call_high-positive---self .code-header}
:::

::: docblock
Creates a new Long Butterfly Spread strategy with the specified
parameters.

A Long Butterfly Spread is created by buying one call at a lower strike
price, selling two calls at a middle strike price, and buying one call
at a higher strike price, all with the same expiration date. This
strategy profits when the underlying price stays near the middle strike
price at expiration.
...
- `high_strike` - The strike price for the long call at the higher
  strike
...
- `quantity` - The number of contracts for each position (note: middle
  position uses 2x this quantity)
- `premium_low` - The premium paid for the long call at the lower strike
- `premium_middle` - The premium received for each short call at the
  middle strike
- `premium_high` - The premium paid for the long call at the higher
  strike
...
- `close_fee_short_call` - Transaction fee for closing the short call
  positions
- `open_fee_long_call_low` - Transaction fee for opening the lower
  strike long call
- `close_fee_long_call_low` - Transaction fee for closing the lower
  strike long call
- `open_fee_long_call_high` - Transaction fee for opening the higher
  strike long call
- `close_fee_long_call_high` - Transaction fee for closing the higher
  strike long call

##### [§](#returns){.doc-anchor}Returns

A fully configured Long Butterfly Spread strategy with positions and
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-breakevenable-for-longbutterflyspread .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#330-332){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#334-355){.src
...
::: {#impl-Clone-for-LongButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#58){.src
.rightside}[§](#impl-Clone-for-LongButterflySpread){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-clone-for-longbutterflyspread .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#fn-cloneself---longbutterflyspread .code-header}
:::
...
::: {#impl-Debug-for-LongButterflySpread .section .impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#58){.src
.rightside}[§](#impl-Debug-for-LongButterflySpread){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-debug-for-longbutterflyspread .code-header}
:::
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-deltaneutrality-for-longbutterflyspread .code-header}
:::
...
### impl [Graph](../../visualization/utils/trait.Graph.html "trait optionstratlib::visualization::utils::Graph"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-graph-for-longbutterflyspread .code-header}
:::

::::::::::::::: impl-items
::: {#method.title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#740-772){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#774-777){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#779-793){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#795-874){.src
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-greeks-for-longbutterflyspread .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#967-973){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-optimizable-for-longbutterflyspread .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#type-strategy-longbutterflyspread .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#600-653){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#655-691){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#693-727){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-pnlcalculator-for-longbutterflyspread .code-header}
:::

::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#979-998){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#1000-1013){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-positionable-for-longbutterflyspread .code-header}
:::

::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#433-465){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#475-520){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#396-413){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#415-421){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-probabilityanalysis-for-longbutterflyspread .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_expiration .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#878-880){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#882-884){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#886-913){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#915-963){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-profit-for-longbutterflyspread .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#731-736){.src
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-strategable-for-longbutterflyspread .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#524-530){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-strategies-for-longbutterflyspread .code-header}
:::

::::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_underlying_price .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#534-536){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#538-549){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#551-564){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#566-584){.src
...
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#586-594){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-strategyconstructor-for-longbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#219-326){.src
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-validable-for-longbutterflyspread .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/butterfly_spread.rs.html#359-392){.src
...
::: {#impl-Freeze-for-LongButterflySpread .section .impl}
[§](#impl-Freeze-for-LongButterflySpread){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-freeze-for-longbutterflyspread .code-header}
:::

::: {#impl-RefUnwindSafe-for-LongButterflySpread .section .impl}
[§](#impl-RefUnwindSafe-for-LongButterflySpread){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-refunwindsafe-for-longbutterflyspread .code-header}
:::

::: {#impl-Send-for-LongButterflySpread .section .impl}
[§](#impl-Send-for-LongButterflySpread){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-send-for-longbutterflyspread .code-header}
:::

::: {#impl-Sync-for-LongButterflySpread .section .impl}
[§](#impl-Sync-for-LongButterflySpread){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-sync-for-longbutterflyspread .code-header}
:::

::: {#impl-Unpin-for-LongButterflySpread .section .impl}
[§](#impl-Unpin-for-LongButterflySpread){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-unpin-for-longbutterflyspread .code-header}
:::

::: {#impl-UnwindSafe-for-LongButterflySpread .section .impl}
[§](#impl-UnwindSafe-for-LongButterflySpread){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [LongButterflySpread](struct.LongButterflySpread.html "struct optionstratlib::strategies::butterfly_spread::LongButterflySpread"){.struct} {#impl-unwindsafe-for-longbutterflyspread .code-header}
:::
:::::::::
