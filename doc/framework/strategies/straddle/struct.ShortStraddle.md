...
# Struct [ShortStraddle]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/straddle.rs.html#114-127){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#shortstraddle){.doc-anchor}ShortStraddle

Represents a Short Straddle options trading strategy. This strategy
involves selling both a call option and a put option with the same
strike price and expiration date.

A short straddle is a neutral strategy that profits from low volatility,
where the underlying asset price remains close to the strike price
through expiration.
...
A short straddle has unlimited risk if the stock price moves
significantly in either direction, but has limited profit potential
equal to the total premium collected from both options.

### [§](#maximum-profit){.doc-anchor}Maximum Profit

The maximum profit is achieved when the underlying asset price at
expiration equals exactly the strike price of both options. In this
case, both options expire worthless and the trader keeps the full
premium collected.

### [§](#maximum-loss){.doc-anchor}Maximum Loss

The potential loss is theoretically unlimited on the upside (if the
stock price rises significantly) and is limited to the strike price
minus the premium received on the downside (if the stock price falls to
zero).
...
::: {#impl-ShortStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#129-244){.src
.rightside}[§](#impl-ShortStraddle){.anchor}

### impl [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-shortstraddle .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#160-243){.src
.rightside}
...
::: docblock
##### [§](#shortstraddle-constructor){.doc-anchor}ShortStraddle Constructor

Creates a new Short Straddle options strategy, which involves
simultaneously selling a call and a put option with the same strike
...
- `strike` - The strike price for both options. If set to zero, it
  defaults to the underlying price (at-the-money)
...
- `open_fee_short_call` - The transaction fee for opening the short call
  position
- `close_fee_short_call` - The transaction fee for closing the short
  call position
- `open_fee_short_put` - The transaction fee for opening the short put
  position
- `close_fee_short_put` - The transaction fee for closing the short put
  position
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-breakevenable-for-shortstraddle .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#348-350){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#352-371){.src
...
::: {#impl-Clone-for-ShortStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#113){.src
.rightside}[§](#impl-Clone-for-ShortStraddle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-clone-for-shortstraddle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#fn-cloneself---shortstraddle .code-header}
:::
...
::: {#impl-Debug-for-ShortStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#113){.src
.rightside}[§](#impl-Debug-for-ShortStraddle){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-debug-for-shortstraddle .code-header}
:::
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-deltaneutrality-for-shortstraddle .code-header}
:::
...
### impl [Graph](../../visualization/utils/trait.Graph.html "trait optionstratlib::visualization::utils::Graph"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-graph-for-shortstraddle .code-header}
:::

::::::::::::::: impl-items
::: {#method.title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#661-673){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#675-678){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#680-699){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#701-747){.src
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-greeks-for-shortstraddle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#831-833){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-optimizable-for-shortstraddle .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#type-strategy-shortstraddle .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#532-571){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#573-608){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#610-637){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-pnlcalculator-for-shortstraddle .code-header}
:::

::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#839-851){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#853-863){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-positionable-for-shortstraddle .code-header}
:::

::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#402-428){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#438-472){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#375-386){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#388-390){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-probabilityanalysis-for-shortstraddle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_expiration .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#751-754){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#756-758){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#760-787){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#789-827){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-profit-for-shortstraddle .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#641-657){.src
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-strategable-for-shortstraddle .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#476-482){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-strategies-for-shortstraddle .code-header}
:::

::::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_underlying_price .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#486-488){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#490-501){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#503-505){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#507-512){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#514-518){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-strategyconstructor-for-shortstraddle .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#247-344){.src
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-validable-for-shortstraddle .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#522-526){.src
...
::: {#impl-Freeze-for-ShortStraddle .section .impl}
[§](#impl-Freeze-for-ShortStraddle){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-freeze-for-shortstraddle .code-header}
:::

::: {#impl-RefUnwindSafe-for-ShortStraddle .section .impl}
[§](#impl-RefUnwindSafe-for-ShortStraddle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-refunwindsafe-for-shortstraddle .code-header}
:::

::: {#impl-Send-for-ShortStraddle .section .impl}
[§](#impl-Send-for-ShortStraddle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-send-for-shortstraddle .code-header}
:::

::: {#impl-Sync-for-ShortStraddle .section .impl}
[§](#impl-Sync-for-ShortStraddle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-sync-for-shortstraddle .code-header}
:::

::: {#impl-Unpin-for-ShortStraddle .section .impl}
[§](#impl-Unpin-for-ShortStraddle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-unpin-for-shortstraddle .code-header}
:::

::: {#impl-UnwindSafe-for-ShortStraddle .section .impl}
[§](#impl-UnwindSafe-for-ShortStraddle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ShortStraddle](struct.ShortStraddle.html "struct optionstratlib::strategies::straddle::ShortStraddle"){.struct} {#impl-unwindsafe-for-shortstraddle .code-header}
:::
:::::::::
