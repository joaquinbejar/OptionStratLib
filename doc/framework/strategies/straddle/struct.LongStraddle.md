...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../../index.html)::[strategies](../index.html)::[straddle](index.html)
:::

# Struct [LongStraddle]{.struct}Copy item path

[[Source](../../../src/optionstratlib/strategies/straddle.rs.html#926-939){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#longstraddle){.doc-anchor}LongStraddle

Represents a Long Straddle options trading strategy, which involves
buying both a call and put option with the same strike price and
expiration date.

A Long Straddle is a volatility strategy that profits when the
underlying asset price moves significantly in either direction. It
consists of buying a call option and buying a put option with identical
...
- `break_even_points` - Vector of price points where the strategy breaks
  even (typically two points for a Long Straddle).
- `long_call` - The long call position component of the strategy.
- `long_put` - The long put position component of the strategy.

### [§](#profitloss-characteristics){.doc-anchor}Profit/Loss Characteristics

- Maximum Loss: Limited to the total premium paid for both options
  (occurs when price at expiration equals the strike price).
- Maximum Profit: Theoretically unlimited to the upside, and limited to
  the downside by how far the underlying can fall (minus strike price
  and premiums paid).
- Break-even Points: Strike Price + Total Premium Paid (upper) and
  Strike Price - Total Premium Paid (lower).
...
- Before major market events (earnings announcements, FDA approvals,
  etc.)
- During periods of low implied volatility, anticipating increased
  volatility

### [§](#risk-management){.doc-anchor}Risk Management

- Time decay (theta) works against this strategy, as both options lose
  value over time
- Most effective when implemented with sufficient time to expiration
- Consider closing the position if implied volatility increases
  significantly without price movement
:::
...
::: docblock
The price points where profit/loss equals zero (typically two points for
a straddle)
:::
...
::: {#impl-LongStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#941-1051){.src
.rightside}[§](#impl-LongStraddle){.anchor}

### impl [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-longstraddle .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#967-1050){.src
.rightside}

#### pub fn [new](#method.new){.fn}( underlying_symbol: [String](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}, underlying_price: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, strike: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, expiration: [ExpirationDate](../../model/types/enum.ExpirationDate.html "enum optionstratlib::model::types::ExpirationDate"){.enum}, implied_volatility: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: Decimal, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, quantity: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, premium_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_call: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_fee_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_fee_long_put: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, ) -\> Self {#pub-fn-new-underlying_symbol-string-underlying_price-positive-strike-positive-expiration-expirationdate-implied_volatility-positive-risk_free_rate-decimal-dividend_yield-positive-quantity-positive-premium_long_call-positive-premium_long_put-positive-open_fee_long_call-positive-close_fee_long_call-positive-open_fee_long_put-positive-close_fee_long_put-positive---self .code-header}
:::

::: docblock
Creates a new Long Straddle strategy.

This constructor builds a Long Straddle by creating and adding both the
long call and long put positions with the same strike price and
expiration date.
...
- `strike` - The strike price for both options (defaults to
...
- `premium_long_call` - The premium paid per contract for the call
  option
...
A fully initialized Long Straddle strategy with calculated break-even
points
:::
:::::
:::::::
...
### impl [BreakEvenable](../base/trait.BreakEvenable.html "trait optionstratlib::strategies::base::BreakEvenable"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-breakevenable-for-longstraddle .code-header}
:::

::::::: impl-items
::: {#method.get_break_even_points .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1155-1157){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1159-1176){.src
...
::: {#impl-Clone-for-LongStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#925){.src
.rightside}[§](#impl-Clone-for-LongStraddle){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-clone-for-longstraddle .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#fn-cloneself---longstraddle .code-header}
:::
...
::: {#impl-Debug-for-LongStraddle .section .impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#925){.src
.rightside}[§](#impl-Debug-for-LongStraddle){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-debug-for-longstraddle .code-header}
:::
...
### impl [DeltaNeutrality](../delta_neutral/trait.DeltaNeutrality.html "trait optionstratlib::strategies::delta_neutral::DeltaNeutrality"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-deltaneutrality-for-longstraddle .code-header}
:::
...
### impl [Graph](../../visualization/utils/trait.Graph.html "trait optionstratlib::visualization::utils::Graph"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-graph-for-longstraddle .code-header}
:::

::::::::::::::: impl-items
::: {#method.title .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1444-1456){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1458-1461){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1463-1482){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1484-1527){.src
...
### impl [Greeks](../../greeks/trait.Greeks.html "trait optionstratlib::greeks::Greeks"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-greeks-for-longstraddle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_options .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1611-1613){.src
...
### impl [Optimizable](../base/trait.Optimizable.html "trait optionstratlib::strategies::base::Optimizable"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-optimizable-for-longstraddle .code-header}
:::
...
#### type [Strategy](../base/trait.Optimizable.html#associatedtype.Strategy){.associatedtype} = [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#type-strategy-longstraddle .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1332-1371){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1373-1408){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1410-1433){.src
...
### impl [PnLCalculator](../../pnl/trait.PnLCalculator.html "trait optionstratlib::pnl::PnLCalculator"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-pnlcalculator-for-longstraddle .code-header}
:::

::::::::: impl-items
::: {#method.calculate_pnl .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1619-1631){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1633-1643){.src
...
### impl [Positionable](../base/trait.Positionable.html "trait optionstratlib::strategies::base::Positionable"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-positionable-for-longstraddle .code-header}
:::

::::::::::: impl-items
::: {#method.get_position .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1207-1233){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1243-1277){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1180-1191){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1193-1195){.src
...
### impl [ProbabilityAnalysis](../probabilities/trait.ProbabilityAnalysis.html "trait optionstratlib::strategies::probabilities::ProbabilityAnalysis"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-probabilityanalysis-for-longstraddle .code-header}
:::

::::::::::::::::::::: impl-items
::: {#method.get_expiration .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1531-1534){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1536-1538){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1540-1578){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1580-1607){.src
...
### impl [Profit](../../pricing/trait.Profit.html "trait optionstratlib::pricing::Profit"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-profit-for-longstraddle .code-header}
:::

::::::: impl-items
::: {#method.calculate_profit_at .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1437-1440){.src
...
### impl [Strategable](../base/trait.Strategable.html "trait optionstratlib::strategies::base::Strategable"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-strategable-for-longstraddle .code-header}
:::

::::::::: impl-items
::: {#method.info .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1281-1287){.src
...
### impl [Strategies](../base/trait.Strategies.html "trait optionstratlib::strategies::base::Strategies"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-strategies-for-longstraddle .code-header}
:::

::::::::::::::::::::::::::::::::::::::::::: impl-items
::: {#method.get_underlying_price .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1291-1293){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1295-1297){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1299-1301){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1303-1309){.src
...
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1311-1318){.src
...
### impl [StrategyConstructor](../trait.StrategyConstructor.html "trait optionstratlib::strategies::StrategyConstructor"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-strategyconstructor-for-longstraddle .code-header}
:::

::::: impl-items
::: {#method.get_strategy .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1054-1151){.src
...
### impl [Validable](../base/trait.Validable.html "trait optionstratlib::strategies::base::Validable"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-validable-for-longstraddle .code-header}
:::

::::: impl-items
::: {#method.validate .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/straddle.rs.html#1322-1326){.src
...
::: {#impl-Freeze-for-LongStraddle .section .impl}
[§](#impl-Freeze-for-LongStraddle){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-freeze-for-longstraddle .code-header}
:::

::: {#impl-RefUnwindSafe-for-LongStraddle .section .impl}
[§](#impl-RefUnwindSafe-for-LongStraddle){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-refunwindsafe-for-longstraddle .code-header}
:::

::: {#impl-Send-for-LongStraddle .section .impl}
[§](#impl-Send-for-LongStraddle){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-send-for-longstraddle .code-header}
:::

::: {#impl-Sync-for-LongStraddle .section .impl}
[§](#impl-Sync-for-LongStraddle){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-sync-for-longstraddle .code-header}
:::

::: {#impl-Unpin-for-LongStraddle .section .impl}
[§](#impl-Unpin-for-LongStraddle){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-unpin-for-longstraddle .code-header}
:::

::: {#impl-UnwindSafe-for-LongStraddle .section .impl}
[§](#impl-UnwindSafe-for-LongStraddle){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [LongStraddle](struct.LongStraddle.html "struct optionstratlib::strategies::straddle::LongStraddle"){.struct} {#impl-unwindsafe-for-longstraddle .code-header}
:::
:::::::::
