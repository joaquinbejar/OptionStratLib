...
# Struct [DeltaInfo]{.struct} Copy item path

[[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#285-300){.src}
]{.sub-heading}
::::
...
This structure provides both an analysis of the cumulative delta of the
strategy and details about its individual positions. It can be used to
evaluate whether a strategy is delta neutral and to inform adjustments.

### [§](#purpose){.doc-anchor}Purpose

DeltaInfo serves as a central structure to analyze and manage the delta
status of multi-position strategies, such as those used in options
trading. It is particularly useful for implementing delta-neutral
strategy adjustments.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.net_delta){.anchor
.field}`net_delta: `[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.net_delta
.structfield .section-header}

::: docblock
The net delta of the strategy, representing the overall sensitivity of
the strategy to changes in the underlying asset price.
:::

[[§](#structfield.individual_deltas){.anchor
.field}`individual_deltas: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`DeltaPositionInfo`](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct}`>`]{#structfield.individual_deltas
.structfield .section-header}

::: docblock
A vector of `DeltaPositionInfo` structures containing the delta
information for each position in the strategy.
:::

[[§](#structfield.is_neutral){.anchor
.field}`is_neutral: `[`bool`](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive}]{#structfield.is_neutral
.structfield .section-header}

::: docblock
Indicates whether the strategy is considered delta neutral based on the
configured neutrality threshold.
:::

[[§](#structfield.neutrality_threshold){.anchor
.field}`neutrality_threshold: `[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.neutrality_threshold
.structfield .section-header}

::: docblock
The threshold used to determine if the strategy is delta neutral. If the
net delta is within this range, the strategy is considered neutral.
:::
...
::: docblock
The current price of the underlying asset, represented as a positive
value.
:::
...
::: {#impl-Clone-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-Clone-for-DeltaInfo){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-clone-for-deltainfo .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#fn-cloneself---deltainfo .code-header}
:::
...
::: {#impl-ComposeSchema-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-ComposeSchema-for-DeltaInfo){.anchor}

### impl ComposeSchema for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-composeschema-for-deltainfo .code-header}
:::
...
::: {#impl-Debug-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-Debug-for-DeltaInfo){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-debug-for-deltainfo .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-DeltaInfo){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#implde-deserializede-for-deltainfo .code-header}
:::
...
::: {#impl-Display-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#302-319){.src
.rightside}[§](#impl-Display-for-DeltaInfo){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-display-for-deltainfo .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#303-318){.src
...
::: {#impl-Serialize-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-Serialize-for-DeltaInfo){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-serialize-for-deltainfo .code-header}
:::
...
::: {#impl-ToSchema-for-DeltaInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#284){.src
.rightside}[§](#impl-ToSchema-for-DeltaInfo){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-toschema-for-deltainfo .code-header}
:::
...
::: {#impl-Freeze-for-DeltaInfo .section .impl}
[§](#impl-Freeze-for-DeltaInfo){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-freeze-for-deltainfo .code-header}
:::

::: {#impl-RefUnwindSafe-for-DeltaInfo .section .impl}
[§](#impl-RefUnwindSafe-for-DeltaInfo){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-refunwindsafe-for-deltainfo .code-header}
:::

::: {#impl-Send-for-DeltaInfo .section .impl}
[§](#impl-Send-for-DeltaInfo){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-send-for-deltainfo .code-header}
:::

::: {#impl-Sync-for-DeltaInfo .section .impl}
[§](#impl-Sync-for-DeltaInfo){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-sync-for-deltainfo .code-header}
:::

::: {#impl-Unpin-for-DeltaInfo .section .impl}
[§](#impl-Unpin-for-DeltaInfo){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-unpin-for-deltainfo .code-header}
:::

::: {#impl-UnwindSafe-for-DeltaInfo .section .impl}
[§](#impl-UnwindSafe-for-DeltaInfo){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-unwindsafe-for-deltainfo .code-header}
:::
:::::::::
