...
[[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#268-283){.src}
]{.sub-heading}
::::
...
.field}`net_delta: Decimal`]{#structfield.net_delta .structfield
.section-header}
...
.field}`individual_deltas: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`DeltaPositionInfo`](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct}`>`]{#structfield.individual_deltas
...
.field}`is_neutral: `[`bool`](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive}]{#structfield.is_neutral
.structfield .section-header}
...
.field}`neutrality_threshold: Decimal`]{#structfield.neutrality_threshold
.structfield .section-header}
...
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#267){.src
.rightside}[§](#impl-Clone-for-DeltaInfo){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-clone-for-deltainfo .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#fn-cloneself---deltainfo .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-debug-for-deltainfo .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#implde-deserializede-for-deltainfo .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#285-302){.src
.rightside}[§](#impl-Display-for-DeltaInfo){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-display-for-deltainfo .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#286-301){.src
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-serialize-for-deltainfo .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-freeze-for-deltainfo .code-header}
:::

::: {#impl-RefUnwindSafe-for-DeltaInfo .section .impl}
[§](#impl-RefUnwindSafe-for-DeltaInfo){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-refunwindsafe-for-deltainfo .code-header}
:::

::: {#impl-Send-for-DeltaInfo .section .impl}
[§](#impl-Send-for-DeltaInfo){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-send-for-deltainfo .code-header}
:::

::: {#impl-Sync-for-DeltaInfo .section .impl}
[§](#impl-Sync-for-DeltaInfo){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-sync-for-deltainfo .code-header}
:::

::: {#impl-Unpin-for-DeltaInfo .section .impl}
[§](#impl-Unpin-for-DeltaInfo){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-unpin-for-deltainfo .code-header}
:::

::: {#impl-UnwindSafe-for-DeltaInfo .section .impl}
[§](#impl-UnwindSafe-for-DeltaInfo){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [DeltaInfo](struct.DeltaInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaInfo"){.struct} {#impl-unwindsafe-for-deltainfo .code-header}
:::
:::::::::
