...
# Struct [DeltaPositionInfo]{.struct} Copy item path

[[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#242-260){.src}
]{.sub-heading}
::::
...
::: docblock
Represents the delta and associated details for a single position in an
options strategy.

This structure contains the key information about an individual option
position's delta characteristics, including its quantity, strike price,
and whether it's a call/put and long/short. It serves as a fundamental
building block for analyzing and managing the delta exposure of complex
options strategies.

### [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `delta`: The delta value of the position, representing the sensitivity
  of the position's price to changes in the underlying asset price.
- `quantity`: The quantity of the options in the position.
- `strike`: The strike price of the option, represented as a positive
  value.
...
`DeltaPositionInfo` is typically used within a collection to represent
all positions in a strategy when calculating net delta exposure or
determining adjustments needed for delta neutrality.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.delta){.anchor
.field}`delta: `[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.delta
.structfield .section-header}

::: docblock
The delta value of the position, representing the sensitivity of the
position's price to changes in the underlying asset price.
:::

[[§](#structfield.delta_per_contract){.anchor
.field}`delta_per_contract: `[`Decimal`](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.delta_per_contract
.structfield .section-header}

::: docblock
Represents the change in value (delta) for a single unit of a financial
contract.

The `delta_per_contract` field indicates the sensitivity of the
contract's price to changes in the price of the underlying asset. It is
expressed as a `Decimal` and is a crucial measure in derivatives trading
and risk management.
:::

[[§](#structfield.quantity){.anchor
.field}`quantity: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.quantity
.structfield .section-header}
...
.field}`option_style: `[`OptionStyle`](../../model/types/enum.OptionStyle.html "enum optionstratlib::model::types::OptionStyle"){.enum}]{#structfield.option_style
.structfield .section-header}
...
::: {#impl-Clone-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-Clone-for-DeltaPositionInfo){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-clone-for-deltapositioninfo .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#fn-cloneself---deltapositioninfo .code-header}
:::
...
::: {#impl-ComposeSchema-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-ComposeSchema-for-DeltaPositionInfo){.anchor}

### impl ComposeSchema for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-composeschema-for-deltapositioninfo .code-header}
:::
...
::: {#impl-Debug-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-Debug-for-DeltaPositionInfo){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-debug-for-deltapositioninfo .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-DeltaPositionInfo){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#implde-deserializede-for-deltapositioninfo .code-header}
:::
...
::: {#impl-Display-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#262-272){.src
.rightside}[§](#impl-Display-for-DeltaPositionInfo){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-display-for-deltapositioninfo .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#263-271){.src
...
::: {#impl-Serialize-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-Serialize-for-DeltaPositionInfo){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-serialize-for-deltapositioninfo .code-header}
:::
...
::: {#impl-ToSchema-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-ToSchema-for-DeltaPositionInfo){.anchor}

### impl [ToSchema](../../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-toschema-for-deltapositioninfo .code-header}
:::
...
::: {#impl-Copy-for-DeltaPositionInfo .section .impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#241){.src
.rightside}[§](#impl-Copy-for-DeltaPositionInfo){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-copy-for-deltapositioninfo .code-header}
:::
:::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-DeltaPositionInfo .section .impl}
[§](#impl-Freeze-for-DeltaPositionInfo){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-freeze-for-deltapositioninfo .code-header}
:::

::: {#impl-RefUnwindSafe-for-DeltaPositionInfo .section .impl}
[§](#impl-RefUnwindSafe-for-DeltaPositionInfo){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-refunwindsafe-for-deltapositioninfo .code-header}
:::

::: {#impl-Send-for-DeltaPositionInfo .section .impl}
[§](#impl-Send-for-DeltaPositionInfo){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-send-for-deltapositioninfo .code-header}
:::

::: {#impl-Sync-for-DeltaPositionInfo .section .impl}
[§](#impl-Sync-for-DeltaPositionInfo){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-sync-for-deltapositioninfo .code-header}
:::

::: {#impl-Unpin-for-DeltaPositionInfo .section .impl}
[§](#impl-Unpin-for-DeltaPositionInfo){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-unpin-for-deltapositioninfo .code-header}
:::

::: {#impl-UnwindSafe-for-DeltaPositionInfo .section .impl}
[§](#impl-UnwindSafe-for-DeltaPositionInfo){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-unwindsafe-for-deltapositioninfo .code-header}
:::
:::::::::
