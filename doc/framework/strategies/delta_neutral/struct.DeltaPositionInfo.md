...
[[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#232-244){.src}
]{.sub-heading}
::::
...
.field}`delta: Decimal`]{#structfield.delta .structfield
.section-header}
...
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#231){.src
.rightside}[§](#impl-Clone-for-DeltaPositionInfo){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-clone-for-deltapositioninfo .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#fn-cloneself---deltapositioninfo .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-debug-for-deltapositioninfo .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#implde-deserializede-for-deltapositioninfo .code-header}
:::
...
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#246-255){.src
.rightside}[§](#impl-Display-for-DeltaPositionInfo){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-display-for-deltapositioninfo .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../../src/optionstratlib/strategies/delta_neutral/model.rs.html#247-254){.src
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-serialize-for-deltapositioninfo .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-copy-for-deltapositioninfo .code-header}
:::
::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-freeze-for-deltapositioninfo .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-send-for-deltapositioninfo .code-header}
:::

::: {#impl-Sync-for-DeltaPositionInfo .section .impl}
[§](#impl-Sync-for-DeltaPositionInfo){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-sync-for-deltapositioninfo .code-header}
:::

::: {#impl-Unpin-for-DeltaPositionInfo .section .impl}
[§](#impl-Unpin-for-DeltaPositionInfo){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltaPositionInfo](struct.DeltaPositionInfo.html "struct optionstratlib::strategies::delta_neutral::DeltaPositionInfo"){.struct} {#impl-unpin-for-deltapositioninfo .code-header}
:::
