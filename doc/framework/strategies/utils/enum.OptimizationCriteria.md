...
# Enum [OptimizationCriteria]{.enum} Copy item path

[[Source](../../../src/optionstratlib/strategies/utils.rs.html#112-117){.src}
]{.sub-heading}
::::
...
::::::: variants
::: {#variant.Ratio .section .variant}
[§](#variant.Ratio){.anchor}

### Ratio {#ratio .code-header}
:::
...
::: {#variant.Area .section .variant}
[§](#variant.Area){.anchor}

### Area {#area .code-header}
:::
...
::: {#impl-Freeze-for-OptimizationCriteria .section .impl}
[§](#impl-Freeze-for-OptimizationCriteria){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-freeze-for-optimizationcriteria .code-header}
:::

::: {#impl-RefUnwindSafe-for-OptimizationCriteria .section .impl}
[§](#impl-RefUnwindSafe-for-OptimizationCriteria){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-refunwindsafe-for-optimizationcriteria .code-header}
:::

::: {#impl-Send-for-OptimizationCriteria .section .impl}
[§](#impl-Send-for-OptimizationCriteria){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-send-for-optimizationcriteria .code-header}
:::

::: {#impl-Sync-for-OptimizationCriteria .section .impl}
[§](#impl-Sync-for-OptimizationCriteria){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-sync-for-optimizationcriteria .code-header}
:::

::: {#impl-Unpin-for-OptimizationCriteria .section .impl}
[§](#impl-Unpin-for-OptimizationCriteria){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-unpin-for-optimizationcriteria .code-header}
:::

::: {#impl-UnwindSafe-for-OptimizationCriteria .section .impl}
[§](#impl-UnwindSafe-for-OptimizationCriteria){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-unwindsafe-for-optimizationcriteria .code-header}
:::
:::::::::
