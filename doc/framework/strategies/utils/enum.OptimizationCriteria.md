...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-freeze-for-optimizationcriteria .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-send-for-optimizationcriteria .code-header}
:::

::: {#impl-Sync-for-OptimizationCriteria .section .impl}
[§](#impl-Sync-for-OptimizationCriteria){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-sync-for-optimizationcriteria .code-header}
:::

::: {#impl-Unpin-for-OptimizationCriteria .section .impl}
[§](#impl-Unpin-for-OptimizationCriteria){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptimizationCriteria](enum.OptimizationCriteria.html "enum optionstratlib::strategies::utils::OptimizationCriteria"){.enum} {#impl-unpin-for-optimizationcriteria .code-header}
:::
