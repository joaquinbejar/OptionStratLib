...
# Enum [GraphBackend]{.enum}Copy item path

[[Source](../../../src/optionstratlib/visualization/utils.rs.html#50-58){.src}
]{.sub-heading}
::::
...
## [§](#backends){.doc-anchor}Backends

- **Bitmap (Native Targets):** Renders the graph to a bitmap image file.
  This is available for all targets except WebAssembly
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

:::::::::: variants
::: {#variant.Bitmap .section .variant}
[§](#variant.Bitmap){.anchor}

### Bitmap {#bitmap .code-header}
:::
...
::::::: {#variant.Bitmap.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.Bitmap.field.file_path){.anchor
.field}`file_path: &'a `[`str`](https://doc.rust-lang.org/1.86.0/std/primitive.str.html){.primitive}]{#variant.Bitmap.field.file_path
.section-header}
...
:::: sub-variant-field
[[§](#variant.Bitmap.field.size){.anchor
.field}`size: (`[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}`, `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}`)`]{#variant.Bitmap.field.size
.section-header}
...
::: {#impl-Freeze-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-Freeze-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-freeze-for-graphbackenda .code-header}
:::

::: {#impl-RefUnwindSafe-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-RefUnwindSafe-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-refunwindsafe-for-graphbackenda .code-header}
:::

::: {#impl-Send-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-Send-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-send-for-graphbackenda .code-header}
:::

::: {#impl-Sync-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-Sync-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-sync-for-graphbackenda .code-header}
:::

::: {#impl-Unpin-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-Unpin-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-unpin-for-graphbackenda .code-header}
:::

::: {#impl-UnwindSafe-for-GraphBackend%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-GraphBackend%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [GraphBackend](enum.GraphBackend.html "enum optionstratlib::visualization::utils::GraphBackend"){.enum}\<\'a\> {#impla-unwindsafe-for-graphbackenda .code-header}
:::
:::::::::
