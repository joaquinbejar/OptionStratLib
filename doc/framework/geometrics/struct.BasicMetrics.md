...
# Struct [BasicMetrics]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#231-255){.src}
]{.sub-heading}
::::
...
The `BasicMetrics` structure encapsulates the core descriptive
statistics for a dataset, providing a quick summary of its central
tendency, spread, and distribution properties. These metrics are widely
used in statistical analysis, curve analysis, and various financial or
scientific computations.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `mean` - The arithmetic average of the dataset. Represents the central
  value where the sum of all data points is divided by the total number
  of points. Useful for understanding the overall trend or expected
  value of the dataset.

- `median` - The middle value in the dataset when sorted. If the dataset
  has an even number of elements, the median is the average of the two
  middle elements. A robust measure of central tendency, particularly in
  datasets with outliers.

- `mode` - The most frequently occurring value in the dataset. If no
  value repeats, the mode might not be well-defined (or may represent
  multi-modal distributions). Useful for identifying common or dominant
  values in a dataset.

- `std_dev` - The standard deviation of the dataset, which quantifies
  the amount of variation or dispersion from the mean. A key measure of
  data spread, often used for assessing volatility or risk in financial
  contexts.

## [§](#applications){.doc-anchor}Applications

The `BasicMetrics` structure is utilized in various domains requiring
...
- **Data Science**:
  ...
  - Understand distributions, clean data, and preprocess datasets for
    machine learning models.

## [§](#integration){.doc-anchor}Integration

The `BasicMetrics` structure is often used as part of larger metric
aggregations, such as:

- [`Metrics`](struct.Metrics.html "struct optionstratlib::geometrics::Metrics"):
  Combines `BasicMetrics` with other metrics for a detailed analysis of
  curve behavior.
- [`AnalysisResult`](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"):
  Provides a high-level result of statistical and shape analysis for
  curves.

## [§](#remarks){.doc-anchor}Remarks

- The values are expressed as
  [`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal")
  to maintain precision, important in financial computations or datasets
  requiring high accuracy.
- The `BasicMetrics` structure is immutable and can be cloned/copied,
  making it efficient for use in concurrent or parallel computations.

## [§](#example-workflow){.doc-anchor}Example Workflow

Typically, `BasicMetrics` is computed from a dataset using statistical
functions and then integrated into a more comprehensive analysis
pipeline.
...
- [`ShapeMetrics`](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"):
  Captures shape-related properties like skewness and kurtosis.
- [`RiskMetrics`](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"):
  Measures risk characteristics of financial instruments.
- [`TrendMetrics`](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"):
  Represents time-based trends in data series.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.mean){.anchor
.field}`mean: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.mean
.structfield .section-header}

::: docblock
The arithmetic mean (average) of the dataset. Calculated by summing all
values and dividing by the count of values. Provides a measure of
central tendency that is affected by all values, including outliers.
:::

[[§](#structfield.median){.anchor
.field}`median: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.median
.structfield .section-header}

::: docblock
The median value of the dataset. Represents the middle value when all
data points are arranged in ascending order. For datasets with even
count, it's the average of the two middle values. Less sensitive to
outliers than the mean.
:::

[[§](#structfield.mode){.anchor
.field}`mode: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.mode
.structfield .section-header}

::: docblock
The most frequently occurring value in the dataset. If multiple values
occur with equal frequency, this typically represents the first
encountered mode or a calculated central mode. For multi-modal
distributions, this is a simplification.
:::

[[§](#structfield.std_dev){.anchor
.field}`std_dev: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.std_dev
.structfield .section-header}

::: docblock
The standard deviation of the dataset. Measures the amount of variation
or dispersion from the mean. A low standard deviation indicates values
...
::: {#impl-Clone-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-Clone-for-BasicMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-clone-for-basicmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#fn-cloneself---basicmetrics .code-header}
:::
...
::: {#impl-ComposeSchema-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-ComposeSchema-for-BasicMetrics){.anchor}

### impl ComposeSchema for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-composeschema-for-basicmetrics .code-header}
:::
...
::: {#impl-Debug-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-Debug-for-BasicMetrics){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-debug-for-basicmetrics .code-header}
:::
...
::: {#impl-Display-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-Display-for-BasicMetrics){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-display-for-basicmetrics .code-header}
:::
...
::: {#impl-Serialize-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-Serialize-for-BasicMetrics){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-serialize-for-basicmetrics .code-header}
:::
...
::: {#impl-ToSchema-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-ToSchema-for-BasicMetrics){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-toschema-for-basicmetrics .code-header}
:::
...
::: {#impl-Copy-for-BasicMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#230){.src
.rightside}[§](#impl-Copy-for-BasicMetrics){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-copy-for-basicmetrics .code-header}
:::
::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-BasicMetrics .section .impl}
[§](#impl-Freeze-for-BasicMetrics){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-freeze-for-basicmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-BasicMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-BasicMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-refunwindsafe-for-basicmetrics .code-header}
:::

::: {#impl-Send-for-BasicMetrics .section .impl}
[§](#impl-Send-for-BasicMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-send-for-basicmetrics .code-header}
:::

::: {#impl-Sync-for-BasicMetrics .section .impl}
[§](#impl-Sync-for-BasicMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-sync-for-basicmetrics .code-header}
:::

::: {#impl-Unpin-for-BasicMetrics .section .impl}
[§](#impl-Unpin-for-BasicMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-unpin-for-basicmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-BasicMetrics .section .impl}
[§](#impl-UnwindSafe-for-BasicMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-unwindsafe-for-basicmetrics .code-header}
:::
:::::::::
