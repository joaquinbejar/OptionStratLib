...
[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#228-252){.src}
]{.sub-heading}
::::
...
- The values are expressed as \[`Decimal`\] to maintain precision,
  important in financial computations or datasets requiring high
  accuracy.
...
.field}`mean: Decimal`]{#structfield.mean .structfield .section-header}
...
.field}`median: Decimal`]{#structfield.median .structfield
.section-header}
...
.field}`mode: Decimal`]{#structfield.mode .structfield .section-header}
...
.field}`std_dev: Decimal`]{#structfield.std_dev .structfield
.section-header}
...
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#227){.src
.rightside}[§](#impl-Clone-for-BasicMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-clone-for-basicmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#fn-cloneself---basicmetrics .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-debug-for-basicmetrics .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-copy-for-basicmetrics .code-header}
:::
::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-freeze-for-basicmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-BasicMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-BasicMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-refunwindsafe-for-basicmetrics .code-header}
:::

::: {#impl-Send-for-BasicMetrics .section .impl}
[§](#impl-Send-for-BasicMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-send-for-basicmetrics .code-header}
:::

::: {#impl-Sync-for-BasicMetrics .section .impl}
[§](#impl-Sync-for-BasicMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-sync-for-basicmetrics .code-header}
:::

::: {#impl-Unpin-for-BasicMetrics .section .impl}
[§](#impl-Unpin-for-BasicMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-unpin-for-basicmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-BasicMetrics .section .impl}
[§](#impl-UnwindSafe-for-BasicMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [BasicMetrics](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct} {#impl-unwindsafe-for-basicmetrics .code-header}
:::
:::::::::
