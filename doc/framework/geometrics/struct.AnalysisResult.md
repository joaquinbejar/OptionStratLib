...
[[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#50-59){.src}
]{.sub-heading}
::::
...
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#49){.src
.rightside}[§](#impl-Debug-for-AnalysisResult){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-debug-for-analysisresult .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-freeze-for-analysisresult .code-header}
:::

::: {#impl-RefUnwindSafe-for-AnalysisResult .section .impl}
[§](#impl-RefUnwindSafe-for-AnalysisResult){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-refunwindsafe-for-analysisresult .code-header}
:::

::: {#impl-Send-for-AnalysisResult .section .impl}
[§](#impl-Send-for-AnalysisResult){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-send-for-analysisresult .code-header}
:::

::: {#impl-Sync-for-AnalysisResult .section .impl}
[§](#impl-Sync-for-AnalysisResult){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-sync-for-analysisresult .code-header}
:::

::: {#impl-Unpin-for-AnalysisResult .section .impl}
[§](#impl-Unpin-for-AnalysisResult){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-unpin-for-analysisresult .code-header}
:::

::: {#impl-UnwindSafe-for-AnalysisResult .section .impl}
[§](#impl-UnwindSafe-for-AnalysisResult){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-unwindsafe-for-analysisresult .code-header}
:::
:::::::::
