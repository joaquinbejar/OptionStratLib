...
# Struct [AnalysisResult]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#53-62){.src}
]{.sub-heading}
::::
...
The `AnalysisResult` structure encapsulates both basic statistical
metrics and shape-related characteristics of a dataset or curve. It
serves as a complete analysis output that can be used to understand both
the statistical properties and the geometrical behavior of the data.

This structure is particularly useful for comprehensive data analysis in
financial modeling, statistical analysis, and geometric curve
evaluation. It combines fundamental statistical insights with
shape-based properties to provide a holistic view of the data.
...
- **statistics**:
  ...
  - Contains fundamental statistical metrics like mean, median, mode,
    and standard deviation.
  - Provides insights into the central tendency and dispersion
    characteristics of the dataset.
  - Used for understanding the overall statistical properties of the
    analyzed data.

- **shape_metrics**:
  [`ShapeMetrics`](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics")

  - Contains shape-related properties such as skewness, kurtosis, and
    critical points (peaks, valleys, and inflection points).
  - Provides insights into the geometrical behavior and distribution
    characteristics of the curve.
  - Used for understanding the asymmetry, tailedness, and notable
    features in the curve's shape.

## [§](#applications){.doc-anchor}Applications

The `AnalysisResult` structure is utilized in various domains requiring
both statistical and geometrical analysis:

- **Financial Analysis**:

  - Evaluate price distributions and identify critical price levels.
  - Detect patterns in market data through both statistical and
    shape-based observations.

- **Data Science**:

  - Provide comprehensive analysis of datasets, combining statistical
    insights with distributional shape characteristics.

- **Geometric Modeling**:

  - Analyze curve properties for more accurate modeling and
    representation.
...
[[§](#structfield.statistics){.anchor
.field}`statistics: `[`BasicMetrics`](struct.BasicMetrics.html "struct optionstratlib::geometrics::BasicMetrics"){.struct}]{#structfield.statistics
.structfield .section-header}

::: docblock
The fundamental statistical metrics of the dataset, including measures
of central tendency (mean, median, mode) and dispersion (standard
deviation).
:::

[[§](#structfield.shape_metrics){.anchor
.field}`shape_metrics: `[`ShapeMetrics`](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct}]{#structfield.shape_metrics
.structfield .section-header}

::: docblock
The shape-related metrics of the curve or dataset, including
distribution characteristics (skewness, kurtosis) and critical geometric
points (peaks, valleys, inflection points).
:::

## Trait Implementations[§](#trait-implementations){.anchor} {#trait-implementations .section-header}

::::::::::::::::::::::::::::::: {#trait-implementations-list}
::: {#impl-Clone-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-Clone-for-AnalysisResult){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-clone-for-analysisresult .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#fn-cloneself---analysisresult .code-header}
:::
...
::: {#impl-ComposeSchema-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-ComposeSchema-for-AnalysisResult){.anchor}

### impl ComposeSchema for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-composeschema-for-analysisresult .code-header}
:::
...
::: {#impl-Debug-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-Debug-for-AnalysisResult){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-debug-for-analysisresult .code-header}
:::
...
::: {#impl-Display-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-Display-for-AnalysisResult){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-display-for-analysisresult .code-header}
:::
...
::: {#impl-Serialize-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-Serialize-for-AnalysisResult){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-serialize-for-analysisresult .code-header}
:::
...
::: {#impl-ToSchema-for-AnalysisResult .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/statistics.rs.html#52){.src
.rightside}[§](#impl-ToSchema-for-AnalysisResult){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-toschema-for-analysisresult .code-header}
:::
...
::: {#impl-Freeze-for-AnalysisResult .section .impl}
[§](#impl-Freeze-for-AnalysisResult){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-freeze-for-analysisresult .code-header}
:::

::: {#impl-RefUnwindSafe-for-AnalysisResult .section .impl}
[§](#impl-RefUnwindSafe-for-AnalysisResult){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-refunwindsafe-for-analysisresult .code-header}
:::

::: {#impl-Send-for-AnalysisResult .section .impl}
[§](#impl-Send-for-AnalysisResult){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-send-for-analysisresult .code-header}
:::

::: {#impl-Sync-for-AnalysisResult .section .impl}
[§](#impl-Sync-for-AnalysisResult){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-sync-for-analysisresult .code-header}
:::

::: {#impl-Unpin-for-AnalysisResult .section .impl}
[§](#impl-Unpin-for-AnalysisResult){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-unpin-for-analysisresult .code-header}
:::

::: {#impl-UnwindSafe-for-AnalysisResult .section .impl}
[§](#impl-UnwindSafe-for-AnalysisResult){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [AnalysisResult](struct.AnalysisResult.html "struct optionstratlib::geometrics::AnalysisResult"){.struct} {#impl-unwindsafe-for-analysisresult .code-header}
:::
:::::::::
