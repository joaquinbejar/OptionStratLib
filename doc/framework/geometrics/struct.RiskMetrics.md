...
[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#444-468){.src}
]{.sub-heading}
::::
...
.field}`volatility: Decimal`]{#structfield.volatility .structfield
.section-header}
...
.field}`value_at_risk: Decimal`]{#structfield.value_at_risk .structfield
.section-header}
...
.field}`expected_shortfall: Decimal`]{#structfield.expected_shortfall
...
.field}`beta: Decimal`]{#structfield.beta .structfield .section-header}
...
.field}`sharpe_ratio: Decimal`]{#structfield.sharpe_ratio .structfield
.section-header}
...
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#443){.src
.rightside}[§](#impl-Clone-for-RiskMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-clone-for-riskmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#fn-cloneself---riskmetrics .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-debug-for-riskmetrics .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-copy-for-riskmetrics .code-header}
:::
::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-freeze-for-riskmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-RiskMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-RiskMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-refunwindsafe-for-riskmetrics .code-header}
:::

::: {#impl-Send-for-RiskMetrics .section .impl}
[§](#impl-Send-for-RiskMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-send-for-riskmetrics .code-header}
:::

::: {#impl-Sync-for-RiskMetrics .section .impl}
[§](#impl-Sync-for-RiskMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-sync-for-riskmetrics .code-header}
:::

::: {#impl-Unpin-for-RiskMetrics .section .impl}
[§](#impl-Unpin-for-RiskMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-unpin-for-riskmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-RiskMetrics .section .impl}
[§](#impl-UnwindSafe-for-RiskMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-unwindsafe-for-riskmetrics .code-header}
:::
:::::::::
