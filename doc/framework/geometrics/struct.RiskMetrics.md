...
# Struct [RiskMetrics]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#447-471){.src}
]{.sub-heading}
::::
...
that assess the risk and performance characteristics of a financial
portfolio, asset, or investment strategy. These metrics provide insights
into the variability, potential losses, and overall return of the
analyzed entity.
...
- **Risk Management**: To estimate potential losses and evaluate market
  exposures
- **Performance Analysis**: To compare against benchmarks and
  alternative strategies
- **Financial Modeling**: To perform stress testing and scenario
  analysis

## [§](#related-concepts){.doc-anchor}Related Concepts

- [`Metrics`](struct.Metrics.html "struct optionstratlib::geometrics::Metrics"):
  Aggregates risk metrics alongside other statistical measures
- **Financial Risk Indicators**: Additional measures like maximum
  drawdown, Treynor ratio, and Sortino ratio
...
[[§](#structfield.volatility){.anchor
.field}`volatility: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.volatility
.structfield .section-header}

::: docblock
Measures the degree of variation in returns over time. Represents the
standard deviation of returns and is a widely used indicator of market
risk.
:::

[[§](#structfield.value_at_risk){.anchor
.field}`value_at_risk: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.value_at_risk
.structfield .section-header}

::: docblock
Quantifies the maximum expected loss over a defined time horizon with a
given confidence level (typically 95% or 99%). Essential for
understanding tail-risk and evaluating potential losses.
:::

[[§](#structfield.expected_shortfall){.anchor
.field}`expected_shortfall: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.expected_shortfall
.structfield .section-header}

::: docblock
Represents the average loss in worst-case scenarios beyond the VaR
threshold. Provides a more comprehensive assessment of tail risk than
VaR alone.
:::

[[§](#structfield.beta){.anchor
.field}`beta: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.beta
.structfield .section-header}

::: docblock
Measures the sensitivity of an asset's returns to market returns. A beta
greater than 1 indicates higher volatility compared to the market, while
a beta less than 1 indicates lower volatility.
:::

[[§](#structfield.sharpe_ratio){.anchor
...
::: docblock
Indicates the risk-adjusted return by comparing the portfolio's excess
return (return above the risk-free rate) to its volatility. Helps
evaluate whether returns justify the associated risk profile.
:::

## Trait Implementations[§](#trait-implementations){.anchor} {#trait-implementations .section-header}

:::::::::::::::::::::::::::::::: {#trait-implementations-list}
::: {#impl-Clone-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-Clone-for-RiskMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-clone-for-riskmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#fn-cloneself---riskmetrics .code-header}
:::
...
::: {#impl-ComposeSchema-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-ComposeSchema-for-RiskMetrics){.anchor}

### impl ComposeSchema for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-composeschema-for-riskmetrics .code-header}
:::
...
::: {#impl-Debug-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-Debug-for-RiskMetrics){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-debug-for-riskmetrics .code-header}
:::
...
::: {#impl-Display-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-Display-for-RiskMetrics){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-display-for-riskmetrics .code-header}
:::
...
::: {#impl-Serialize-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-Serialize-for-RiskMetrics){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-serialize-for-riskmetrics .code-header}
:::
...
::: {#impl-ToSchema-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-ToSchema-for-RiskMetrics){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-toschema-for-riskmetrics .code-header}
:::
...
::: {#impl-Copy-for-RiskMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#446){.src
.rightside}[§](#impl-Copy-for-RiskMetrics){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-copy-for-riskmetrics .code-header}
:::
::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-RiskMetrics .section .impl}
[§](#impl-Freeze-for-RiskMetrics){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-freeze-for-riskmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-RiskMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-RiskMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-refunwindsafe-for-riskmetrics .code-header}
:::

::: {#impl-Send-for-RiskMetrics .section .impl}
[§](#impl-Send-for-RiskMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-send-for-riskmetrics .code-header}
:::

::: {#impl-Sync-for-RiskMetrics .section .impl}
[§](#impl-Sync-for-RiskMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-sync-for-riskmetrics .code-header}
:::

::: {#impl-Unpin-for-RiskMetrics .section .impl}
[§](#impl-Unpin-for-RiskMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-unpin-for-riskmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-RiskMetrics .section .impl}
[§](#impl-UnwindSafe-for-RiskMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RiskMetrics](struct.RiskMetrics.html "struct optionstratlib::geometrics::RiskMetrics"){.struct} {#impl-unwindsafe-for-riskmetrics .code-header}
:::
:::::::::
