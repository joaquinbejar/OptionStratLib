...
# Enum [ConstructionMethod]{.enum}Copy item path

[[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#68-90){.src}
]{.sub-heading}
::::
...
The generic parameters allow flexibility in the types of points and
input parameters used:

- `Point`: The type representing a coordinate in the geometric space
- `Input`: The parameter type passed to parametric functions (typically
  `Decimal` for 2D or `(Decimal, Decimal)` for 3D)
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::: variants
::: {#variant.FromData .section .variant}
[§](#variant.FromData){.anchor}

### FromData {#fromdata .code-header}
:::

::: docblock
Construct a geometric object from an explicit set of points.

This method uses a sorted collection of points to directly define the
geometry without requiring any computation.
:::

::::: {#variant.FromData.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.FromData.field.points){.anchor
.field}`points: `[`BTreeSet`](https://doc.rust-lang.org/1.86.0/alloc/collections/btree/set/struct.BTreeSet.html "struct alloc::collections::btree::set::BTreeSet"){.struct}`<Point>`]{#variant.FromData.field.points
.section-header}
...
::: {#variant.Parametric .section .variant}
[§](#variant.Parametric){.anchor}

### Parametric {#parametric .code-header}
:::

::: docblock
Construct a geometric object using a parametric function.

This method generates points by evaluating a mathematical function at
specific parameter values defined by the construction parameters.
:::

::::::: {#variant.Parametric.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.Parametric.field.f){.anchor
.field}`f: `[`Box`](https://doc.rust-lang.org/1.86.0/alloc/boxed/struct.Box.html "struct alloc::boxed::Box"){.struct}`<dyn `[`Fn`](https://doc.rust-lang.org/1.86.0/core/ops/function/trait.Fn.html "trait core::ops::function::Fn"){.trait}`(Input) -> `[`ResultPoint`](type.ResultPoint.html "type optionstratlib::geometrics::ResultPoint"){.type}`<Point> + `[`Send`](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait}` + `[`Sync`](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait}`>`]{#variant.Parametric.field.f
.section-header}

::: docblock
Function that maps from parameter space to point coordinates. Must be
thread-safe to support parallel computation.
:::
::::

:::: sub-variant-field
[[§](#variant.Parametric.field.params){.anchor
.field}`params: `[`ConstructionParams`](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum}]{#variant.Parametric.field.params
.section-header}
...
::: {#impl-Freeze-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-Freeze-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-freeze-for-constructionmethodpoint-input .code-header}
:::

::: {#impl-RefUnwindSafe-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-RefUnwindSafe-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> \![RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-refunwindsafe-for-constructionmethodpoint-input .code-header}
:::

:::: {#impl-Send-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-Send-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-send-for-constructionmethodpoint-input .code-header}
...
:::: {#impl-Sync-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-Sync-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-sync-for-constructionmethodpoint-input .code-header}
...
::: {#impl-Unpin-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-Unpin-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-unpin-for-constructionmethodpoint-input .code-header}
:::

::: {#impl-UnwindSafe-for-ConstructionMethod%3CPoint,+Input%3E .section .impl}
[§](#impl-UnwindSafe-for-ConstructionMethod%3CPoint,+Input%3E){.anchor}

### impl\<Point, Input\> \![UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-unwindsafe-for-constructionmethodpoint-input .code-header}
:::
:::::::::::
