...
[[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#69-91){.src}
]{.sub-heading}
::::
...
.field}`points: `[`BTreeSet`](https://doc.rust-lang.org/1.91.1/alloc/collections/btree/set/struct.BTreeSet.html "struct alloc::collections::btree::set::BTreeSet"){.struct}`<Point>`]{#variant.FromData.field.points
.section-header}
...
.field}`f: `[`Box`](https://doc.rust-lang.org/1.91.1/alloc/boxed/struct.Box.html "struct alloc::boxed::Box"){.struct}`<dyn `[`Fn`](https://doc.rust-lang.org/1.91.1/core/ops/function/trait.Fn.html "trait core::ops::function::Fn"){.trait}`(Input) -> `[`ResultPoint`](type.ResultPoint.html "type optionstratlib::geometrics::ResultPoint"){.type}`<Point> + `[`Send`](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait}` + `[`Sync`](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait}`>`]{#variant.Parametric.field.f
.section-header}
...
### impl\<Point, Input\> [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-send-for-constructionmethodpoint-input .code-header}
...
### impl\<Point, Input\> [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-sync-for-constructionmethodpoint-input .code-header}
...
### impl\<Point, Input\> [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ConstructionMethod](enum.ConstructionMethod.html "enum optionstratlib::geometrics::ConstructionMethod"){.enum}\<Point, Input\> {#implpoint-input-unpin-for-constructionmethodpoint-input .code-header}
:::
