...
# Struct [PlotOptions]{.struct}Copy item path

[[Source](../../src/optionstratlib/geometrics/visualization/plotters.rs.html#18-44){.src}
]{.sub-heading}
::::
...
This structure provides comprehensive customization capabilities for
plots, including titles, axis labels, colors, dimensions, and visual
styling. It serves as the central configuration object for the plotting
system.

Use with `PlotBuilder` to create customized visualizations that can be
rendered and saved to files through the `Plottable` trait
implementation.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.title){.anchor
.field}`title: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>`]{#structfield.title
...
[[§](#structfield.x_label){.anchor
.field}`x_label: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>`]{#structfield.x_label
.structfield .section-header}
...
[[§](#structfield.y_label){.anchor
.field}`y_label: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>`]{#structfield.y_label
.structfield .section-header}
...
[[§](#structfield.z_label){.anchor
.field}`z_label: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>`]{#structfield.z_label
.structfield .section-header}
...
::: docblock
Optional collection of RGB colors to use for individual data series
lines Each color in the vector corresponds to a different curve in the
plot
:::

[[§](#structfield.line_width){.anchor
.field}`line_width: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.line_width
.structfield .section-header}
...
[[§](#structfield.width){.anchor
.field}`width: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.width
.structfield .section-header}
...
[[§](#structfield.height){.anchor
.field}`height: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.height
.structfield .section-header}
...
[[§](#structfield.curve_name){.anchor
.field}`curve_name: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`String`](https://doc.rust-lang.org/1.86.0/alloc/string/struct.String.html "struct alloc::string::String"){.struct}`>>`]{#structfield.curve_name
.structfield .section-header}
...
[[§](#structfield.point_size){.anchor
.field}`point_size: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}`>`]{#structfield.point_size
.structfield .section-header}
...
[[§](#structfield.labels_size){.anchor
.field}`labels_size: `[`Option`](https://doc.rust-lang.org/1.86.0/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`f64`](https://doc.rust-lang.org/1.86.0/std/primitive.f64.html){.primitive}`>`]{#structfield.labels_size
.structfield .section-header}
...
::: {#impl-Clone-for-PlotOptions .section .impl}
[Source](../../src/optionstratlib/geometrics/visualization/plotters.rs.html#17){.src
.rightside}[§](#impl-Clone-for-PlotOptions){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-clone-for-plotoptions .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#fn-cloneself---plotoptions .code-header}
:::
...
::: {#impl-Debug-for-PlotOptions .section .impl}
[Source](../../src/optionstratlib/geometrics/visualization/plotters.rs.html#17){.src
.rightside}[§](#impl-Debug-for-PlotOptions){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-debug-for-plotoptions .code-header}
:::
...
::: {#impl-Default-for-PlotOptions .section .impl}
[Source](../../src/optionstratlib/geometrics/visualization/plotters.rs.html#60-77){.src
.rightside}[§](#impl-Default-for-PlotOptions){.anchor}

### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-default-for-plotoptions .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/geometrics/visualization/plotters.rs.html#61-76){.src
...
::: {#impl-Freeze-for-PlotOptions .section .impl}
[§](#impl-Freeze-for-PlotOptions){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-freeze-for-plotoptions .code-header}
:::

::: {#impl-RefUnwindSafe-for-PlotOptions .section .impl}
[§](#impl-RefUnwindSafe-for-PlotOptions){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-refunwindsafe-for-plotoptions .code-header}
:::

::: {#impl-Send-for-PlotOptions .section .impl}
[§](#impl-Send-for-PlotOptions){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-send-for-plotoptions .code-header}
:::

::: {#impl-Sync-for-PlotOptions .section .impl}
[§](#impl-Sync-for-PlotOptions){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-sync-for-plotoptions .code-header}
:::

::: {#impl-Unpin-for-PlotOptions .section .impl}
[§](#impl-Unpin-for-PlotOptions){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-unpin-for-plotoptions .code-header}
:::

::: {#impl-UnwindSafe-for-PlotOptions .section .impl}
[§](#impl-UnwindSafe-for-PlotOptions){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PlotOptions](struct.PlotOptions.html "struct optionstratlib::geometrics::PlotOptions"){.struct} {#impl-unwindsafe-for-plotoptions .code-header}
:::
:::::::::
