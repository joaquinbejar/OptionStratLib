...
[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#398-416){.src}
]{.sub-heading}
::::
...
.field}`slope: Decimal`]{#structfield.slope .structfield
.section-header}
...
.field}`intercept: Decimal`]{#structfield.intercept .structfield
.section-header}
...
.field}`r_squared: Decimal`]{#structfield.r_squared .structfield
.section-header}
...
.field}`moving_average: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.moving_average
...
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#397){.src
.rightside}[§](#impl-Clone-for-TrendMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-clone-for-trendmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#fn-cloneself---trendmetrics .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-debug-for-trendmetrics .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-freeze-for-trendmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-TrendMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-TrendMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-refunwindsafe-for-trendmetrics .code-header}
:::

::: {#impl-Send-for-TrendMetrics .section .impl}
[§](#impl-Send-for-TrendMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-send-for-trendmetrics .code-header}
:::

::: {#impl-Sync-for-TrendMetrics .section .impl}
[§](#impl-Sync-for-TrendMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-sync-for-trendmetrics .code-header}
:::

::: {#impl-Unpin-for-TrendMetrics .section .impl}
[§](#impl-Unpin-for-TrendMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-unpin-for-trendmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-TrendMetrics .section .impl}
[§](#impl-UnwindSafe-for-TrendMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-unwindsafe-for-trendmetrics .code-header}
:::
:::::::::
