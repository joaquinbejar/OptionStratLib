...
# Struct [TrendMetrics]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#401-419){.src}
]{.sub-heading}
::::
...
This structure stores comprehensive metrics that describe the linear
relationship and trend behavior in a dataset. It provides statistical
values derived from linear regression analysis along with smoothed data
points for visualization and further analysis.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- **slope**: The rate of change in the dependent variable (y-axis) with
  respect to the independent variable (x-axis), calculated from linear
  regression.
- **intercept**: The y-coordinate where the regression line intersects
  the y-axis, representing the value when x = 0.
- **r_squared**: The coefficient of determination that measures how well
  the data fits the regression model, with values closer to 1 indicating
  a better fit.
- **moving_average**: A series of smoothed data points derived from the
  original dataset to reduce noise and highlight the underlying trend
  pattern.
...
- Quantifying the strength and direction of relationships between
  variables
...
alongside other metric types to provide comprehensive statistical
analysis.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.slope){.anchor
.field}`slope: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.slope
.structfield .section-header}

::: docblock
The slope coefficient of the linear regression line, indicating the rate
and direction of change in the dataset.
:::

[[§](#structfield.intercept){.anchor
.field}`intercept: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.intercept
.structfield .section-header}

::: docblock
The y-intercept of the regression line, showing the baseline value when
the independent variable equals zero.
:::

[[§](#structfield.r_squared){.anchor
.field}`r_squared: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.r_squared
.structfield .section-header}
...
[[§](#structfield.moving_average){.anchor
.field}`moving_average: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.moving_average
.structfield .section-header}
...
::: {#impl-Clone-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-Clone-for-TrendMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-clone-for-trendmetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#fn-cloneself---trendmetrics .code-header}
:::
...
::: {#impl-ComposeSchema-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-ComposeSchema-for-TrendMetrics){.anchor}

### impl ComposeSchema for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-composeschema-for-trendmetrics .code-header}
:::
...
::: {#impl-Debug-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-Debug-for-TrendMetrics){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-debug-for-trendmetrics .code-header}
:::
...
::: {#impl-Display-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-Display-for-TrendMetrics){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-display-for-trendmetrics .code-header}
:::
...
::: {#impl-Serialize-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-Serialize-for-TrendMetrics){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-serialize-for-trendmetrics .code-header}
:::
...
::: {#impl-ToSchema-for-TrendMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#400){.src
.rightside}[§](#impl-ToSchema-for-TrendMetrics){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-toschema-for-trendmetrics .code-header}
:::
...
::: {#impl-Freeze-for-TrendMetrics .section .impl}
[§](#impl-Freeze-for-TrendMetrics){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-freeze-for-trendmetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-TrendMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-TrendMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-refunwindsafe-for-trendmetrics .code-header}
:::

::: {#impl-Send-for-TrendMetrics .section .impl}
[§](#impl-Send-for-TrendMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-send-for-trendmetrics .code-header}
:::

::: {#impl-Sync-for-TrendMetrics .section .impl}
[§](#impl-Sync-for-TrendMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-sync-for-trendmetrics .code-header}
:::

::: {#impl-Unpin-for-TrendMetrics .section .impl}
[§](#impl-Unpin-for-TrendMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-unpin-for-trendmetrics .code-header}
:::

::: {#impl-UnwindSafe-for-TrendMetrics .section .impl}
[§](#impl-UnwindSafe-for-TrendMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TrendMetrics](struct.TrendMetrics.html "struct optionstratlib::geometrics::TrendMetrics"){.struct} {#impl-unwindsafe-for-trendmetrics .code-header}
:::
:::::::::
