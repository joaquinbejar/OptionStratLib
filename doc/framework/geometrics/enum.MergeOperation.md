...
[[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#20-33){.src}
]{.sub-heading}
::::
...
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#19){.src
.rightside}[§](#impl-Clone-for-MergeOperation){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-clone-for-mergeoperation .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#fn-cloneself---mergeoperation .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-debug-for-mergeoperation .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-partialeq-for-mergeoperation .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-mergeoperation---bool .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-copy-for-mergeoperation .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-structuralpartialeq-for-mergeoperation .code-header}
:::
:::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-freeze-for-mergeoperation .code-header}
:::

::: {#impl-RefUnwindSafe-for-MergeOperation .section .impl}
[§](#impl-RefUnwindSafe-for-MergeOperation){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-refunwindsafe-for-mergeoperation .code-header}
:::

::: {#impl-Send-for-MergeOperation .section .impl}
[§](#impl-Send-for-MergeOperation){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-send-for-mergeoperation .code-header}
:::

::: {#impl-Sync-for-MergeOperation .section .impl}
[§](#impl-Sync-for-MergeOperation){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-sync-for-mergeoperation .code-header}
:::

::: {#impl-Unpin-for-MergeOperation .section .impl}
[§](#impl-Unpin-for-MergeOperation){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-unpin-for-mergeoperation .code-header}
:::

::: {#impl-UnwindSafe-for-MergeOperation .section .impl}
[§](#impl-UnwindSafe-for-MergeOperation){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-unwindsafe-for-mergeoperation .code-header}
:::
:::::::::
