...
# Enum [MergeOperation]{.enum} Copy item path

[[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#22-35){.src}
]{.sub-heading}
::::
...
This enum defines the possible operations when merging or combining
multiple data sets, such as curves or points. It is commonly used with
the `Arithmetic` trait to specify how values should be combined during
geometric operations.

## [§](#operations){.doc-anchor}Operations
...
- `Divide` - Performs division of values (a / b), with appropriate error
...
The operation specified will determine how values are combined when
merging geometric objects that implement the `Arithmetic` trait.
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::: variants
::: {#variant.Add .section .variant}
[§](#variant.Add){.anchor}
...
::: {#variant.Subtract .section .variant}
[§](#variant.Subtract){.anchor}

### Subtract {#subtract .code-header}
:::
...
::: {#variant.Multiply .section .variant}
[§](#variant.Multiply){.anchor}

### Multiply {#multiply .code-header}
:::
...
::: {#variant.Divide .section .variant}
[§](#variant.Divide){.anchor}

### Divide {#divide .code-header}
:::
...
::: {#impl-Clone-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-Clone-for-MergeOperation){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-clone-for-mergeoperation .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#fn-cloneself---mergeoperation .code-header}
:::
...
::: {#impl-ComposeSchema-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-ComposeSchema-for-MergeOperation){.anchor}

### impl ComposeSchema for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-composeschema-for-mergeoperation .code-header}
:::
...
::: {#impl-Debug-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-Debug-for-MergeOperation){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-debug-for-mergeoperation .code-header}
:::
...
::: {#impl-PartialEq-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-PartialEq-for-MergeOperation){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-partialeq-for-mergeoperation .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-mergeoperation---bool .code-header}
:::
...
::: {#impl-ToSchema-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-ToSchema-for-MergeOperation){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-toschema-for-mergeoperation .code-header}
:::
...
::: {#impl-Copy-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-Copy-for-MergeOperation){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-copy-for-mergeoperation .code-header}
:::

::: {#impl-StructuralPartialEq-for-MergeOperation .section .impl}
[Source](../../src/optionstratlib/geometrics/operations/arithmetic.rs.html#21){.src
.rightside}[§](#impl-StructuralPartialEq-for-MergeOperation){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-structuralpartialeq-for-mergeoperation .code-header}
:::
::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-MergeOperation .section .impl}
[§](#impl-Freeze-for-MergeOperation){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-freeze-for-mergeoperation .code-header}
:::

::: {#impl-RefUnwindSafe-for-MergeOperation .section .impl}
[§](#impl-RefUnwindSafe-for-MergeOperation){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-refunwindsafe-for-mergeoperation .code-header}
:::

::: {#impl-Send-for-MergeOperation .section .impl}
[§](#impl-Send-for-MergeOperation){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-send-for-mergeoperation .code-header}
:::

::: {#impl-Sync-for-MergeOperation .section .impl}
[§](#impl-Sync-for-MergeOperation){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-sync-for-mergeoperation .code-header}
:::

::: {#impl-Unpin-for-MergeOperation .section .impl}
[§](#impl-Unpin-for-MergeOperation){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-unpin-for-mergeoperation .code-header}
:::

::: {#impl-UnwindSafe-for-MergeOperation .section .impl}
[§](#impl-UnwindSafe-for-MergeOperation){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [MergeOperation](enum.MergeOperation.html "enum optionstratlib::geometrics::MergeOperation"){.enum} {#impl-unwindsafe-for-mergeoperation .code-header}
:::
:::::::::
