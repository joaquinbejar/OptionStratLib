...
# Enum [ConstructionParams]{.enum} Copy item path

[[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#25-58){.src}
]{.sub-heading}
::::
...
This enum provides configuration options for different dimensional
spaces when generating geometric objects through parametric equations or
sampling. It supports both 2D curves (with a single parameter t) and 3D
surfaces (with two parameters x and y).
:::

## Variants[§](#variants){.anchor} {#variants .variants .section-header}

::::::::::::::::::::::::::: variants
::: {#variant.D2 .section .variant}
[§](#variant.D2){.anchor}
...
::::::::: {#variant.D2.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.D2.field.t_start){.anchor
.field}`t_start: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D2.field.t_start
.section-header}
...
:::: sub-variant-field
[[§](#variant.D2.field.t_end){.anchor
.field}`t_end: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D2.field.t_end
.section-header}
...
:::: sub-variant-field
[[§](#variant.D2.field.steps){.anchor
.field}`steps: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.D2.field.steps
.section-header}
...
::::::::::::::: {#variant.D3.fields .sub-variant}
#### Fields

:::: sub-variant-field
[[§](#variant.D3.field.x_start){.anchor
.field}`x_start: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D3.field.x_start
.section-header}
...
:::: sub-variant-field
[[§](#variant.D3.field.x_end){.anchor
.field}`x_end: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D3.field.x_end
.section-header}
...
:::: sub-variant-field
[[§](#variant.D3.field.y_start){.anchor
.field}`y_start: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D3.field.y_start
.section-header}
...
:::: sub-variant-field
[[§](#variant.D3.field.y_end){.anchor
.field}`y_end: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#variant.D3.field.y_end
.section-header}
...
:::: sub-variant-field
[[§](#variant.D3.field.x_steps){.anchor
.field}`x_steps: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.D3.field.x_steps
.section-header}
...
:::: sub-variant-field
[[§](#variant.D3.field.y_steps){.anchor
.field}`y_steps: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#variant.D3.field.y_steps
.section-header}
...
::: {#impl-Clone-for-ConstructionParams .section .impl}
[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#24){.src
.rightside}[§](#impl-Clone-for-ConstructionParams){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-clone-for-constructionparams .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#fn-cloneself---constructionparams .code-header}
:::
...
::: {#impl-ComposeSchema-for-ConstructionParams .section .impl}
[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#24){.src
.rightside}[§](#impl-ComposeSchema-for-ConstructionParams){.anchor}

### impl ComposeSchema for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-composeschema-for-constructionparams .code-header}
:::
...
::: {#impl-Debug-for-ConstructionParams .section .impl}
[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#24){.src
.rightside}[§](#impl-Debug-for-ConstructionParams){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-debug-for-constructionparams .code-header}
:::
...
::: {#impl-ToSchema-for-ConstructionParams .section .impl}
[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#24){.src
.rightside}[§](#impl-ToSchema-for-ConstructionParams){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-toschema-for-constructionparams .code-header}
:::
...
::: {#impl-Freeze-for-ConstructionParams .section .impl}
[§](#impl-Freeze-for-ConstructionParams){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-freeze-for-constructionparams .code-header}
:::

::: {#impl-RefUnwindSafe-for-ConstructionParams .section .impl}
[§](#impl-RefUnwindSafe-for-ConstructionParams){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-refunwindsafe-for-constructionparams .code-header}
:::

::: {#impl-Send-for-ConstructionParams .section .impl}
[§](#impl-Send-for-ConstructionParams){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-send-for-constructionparams .code-header}
:::

::: {#impl-Sync-for-ConstructionParams .section .impl}
[§](#impl-Sync-for-ConstructionParams){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-sync-for-constructionparams .code-header}
:::

::: {#impl-Unpin-for-ConstructionParams .section .impl}
[§](#impl-Unpin-for-ConstructionParams){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-unpin-for-constructionparams .code-header}
:::

::: {#impl-UnwindSafe-for-ConstructionParams .section .impl}
[§](#impl-UnwindSafe-for-ConstructionParams){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-unwindsafe-for-constructionparams .code-header}
:::
:::::::::
