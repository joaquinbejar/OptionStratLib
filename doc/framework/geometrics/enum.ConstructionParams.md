...
[[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#24-57){.src}
]{.sub-heading}
::::
...
.field}`t_start: Decimal`]{#variant.D2.field.t_start .section-header}
...
.field}`t_end: Decimal`]{#variant.D2.field.t_end .section-header}
...
.field}`steps: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.D2.field.steps
.section-header}
...
.field}`x_start: Decimal`]{#variant.D3.field.x_start .section-header}
...
.field}`x_end: Decimal`]{#variant.D3.field.x_end .section-header}
...
.field}`y_start: Decimal`]{#variant.D3.field.y_start .section-header}
...
.field}`y_end: Decimal`]{#variant.D3.field.y_end .section-header}
...
.field}`x_steps: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.D3.field.x_steps
.section-header}
...
.field}`y_steps: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#variant.D3.field.y_steps
.section-header}
...
[Source](../../src/optionstratlib/geometrics/construction/types.rs.html#23){.src
.rightside}[§](#impl-Clone-for-ConstructionParams){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-clone-for-constructionparams .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#fn-cloneself---constructionparams .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-debug-for-constructionparams .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-freeze-for-constructionparams .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-send-for-constructionparams .code-header}
:::

::: {#impl-Sync-for-ConstructionParams .section .impl}
[§](#impl-Sync-for-ConstructionParams){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-sync-for-constructionparams .code-header}
:::

::: {#impl-Unpin-for-ConstructionParams .section .impl}
[§](#impl-Unpin-for-ConstructionParams){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-unpin-for-constructionparams .code-header}
:::

::: {#impl-UnwindSafe-for-ConstructionParams .section .impl}
[§](#impl-UnwindSafe-for-ConstructionParams){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ConstructionParams](enum.ConstructionParams.html "enum optionstratlib::geometrics::ConstructionParams"){.enum} {#impl-unwindsafe-for-constructionparams .code-header}
:::
:::::::::
