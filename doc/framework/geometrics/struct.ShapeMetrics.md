...
[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#290-317){.src}
]{.sub-heading}
::::
...
.field}`skewness: Decimal`]{#structfield.skewness .structfield
.section-header}
...
.field}`kurtosis: Decimal`]{#structfield.kurtosis .structfield
.section-header}
...
.field}`peaks: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.peaks
...
.field}`valleys: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.valleys
.structfield .section-header}
...
.field}`inflection_points: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.inflection_points
.structfield .section-header}
...
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#289){.src
.rightside}[§](#impl-Clone-for-ShapeMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-clone-for-shapemetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#fn-cloneself---shapemetrics .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-debug-for-shapemetrics .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-freeze-for-shapemetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-ShapeMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-ShapeMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-refunwindsafe-for-shapemetrics .code-header}
:::

::: {#impl-Send-for-ShapeMetrics .section .impl}
[§](#impl-Send-for-ShapeMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-send-for-shapemetrics .code-header}
:::

::: {#impl-Sync-for-ShapeMetrics .section .impl}
[§](#impl-Sync-for-ShapeMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-sync-for-shapemetrics .code-header}
:::

::: {#impl-Unpin-for-ShapeMetrics .section .impl}
[§](#impl-Unpin-for-ShapeMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-unpin-for-shapemetrics .code-header}
:::

::: {#impl-UnwindSafe-for-ShapeMetrics .section .impl}
[§](#impl-UnwindSafe-for-ShapeMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-unwindsafe-for-shapemetrics .code-header}
:::
:::::::::
