...
# Struct [ShapeMetrics]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#293-320){.src}
]{.sub-heading}
::::
...
The `ShapeMetrics` structure encapsulates shape-related properties and
critical points describing a curve's geometrical behavior. It's
primarily used for mathematical and statistical analysis of curves
representing data distributions or mathematical functions.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `skewness` - A measure of distribution asymmetry. Positive values
  indicate right tailing while negative values indicate left tailing.

- `kurtosis` - A measure of the "tailedness" or presence of outliers in
  the distribution. Higher values indicate heavier tails and more
  outliers compared to a normal distribution.

- `peaks` - Collection of points representing local or global maxima
  along the curve, stored as `Point2D` coordinates.

- `valleys` - Collection of points representing local or global minima
  along the curve, stored as `Point2D` coordinates.

- `inflection_points` - Points where the curve changes concavity
  (transitioning from concave up to concave down or vice versa), stored
  as `Point2D` coordinates.
...
- Statistical distribution analysis to characterize data shape
  properties
...
## [§](#relationship-with-other-structures){.doc-anchor}Relationship with Other Structures

`ShapeMetrics` is typically part of the larger `AnalysisResult`
structure that provides comprehensive curve analysis. It uses `Point2D`
to represent all positional data with high-precision `Decimal` values.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.skewness){.anchor
.field}`skewness: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.skewness
.structfield .section-header}

::: docblock
Describes the asymmetry of the curve's distribution. A positive value
indicates a right tail (right-skewed distribution), while a negative
value indicates a left tail (left-skewed distribution). A value close to
zero suggests symmetry.
:::

[[§](#structfield.kurtosis){.anchor
.field}`kurtosis: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.kurtosis
.structfield .section-header}

::: docblock
Indicates the "tailedness" or presence of outliers in the curve's
distribution. Higher values correspond to heavier tails and more
outliers compared to a normal distribution. Standard normal distribution
has kurtosis of 3.0. Often expressed as excess kurtosis (kurtosis - 3).
:::

[[§](#structfield.peaks){.anchor
.field}`peaks: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.peaks
.structfield .section-header}

::: docblock
Collection of `Point2D` instances representing local or global maxima
(peaks) along the curve. These points have higher y-values than their
immediate neighboring points.
:::

[[§](#structfield.valleys){.anchor
.field}`valleys: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.valleys
.structfield .section-header}

::: docblock
Collection of `Point2D` instances representing local or global minima
(valleys) along the curve. These points have lower y-values than their
immediate neighboring points.
:::

[[§](#structfield.inflection_points){.anchor
.field}`inflection_points: `[`Vec`](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}`>`]{#structfield.inflection_points
.structfield .section-header}

::: docblock
Points where the curve changes concavity, transitioning from concave up
to concave down (or vice versa). At these points, the second derivative
equals zero while changing sign.
:::

## Trait Implementations[§](#trait-implementations){.anchor} {#trait-implementations .section-header}

::::::::::::::::::::::::::::::: {#trait-implementations-list}
::: {#impl-Clone-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-Clone-for-ShapeMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-clone-for-shapemetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#fn-cloneself---shapemetrics .code-header}
:::
...
::: {#impl-ComposeSchema-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-ComposeSchema-for-ShapeMetrics){.anchor}

### impl ComposeSchema for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-composeschema-for-shapemetrics .code-header}
:::
...
::: {#impl-Debug-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-Debug-for-ShapeMetrics){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-debug-for-shapemetrics .code-header}
:::
...
::: {#impl-Display-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-Display-for-ShapeMetrics){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-display-for-shapemetrics .code-header}
:::
...
::: {#impl-Serialize-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-Serialize-for-ShapeMetrics){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-serialize-for-shapemetrics .code-header}
:::
...
::: {#impl-ToSchema-for-ShapeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#292){.src
.rightside}[§](#impl-ToSchema-for-ShapeMetrics){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-toschema-for-shapemetrics .code-header}
:::
...
::: {#impl-Freeze-for-ShapeMetrics .section .impl}
[§](#impl-Freeze-for-ShapeMetrics){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-freeze-for-shapemetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-ShapeMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-ShapeMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-refunwindsafe-for-shapemetrics .code-header}
:::

::: {#impl-Send-for-ShapeMetrics .section .impl}
[§](#impl-Send-for-ShapeMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-send-for-shapemetrics .code-header}
:::

::: {#impl-Sync-for-ShapeMetrics .section .impl}
[§](#impl-Sync-for-ShapeMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-sync-for-shapemetrics .code-header}
:::

::: {#impl-Unpin-for-ShapeMetrics .section .impl}
[§](#impl-Unpin-for-ShapeMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-unpin-for-shapemetrics .code-header}
:::

::: {#impl-UnwindSafe-for-ShapeMetrics .section .impl}
[§](#impl-UnwindSafe-for-ShapeMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [ShapeMetrics](struct.ShapeMetrics.html "struct optionstratlib::geometrics::ShapeMetrics"){.struct} {#impl-unwindsafe-for-shapemetrics .code-header}
:::
:::::::::
