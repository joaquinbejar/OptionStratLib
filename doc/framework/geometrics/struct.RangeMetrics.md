...
[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#350-368){.src}
]{.sub-heading}
::::
...
.field}`range: Decimal`]{#structfield.range .structfield
.section-header}
...
.field}`quartiles: (Decimal, Decimal, Decimal)`]{#structfield.quartiles
.structfield .section-header}
...
.field}`interquartile_range: Decimal`]{#structfield.interquartile_range
.structfield .section-header}
...
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#349){.src
.rightside}[§](#impl-Clone-for-RangeMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-clone-for-rangemetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#fn-cloneself---rangemetrics .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-debug-for-rangemetrics .code-header}
:::
...
### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-copy-for-rangemetrics .code-header}
:::
::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-freeze-for-rangemetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-RangeMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-RangeMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-refunwindsafe-for-rangemetrics .code-header}
:::

::: {#impl-Send-for-RangeMetrics .section .impl}
[§](#impl-Send-for-RangeMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-send-for-rangemetrics .code-header}
:::

::: {#impl-Sync-for-RangeMetrics .section .impl}
[§](#impl-Sync-for-RangeMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-sync-for-rangemetrics .code-header}
:::

::: {#impl-Unpin-for-RangeMetrics .section .impl}
[§](#impl-Unpin-for-RangeMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-unpin-for-rangemetrics .code-header}
:::

::: {#impl-UnwindSafe-for-RangeMetrics .section .impl}
[§](#impl-UnwindSafe-for-RangeMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-unwindsafe-for-rangemetrics .code-header}
:::
:::::::::
