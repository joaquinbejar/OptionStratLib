...
# Struct [RangeMetrics]{.struct} Copy item path

[[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#353-371){.src}
]{.sub-heading}
::::
...
`RangeMetrics` provides key statistical measures related to data ranges
and distributions. This structure is particularly useful when analyzing
numerical datasets from financial curves, scientific measurements, or
computational geometry applications.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `min` - The minimum point in the dataset, containing both x and y
  coordinates as the smallest values. This defines the lower boundary of
  the data range.

- `max` - The maximum point in the dataset, containing both x and y
  coordinates as the largest values. This defines the upper boundary of
  the data range.

- `range` - The numerical difference between the maximum and minimum
  values. Provides a simple measure of data dispersion or spread.

- `quartiles` - A tuple containing first quartile (Q1), median (Q2), and
  third quartile (Q3). These values divide the dataset into four equal
  parts, providing insight into data distribution.

- `interquartile_range` - The difference between the third and first
  quartiles (Q3 - Q1). A robust statistical measure of dispersion that
  is less sensitive to outliers than the full range.

## [§](#usage){.doc-anchor}Usage

`RangeMetrics` is typically calculated as part of a larger statistical
analysis workflow. It provides essential information for box plots,
outlier detection, and distribution analysis.

This structure is part of the curves analysis module that provides
comprehensive statistical and financial analysis tools for mathematical
curves.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.min){.anchor
.field}`min: `[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}]{#structfield.min
.structfield .section-header}

::: docblock
The minimum point in the dataset, containing the smallest x and y
coordinates observed.
:::

[[§](#structfield.max){.anchor
.field}`max: `[`Point2D`](../curves/struct.Point2D.html "struct optionstratlib::curves::Point2D"){.struct}]{#structfield.max
.structfield .section-header}

::: docblock
The maximum point in the dataset, containing the largest x and y
coordinates observed.
:::

[[§](#structfield.range){.anchor
.field}`range: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.range
.structfield .section-header}
...
[[§](#structfield.quartiles){.anchor
.field}`quartiles: (`[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`, `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`, `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`)`]{#structfield.quartiles
.structfield .section-header}

::: docblock
A tuple of three values representing the first quartile (Q1), median
(Q2), and third quartile (Q3) of the dataset.
:::

[[§](#structfield.interquartile_range){.anchor
.field}`interquartile_range: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.interquartile_range
.structfield .section-header}
...
::: {#impl-Clone-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-Clone-for-RangeMetrics){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-clone-for-rangemetrics .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#fn-cloneself---rangemetrics .code-header}
:::
...
::: {#impl-ComposeSchema-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-ComposeSchema-for-RangeMetrics){.anchor}

### impl ComposeSchema for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-composeschema-for-rangemetrics .code-header}
:::
...
::: {#impl-Debug-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-Debug-for-RangeMetrics){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-debug-for-rangemetrics .code-header}
:::
...
::: {#impl-Display-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-Display-for-RangeMetrics){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-display-for-rangemetrics .code-header}
:::
...
::: {#impl-Serialize-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-Serialize-for-RangeMetrics){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-serialize-for-rangemetrics .code-header}
:::
...
::: {#impl-ToSchema-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-ToSchema-for-RangeMetrics){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-toschema-for-rangemetrics .code-header}
:::
...
::: {#impl-Copy-for-RangeMetrics .section .impl}
[Source](../../src/optionstratlib/geometrics/analysis/metrics.rs.html#352){.src
.rightside}[§](#impl-Copy-for-RangeMetrics){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.91.1/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-copy-for-rangemetrics .code-header}
:::
::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-RangeMetrics .section .impl}
[§](#impl-Freeze-for-RangeMetrics){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-freeze-for-rangemetrics .code-header}
:::

::: {#impl-RefUnwindSafe-for-RangeMetrics .section .impl}
[§](#impl-RefUnwindSafe-for-RangeMetrics){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-refunwindsafe-for-rangemetrics .code-header}
:::

::: {#impl-Send-for-RangeMetrics .section .impl}
[§](#impl-Send-for-RangeMetrics){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-send-for-rangemetrics .code-header}
:::

::: {#impl-Sync-for-RangeMetrics .section .impl}
[§](#impl-Sync-for-RangeMetrics){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-sync-for-rangemetrics .code-header}
:::

::: {#impl-Unpin-for-RangeMetrics .section .impl}
[§](#impl-Unpin-for-RangeMetrics){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-unpin-for-rangemetrics .code-header}
:::

::: {#impl-UnwindSafe-for-RangeMetrics .section .impl}
[§](#impl-UnwindSafe-for-RangeMetrics){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RangeMetrics](struct.RangeMetrics.html "struct optionstratlib::geometrics::RangeMetrics"){.struct} {#impl-unwindsafe-for-rangemetrics .code-header}
:::
:::::::::
