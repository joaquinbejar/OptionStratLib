...
# Struct [FourOptions]{.struct}Copy item path

[[Source](../../src/optionstratlib/chains/four.rs.html#39-51){.src}
]{.sub-heading}
::::
...
::: docblock
Represents a combination of four option positions that form a complete
option strategy.

This struct encapsulates a set of four option contracts that together
can create various option strategies such as iron condors, iron
butterflies, straddles, strangles, or custom four-legged option
combinations.

Each component is stored as an `Arc<Options>` to allow efficient sharing
of option contract data across different parts of the application
without unnecessary cloning.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `long_call` - A call option that is purchased (long position), giving
  the right to buy the underlying asset at the strike price.

- `short_call` - A call option that is sold (short position), creating
  an obligation to sell the underlying asset at the strike price if the
  buyer exercises.

- `long_put` - A put option that is purchased (long position), giving
  the right to sell the underlying asset at the strike price.

- `short_put` - A put option that is sold (short position), creating an
  obligation to buy the underlying asset at the strike price if the
  buyer exercises.

## [§](#usage){.doc-anchor}Usage

This structure is typically used in option strategy analysis, risk
management, and portfolio modeling where multiple option positions are
evaluated together to assess combined payoff profiles and risk
characteristics.
:::
...
.field}`long_call: `[`Arc`](https://doc.rust-lang.org/1.86.0/alloc/sync/struct.Arc.html "struct alloc::sync::Arc"){.struct}`<`[`Options`](../model/option/struct.Options.html "struct optionstratlib::model::option::Options"){.struct}`>`]{#structfield.long_call
.structfield .section-header}

::: docblock
A purchased call option contract, giving the right to buy the underlying
asset
:::

[[§](#structfield.short_call){.anchor
.field}`short_call: `[`Arc`](https://doc.rust-lang.org/1.86.0/alloc/sync/struct.Arc.html "struct alloc::sync::Arc"){.struct}`<`[`Options`](../model/option/struct.Options.html "struct optionstratlib::model::option::Options"){.struct}`>`]{#structfield.short_call
.structfield .section-header}

::: docblock
A sold call option contract, creating the obligation to sell the
underlying if exercised
:::

[[§](#structfield.long_put){.anchor
.field}`long_put: `[`Arc`](https://doc.rust-lang.org/1.86.0/alloc/sync/struct.Arc.html "struct alloc::sync::Arc"){.struct}`<`[`Options`](../model/option/struct.Options.html "struct optionstratlib::model::option::Options"){.struct}`>`]{#structfield.long_put
.structfield .section-header}

::: docblock
A purchased put option contract, giving the right to sell the underlying
asset
:::

[[§](#structfield.short_put){.anchor
.field}`short_put: `[`Arc`](https://doc.rust-lang.org/1.86.0/alloc/sync/struct.Arc.html "struct alloc::sync::Arc"){.struct}`<`[`Options`](../model/option/struct.Options.html "struct optionstratlib::model::option::Options"){.struct}`>`]{#structfield.short_put
.structfield .section-header}

::: docblock
A sold put option contract, creating the obligation to buy the
underlying if exercised
:::
...
::: {#impl-Clone-for-FourOptions .section .impl}
[Source](../../src/optionstratlib/chains/four.rs.html#38){.src
.rightside}[§](#impl-Clone-for-FourOptions){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-clone-for-fouroptions .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#fn-cloneself---fouroptions .code-header}
:::
...
::: {#impl-Debug-for-FourOptions .section .impl}
[Source](../../src/optionstratlib/chains/four.rs.html#38){.src
.rightside}[§](#impl-Debug-for-FourOptions){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-debug-for-fouroptions .code-header}
:::
...
::: {#impl-PartialEq-for-FourOptions .section .impl}
[Source](../../src/optionstratlib/chains/four.rs.html#53-60){.src
.rightside}[§](#impl-PartialEq-for-FourOptions){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-partialeq-for-fouroptions .code-header}
:::

::::::: impl-items
::: {#method.eq .section .method .trait-impl}
[Source](../../src/optionstratlib/chains/four.rs.html#54-59){.src
...
::: {#impl-Freeze-for-FourOptions .section .impl}
[§](#impl-Freeze-for-FourOptions){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-freeze-for-fouroptions .code-header}
:::

::: {#impl-RefUnwindSafe-for-FourOptions .section .impl}
[§](#impl-RefUnwindSafe-for-FourOptions){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-refunwindsafe-for-fouroptions .code-header}
:::

::: {#impl-Send-for-FourOptions .section .impl}
[§](#impl-Send-for-FourOptions){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-send-for-fouroptions .code-header}
:::

::: {#impl-Sync-for-FourOptions .section .impl}
[§](#impl-Sync-for-FourOptions){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-sync-for-fouroptions .code-header}
:::

::: {#impl-Unpin-for-FourOptions .section .impl}
[§](#impl-Unpin-for-FourOptions){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-unpin-for-fouroptions .code-header}
:::

::: {#impl-UnwindSafe-for-FourOptions .section .impl}
[§](#impl-UnwindSafe-for-FourOptions){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [FourOptions](struct.FourOptions.html "struct optionstratlib::chains::FourOptions"){.struct} {#impl-unwindsafe-for-fouroptions .code-header}
:::
:::::::::
