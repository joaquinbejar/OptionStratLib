...
# Struct [DeltasInStrike]{.struct} Copy item path

[[Source](../../src/optionstratlib/chains/options.rs.html#142-154){.src}
]{.sub-heading}
::::
...
::: docblock
Represents option delta values for all four basic option positions at a
specific strike price.

This structure contains delta values for the four fundamental option
positions: long call, short call, long put, and short put. Delta
measures the rate of change of an option's price with respect to changes
in the underlying asset's price.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `long_call` - Delta value for a long call position. Typically ranges
  between 0 and 1, where values closer to 1 indicate the option behaves
  more like the underlying asset.

- `short_call` - Delta value for a short call position. This is the
  negative of the long call delta, typically ranging from -1 to 0.

- `long_put` - Delta value for a long put position. Typically ranges
  between -1 and 0, where values closer to -1 indicate stronger inverse
  correlation with the underlying.

- `short_put` - Delta value for a short put position. This is the
  negative of the long put delta, typically ranging from 0 to 1.

## [§](#usage){.doc-anchor}Usage

This struct is typically used in options analysis, risk management, and
strategy development to assess position sensitivity to underlying price
movements at specific strike prices.

Delta values are essential for understanding directional exposure and
for implementing delta-neutral strategies in options trading.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.long_call){.anchor
.field}`long_call: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.long_call
...
.field}`short_call: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.short_call
.structfield .section-header}
...
.field}`long_put: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.long_put
.structfield .section-header}
...
.field}`short_put: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.short_put
.structfield .section-header}
...
::: {#impl-Clone-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-Clone-for-DeltasInStrike){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-clone-for-deltasinstrike .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#fn-cloneself---deltasinstrike .code-header}
:::
...
::: {#impl-ComposeSchema-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-ComposeSchema-for-DeltasInStrike){.anchor}

### impl ComposeSchema for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-composeschema-for-deltasinstrike .code-header}
:::
...
::: {#impl-Debug-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-Debug-for-DeltasInStrike){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-debug-for-deltasinstrike .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-DeltasInStrike){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#implde-deserializede-for-deltasinstrike .code-header}
:::
...
::: {#impl-Display-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-Display-for-DeltasInStrike){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-display-for-deltasinstrike .code-header}
:::
...
::: {#impl-Serialize-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-Serialize-for-DeltasInStrike){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-serialize-for-deltasinstrike .code-header}
:::
...
::: {#impl-ToSchema-for-DeltasInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#141){.src
.rightside}[§](#impl-ToSchema-for-DeltasInStrike){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-toschema-for-deltasinstrike .code-header}
:::
...
::: {#impl-Freeze-for-DeltasInStrike .section .impl}
[§](#impl-Freeze-for-DeltasInStrike){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-freeze-for-deltasinstrike .code-header}
:::

::: {#impl-RefUnwindSafe-for-DeltasInStrike .section .impl}
[§](#impl-RefUnwindSafe-for-DeltasInStrike){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-refunwindsafe-for-deltasinstrike .code-header}
:::

::: {#impl-Send-for-DeltasInStrike .section .impl}
[§](#impl-Send-for-DeltasInStrike){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-send-for-deltasinstrike .code-header}
:::

::: {#impl-Sync-for-DeltasInStrike .section .impl}
[§](#impl-Sync-for-DeltasInStrike){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-sync-for-deltasinstrike .code-header}
:::

::: {#impl-Unpin-for-DeltasInStrike .section .impl}
[§](#impl-Unpin-for-DeltasInStrike){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-unpin-for-deltasinstrike .code-header}
:::

::: {#impl-UnwindSafe-for-DeltasInStrike .section .impl}
[§](#impl-UnwindSafe-for-DeltasInStrike){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-unwindsafe-for-deltasinstrike .code-header}
:::
:::::::::
