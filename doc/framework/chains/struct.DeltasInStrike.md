...
[[Source](../../src/optionstratlib/chains/options.rs.html#139-151){.src}
]{.sub-heading}
::::
...
.field}`long_call: Decimal`]{#structfield.long_call .structfield
.section-header}
...
.field}`short_call: Decimal`]{#structfield.short_call .structfield
.section-header}
...
.field}`long_put: Decimal`]{#structfield.long_put .structfield
.section-header}
...
.field}`short_put: Decimal`]{#structfield.short_put .structfield
.section-header}
...
[Source](../../src/optionstratlib/chains/options.rs.html#138){.src
.rightside}[§](#impl-Clone-for-DeltasInStrike){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-clone-for-deltasinstrike .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#fn-cloneself---deltasinstrike .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-debug-for-deltasinstrike .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-freeze-for-deltasinstrike .code-header}
:::

::: {#impl-RefUnwindSafe-for-DeltasInStrike .section .impl}
[§](#impl-RefUnwindSafe-for-DeltasInStrike){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-refunwindsafe-for-deltasinstrike .code-header}
:::

::: {#impl-Send-for-DeltasInStrike .section .impl}
[§](#impl-Send-for-DeltasInStrike){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-send-for-deltasinstrike .code-header}
:::

::: {#impl-Sync-for-DeltasInStrike .section .impl}
[§](#impl-Sync-for-DeltasInStrike){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-sync-for-deltasinstrike .code-header}
:::

::: {#impl-Unpin-for-DeltasInStrike .section .impl}
[§](#impl-Unpin-for-DeltasInStrike){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-unpin-for-deltasinstrike .code-header}
:::

::: {#impl-UnwindSafe-for-DeltasInStrike .section .impl}
[§](#impl-UnwindSafe-for-DeltasInStrike){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct} {#impl-unwindsafe-for-deltasinstrike .code-header}
:::
:::::::::
