...
# Struct [RNDResult]{.struct} Copy item path

[[Source](../../src/optionstratlib/chains/rnd.rs.html#185-190){.src}
]{.sub-heading}
::::
...
Contains both the calculated density values and their statistical
properties.

## [§](#fields-1){.doc-anchor}Fields {#fields-1}

- `densities` - Mapping of strike prices to their corresponding
  probability densities
- `statistics` - Statistical moments and properties of the distribution

## [§](#notes){.doc-anchor}Notes

The densities represent the market's implied probability distribution of
future prices.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.densities){.anchor
.field}`densities: `[`BTreeMap`](https://doc.rust-lang.org/1.91.1/alloc/collections/btree/map/struct.BTreeMap.html "struct alloc::collections::btree::map::BTreeMap"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`, `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}`>`]{#structfield.densities
...
.field}`statistics: RNDStatistics`]{#structfield.statistics .structfield
.section-header}
...
::: {#impl-RNDResult .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#377-386){.src
.rightside}[§](#impl-RNDResult){.anchor}

### impl [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-rndresult .code-header}
:::

::::: impl-items
::: {#method.new .section .method}
[Source](../../src/optionstratlib/chains/rnd.rs.html#379-385){.src
.rightside}

#### pub fn [new](#method.new){.fn}(densities: [BTreeMap](https://doc.rust-lang.org/1.91.1/alloc/collections/btree/map/struct.BTreeMap.html "struct alloc::collections::btree::map::BTreeMap"){.struct}\<[Positive](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, [Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}\>) -\> Self {#pub-fn-newdensities-btreemappositive-decimal---self .code-header}
:::
...
::: {#impl-Clone-for-RNDResult .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#184){.src
.rightside}[§](#impl-Clone-for-RNDResult){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-clone-for-rndresult .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#fn-cloneself---rndresult .code-header}
:::
...
::: {#impl-Debug-for-RNDResult .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#184){.src
.rightside}[§](#impl-Debug-for-RNDResult){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-debug-for-rndresult .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-RNDResult .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#184){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-RNDResult){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#implde-deserializede-for-rndresult .code-header}
:::
...
::: {#impl-Serialize-for-RNDResult .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#184){.src
.rightside}[§](#impl-Serialize-for-RNDResult){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-serialize-for-rndresult .code-header}
:::
...
::: {#impl-Freeze-for-RNDResult .section .impl}
[§](#impl-Freeze-for-RNDResult){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-freeze-for-rndresult .code-header}
:::

::: {#impl-RefUnwindSafe-for-RNDResult .section .impl}
[§](#impl-RefUnwindSafe-for-RNDResult){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-refunwindsafe-for-rndresult .code-header}
:::

::: {#impl-Send-for-RNDResult .section .impl}
[§](#impl-Send-for-RNDResult){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-send-for-rndresult .code-header}
:::

::: {#impl-Sync-for-RNDResult .section .impl}
[§](#impl-Sync-for-RNDResult){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-sync-for-rndresult .code-header}
:::

::: {#impl-Unpin-for-RNDResult .section .impl}
[§](#impl-Unpin-for-RNDResult){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-unpin-for-rndresult .code-header}
:::

::: {#impl-UnwindSafe-for-RNDResult .section .impl}
[§](#impl-UnwindSafe-for-RNDResult){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-unwindsafe-for-rndresult .code-header}
:::
:::::::::
