...
[[Source](../../src/optionstratlib/chains/rnd.rs.html#182-187){.src}
]{.sub-heading}
::::
...
.field}`densities: `[`BTreeMap`](https://doc.rust-lang.org/1.86.0/alloc/collections/btree/map/struct.BTreeMap.html "struct alloc::collections::btree::map::BTreeMap"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`, Decimal>`]{#structfield.densities
...
[Source](../../src/optionstratlib/chains/rnd.rs.html#374-383){.src
...
[Source](../../src/optionstratlib/chains/rnd.rs.html#376-382){.src
.rightside}

#### pub fn [new](#method.new){.fn}(densities: [BTreeMap](https://doc.rust-lang.org/1.86.0/alloc/collections/btree/map/struct.BTreeMap.html "struct alloc::collections::btree::map::BTreeMap"){.struct}\<[Positive](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, Decimal\>) -\> Self {#pub-fn-newdensities-btreemappositive-decimal---self .code-header}
:::
...
[Source](../../src/optionstratlib/chains/rnd.rs.html#181){.src
.rightside}[§](#impl-Clone-for-RNDResult){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-clone-for-rndresult .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#fn-cloneself---rndresult .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-debug-for-rndresult .code-header}
:::
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#implde-deserializede-for-rndresult .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-serialize-for-rndresult .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-freeze-for-rndresult .code-header}
:::

::: {#impl-RefUnwindSafe-for-RNDResult .section .impl}
[§](#impl-RefUnwindSafe-for-RNDResult){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-refunwindsafe-for-rndresult .code-header}
:::

::: {#impl-Send-for-RNDResult .section .impl}
[§](#impl-Send-for-RNDResult){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-send-for-rndresult .code-header}
:::

::: {#impl-Sync-for-RNDResult .section .impl}
[§](#impl-Sync-for-RNDResult){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-sync-for-rndresult .code-header}
:::

::: {#impl-Unpin-for-RNDResult .section .impl}
[§](#impl-Unpin-for-RNDResult){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-unpin-for-rndresult .code-header}
:::

::: {#impl-UnwindSafe-for-RNDResult .section .impl}
[§](#impl-UnwindSafe-for-RNDResult){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RNDResult](struct.RNDResult.html "struct optionstratlib::chains::RNDResult"){.struct} {#impl-unwindsafe-for-rndresult .code-header}
:::
:::::::::
