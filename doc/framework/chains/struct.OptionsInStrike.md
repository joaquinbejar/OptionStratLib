...
[[Source](../../src/optionstratlib/chains/options.rs.html#43-55){.src}
]{.sub-heading}
::::
...
[Source](../../src/optionstratlib/chains/options.rs.html#57-112){.src
...
[Source](../../src/optionstratlib/chains/options.rs.html#74-86){.src
.rightside}
...
[Source](../../src/optionstratlib/chains/options.rs.html#104-111){.src
.rightside}

#### pub fn [deltas](#method.deltas){.fn}(&self) -\> [Result](https://doc.rust-lang.org/1.91.1/core/result/enum.Result.html "enum core::result::Result"){.enum}\<[DeltasInStrike](struct.DeltasInStrike.html "struct optionstratlib::chains::DeltasInStrike"){.struct}, [OptionsError](../error/enum.OptionsError.html "enum optionstratlib::error::OptionsError"){.enum}\> {#pub-fn-deltasself---resultdeltasinstrike-optionserror .code-header}
:::
...
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-Clone-for-OptionsInStrike){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-clone-for-optionsinstrike .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#fn-cloneself---optionsinstrike .code-header}
:::
...
::: {#impl-ComposeSchema-for-OptionsInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-ComposeSchema-for-OptionsInStrike){.anchor}

### impl ComposeSchema for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-composeschema-for-optionsinstrike .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-debug-for-optionsinstrike .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-OptionsInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-OptionsInStrike){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#implde-deserializede-for-optionsinstrike .code-header}
:::
...
::: {#impl-Display-for-OptionsInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-Display-for-OptionsInStrike){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-display-for-optionsinstrike .code-header}
:::
...
::: {#impl-Serialize-for-OptionsInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-Serialize-for-OptionsInStrike){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-serialize-for-optionsinstrike .code-header}
:::
...
::: {#impl-ToSchema-for-OptionsInStrike .section .impl}
[Source](../../src/optionstratlib/chains/options.rs.html#42){.src
.rightside}[§](#impl-ToSchema-for-OptionsInStrike){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-toschema-for-optionsinstrike .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-freeze-for-optionsinstrike .code-header}
:::

::: {#impl-RefUnwindSafe-for-OptionsInStrike .section .impl}
[§](#impl-RefUnwindSafe-for-OptionsInStrike){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-refunwindsafe-for-optionsinstrike .code-header}
:::

::: {#impl-Send-for-OptionsInStrike .section .impl}
[§](#impl-Send-for-OptionsInStrike){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-send-for-optionsinstrike .code-header}
:::

::: {#impl-Sync-for-OptionsInStrike .section .impl}
[§](#impl-Sync-for-OptionsInStrike){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-sync-for-optionsinstrike .code-header}
:::

::: {#impl-Unpin-for-OptionsInStrike .section .impl}
[§](#impl-Unpin-for-OptionsInStrike){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-unpin-for-optionsinstrike .code-header}
:::

::: {#impl-UnwindSafe-for-OptionsInStrike .section .impl}
[§](#impl-UnwindSafe-for-OptionsInStrike){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptionsInStrike](struct.OptionsInStrike.html "struct optionstratlib::chains::OptionsInStrike"){.struct} {#impl-unwindsafe-for-optionsinstrike .code-header}
:::
:::::::::
