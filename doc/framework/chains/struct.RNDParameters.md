...
[[Source](../../src/optionstratlib/chains/rnd.rs.html#152-159){.src}
]{.sub-heading}
::::
...
.field}`interpolation_points: `[`usize`](https://doc.rust-lang.org/1.86.0/std/primitive.usize.html){.primitive}]{#structfield.interpolation_points
.structfield .section-header}
...
[Source](../../src/optionstratlib/chains/rnd.rs.html#151){.src
.rightside}[§](#impl-Clone-for-RNDParameters){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-clone-for-rndparameters .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#fn-cloneself---rndparameters .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-debug-for-rndparameters .code-header}
:::
...
[Source](../../src/optionstratlib/chains/rnd.rs.html#161-169){.src
.rightside}[§](#impl-Default-for-RNDParameters){.anchor}

### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-default-for-rndparameters .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#162-168){.src
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-freeze-for-rndparameters .code-header}
:::

::: {#impl-RefUnwindSafe-for-RNDParameters .section .impl}
[§](#impl-RefUnwindSafe-for-RNDParameters){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-refunwindsafe-for-rndparameters .code-header}
:::

::: {#impl-Send-for-RNDParameters .section .impl}
[§](#impl-Send-for-RNDParameters){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-send-for-rndparameters .code-header}
:::

::: {#impl-Sync-for-RNDParameters .section .impl}
[§](#impl-Sync-for-RNDParameters){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-sync-for-rndparameters .code-header}
:::

::: {#impl-Unpin-for-RNDParameters .section .impl}
[§](#impl-Unpin-for-RNDParameters){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-unpin-for-rndparameters .code-header}
:::

::: {#impl-UnwindSafe-for-RNDParameters .section .impl}
[§](#impl-UnwindSafe-for-RNDParameters){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-unwindsafe-for-rndparameters .code-header}
:::
:::::::::
