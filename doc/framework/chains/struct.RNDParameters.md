...
# Struct [RNDParameters]{.struct} Copy item path

[[Source](../../src/optionstratlib/chains/rnd.rs.html#155-162){.src}
]{.sub-heading}
::::
...
This structure holds all necessary parameters for calculating the
Risk-Neutral Density (RND) from option chain data.

## [§](#parameters){.doc-anchor}Parameters

- `risk_free_rate` - Risk-free interest rate used in the calculation
- `interpolation_points` - Number of points to use in interpolation
  between strikes
- `derivative_tolerance` - Numerical tolerance for derivative
  calculations
...
[[§](#structfield.interpolation_points){.anchor
.field}`interpolation_points: `[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}]{#structfield.interpolation_points
.structfield .section-header}
...
[[§](#structfield.derivative_tolerance){.anchor
.field}`derivative_tolerance: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.derivative_tolerance
.structfield .section-header}
...
::: {#impl-Clone-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-Clone-for-RNDParameters){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-clone-for-rndparameters .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#fn-cloneself---rndparameters .code-header}
:::
...
::: {#impl-ComposeSchema-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-ComposeSchema-for-RNDParameters){.anchor}

### impl ComposeSchema for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-composeschema-for-rndparameters .code-header}
:::
...
::: {#impl-Debug-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-Debug-for-RNDParameters){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-debug-for-rndparameters .code-header}
:::
...
::: {#impl-Default-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#164-172){.src
.rightside}[§](#impl-Default-for-RNDParameters){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-default-for-rndparameters .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#165-171){.src
...
::: {#impl-Deserialize%3C'de%3E-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-RNDParameters){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#implde-deserializede-for-rndparameters .code-header}
:::
...
::: {#impl-Display-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-Display-for-RNDParameters){.anchor}

### impl [Display](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-display-for-rndparameters .code-header}
:::
...
::: {#impl-Serialize-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-Serialize-for-RNDParameters){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-serialize-for-rndparameters .code-header}
:::
...
::: {#impl-ToSchema-for-RNDParameters .section .impl}
[Source](../../src/optionstratlib/chains/rnd.rs.html#154){.src
.rightside}[§](#impl-ToSchema-for-RNDParameters){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-toschema-for-rndparameters .code-header}
:::
...
::: {#impl-Freeze-for-RNDParameters .section .impl}
[§](#impl-Freeze-for-RNDParameters){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-freeze-for-rndparameters .code-header}
:::

::: {#impl-RefUnwindSafe-for-RNDParameters .section .impl}
[§](#impl-RefUnwindSafe-for-RNDParameters){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-refunwindsafe-for-rndparameters .code-header}
:::

::: {#impl-Send-for-RNDParameters .section .impl}
[§](#impl-Send-for-RNDParameters){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-send-for-rndparameters .code-header}
:::

::: {#impl-Sync-for-RNDParameters .section .impl}
[§](#impl-Sync-for-RNDParameters){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-sync-for-rndparameters .code-header}
:::

::: {#impl-Unpin-for-RNDParameters .section .impl}
[§](#impl-Unpin-for-RNDParameters){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-unpin-for-rndparameters .code-header}
:::

::: {#impl-UnwindSafe-for-RNDParameters .section .impl}
[§](#impl-UnwindSafe-for-RNDParameters){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RNDParameters](struct.RNDParameters.html "struct optionstratlib::chains::RNDParameters"){.struct} {#impl-unwindsafe-for-rndparameters .code-header}
:::
:::::::::
