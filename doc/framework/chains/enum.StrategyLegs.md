...
# Enum [StrategyLegs]{.enum}Copy item path

[[Source](../../src/optionstratlib/chains/legs.rs.html#36-90){.src}
]{.sub-heading}
::::
...
:::: sub-variant-field
[[§](#variant.TwoLegs.field.first){.anchor
...
:::: sub-variant-field
[[§](#variant.TwoLegs.field.second){.anchor
...
:::: sub-variant-field
[[§](#variant.ThreeLegs.field.first){.anchor
...
:::: sub-variant-field
[[§](#variant.ThreeLegs.field.second){.anchor
...
:::: sub-variant-field
[[§](#variant.ThreeLegs.field.third){.anchor
...
:::: sub-variant-field
[[§](#variant.FourLegs.field.first){.anchor
...
:::: sub-variant-field
[[§](#variant.FourLegs.field.second){.anchor
...
:::: sub-variant-field
[[§](#variant.FourLegs.field.third){.anchor
...
:::: sub-variant-field
[[§](#variant.FourLegs.field.fourth){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.first){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.second){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.third){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.fourth){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.fifth){.anchor
...
:::: sub-variant-field
[[§](#variant.SixLegs.field.sixth){.anchor
...
[Source](../../src/optionstratlib/chains/legs.rs.html#35){.src
.rightside}[§](#impl-Clone-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-clone-for-strategylegsa .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#fn-cloneself---strategylegsa .code-header}
:::
...
[Source](../../src/optionstratlib/chains/legs.rs.html#35){.src
.rightside}[§](#impl-Debug-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-debug-for-strategylegsa .code-header}
:::
...
[Source](../../src/optionstratlib/chains/legs.rs.html#92-141){.src
.rightside}[§](#impl-Display-for-StrategyLegs%3C'_%3E){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'\_\> {#impl-display-for-strategylegs_ .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/chains/legs.rs.html#93-140){.src
...
[§](#impl-Freeze-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-freeze-for-strategylegsa .code-header}
:::

::: {#impl-RefUnwindSafe-for-StrategyLegs%3C'a%3E .section .impl}
[§](#impl-RefUnwindSafe-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-refunwindsafe-for-strategylegsa .code-header}
:::

::: {#impl-Send-for-StrategyLegs%3C'a%3E .section .impl}
[§](#impl-Send-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-send-for-strategylegsa .code-header}
:::

::: {#impl-Sync-for-StrategyLegs%3C'a%3E .section .impl}
[§](#impl-Sync-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-sync-for-strategylegsa .code-header}
:::

::: {#impl-Unpin-for-StrategyLegs%3C'a%3E .section .impl}
[§](#impl-Unpin-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-unpin-for-strategylegsa .code-header}
:::

::: {#impl-UnwindSafe-for-StrategyLegs%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-StrategyLegs%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [StrategyLegs](enum.StrategyLegs.html "enum optionstratlib::chains::StrategyLegs"){.enum}\<\'a\> {#impla-unwindsafe-for-strategylegsa .code-header}
:::
:::::::::
