...
# Struct [RandomPositionsParams]{.struct} Copy item path

[[Source](../../../src/optionstratlib/chains/utils.rs.html#450-479){.src}
]{.sub-heading}
::::

``` {.rust .item-decl}
pub struct RandomPositionsParams {Show 14 fields
...
[[§](#structfield.qty_puts_long){.anchor
.field}`qty_puts_long: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}`>`]{#structfield.qty_puts_long
...
[[§](#structfield.qty_puts_short){.anchor
.field}`qty_puts_short: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}`>`]{#structfield.qty_puts_short
.structfield .section-header}
...
[[§](#structfield.qty_calls_long){.anchor
.field}`qty_calls_long: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}`>`]{#structfield.qty_calls_long
.structfield .section-header}
...
[[§](#structfield.qty_calls_short){.anchor
.field}`qty_calls_short: `[`Option`](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}`<`[`usize`](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}`>`]{#structfield.qty_calls_short
.structfield .section-header}
...
.field}`expiration_date: `[`ExpirationDate`](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}]{#structfield.expiration_date
.structfield .section-header}
...
[[§](#structfield.option_qty){.anchor
.field}`option_qty: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.option_qty
.structfield .section-header}
...
.field}`dividend_yield: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.dividend_yield
.structfield .section-header}
...
[[§](#structfield.open_put_fee){.anchor
.field}`open_put_fee: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.open_put_fee
.structfield .section-header}
...
[[§](#structfield.open_call_fee){.anchor
.field}`open_call_fee: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.open_call_fee
.structfield .section-header}
...
[[§](#structfield.close_put_fee){.anchor
.field}`close_put_fee: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.close_put_fee
.structfield .section-header}
...
[[§](#structfield.close_call_fee){.anchor
.field}`close_call_fee: `[`Positive`](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.close_call_fee
.structfield .section-header}
...
::: {#impl-RandomPositionsParams .section .impl}
[Source](../../../src/optionstratlib/chains/utils.rs.html#481-562){.src
.rightside}[§](#impl-RandomPositionsParams){.anchor}

### impl [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-randompositionsparams .code-header}
:::

::::::: impl-items
::: {#method.new .section .method}
[Source](../../../src/optionstratlib/chains/utils.rs.html#513-545){.src
.rightside}

#### pub fn [new](#method.new){.fn}( qty_puts_long: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}\>, qty_puts_short: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}\>, qty_calls_long: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}\>, qty_calls_short: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive}\>, expiration_date: [ExpirationDate](../../model/enum.ExpirationDate.html "enum optionstratlib::model::ExpirationDate"){.enum}, option_qty: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, risk_free_rate: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, dividend_yield: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_put_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, open_call_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_put_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, close_call_fee: [Positive](../../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}, epic: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[String](https://doc.rust-lang.org/1.91.1/alloc/string/struct.String.html "struct alloc::string::String"){.struct}\>, extra_fields: [Option](https://doc.rust-lang.org/1.91.1/core/option/enum.Option.html "enum core::option::Option"){.enum}\<[Value](../../../serde_json/value/enum.Value.html "enum serde_json::value::Value"){.enum}\>, ) -\> Self {#pub-fn-new-qty_puts_long-optionusize-qty_puts_short-optionusize-qty_calls_long-optionusize-qty_calls_short-optionusize-expiration_date-expirationdate-option_qty-positive-risk_free_rate-decimal-dividend_yield-positive-open_put_fee-positive-open_call_fee-positive-close_put_fee-positive-close_call_fee-positive-epic-optionstring-extra_fields-optionvalue---self .code-header}
:::

::: docblock
Creates a new instance of `RandomPositionsParams` with the specified
parameters.

This constructor initializes a configuration object that defines
parameters for generating random option positions in an option chain. It
allows specifying the quantity of different option types (puts/calls,
long/short), expiration settings, and various fee structures.
...
- `qty_calls_short` - Optional number of short call positions to
  generate
- `expiration_date` - The expiration date for the options (can be
  specified as days from now or absolute date)
...
This function has many parameters, but this is justified by the complex
nature of option position generation which requires detailed
configuration.
:::

::: {#method.total_positions .section .method}
[Source](../../../src/optionstratlib/chains/utils.rs.html#556-561){.src
.rightside}

#### pub fn [total_positions](#method.total_positions){.fn}(&self) -\> [usize](https://doc.rust-lang.org/1.91.1/std/primitive.usize.html){.primitive} {#pub-fn-total_positionsself---usize .code-header}
:::

::: docblock
Returns the total number of positions to generate.

This method calculates the sum of all option position types (puts
long/short and calls long/short) that need to be generated based on the
current configuration. If any position type is not specified (None), it
is treated as zero.
...
::: {#impl-Clone-for-RandomPositionsParams .section .impl}
[Source](../../../src/optionstratlib/chains/utils.rs.html#449){.src
.rightside}[§](#impl-Clone-for-RandomPositionsParams){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-clone-for-randompositionsparams .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#fn-cloneself---randompositionsparams .code-header}
:::
...
::: {#impl-Debug-for-RandomPositionsParams .section .impl}
[Source](../../../src/optionstratlib/chains/utils.rs.html#449){.src
.rightside}[§](#impl-Debug-for-RandomPositionsParams){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-debug-for-randompositionsparams .code-header}
:::
...
::: {#impl-Freeze-for-RandomPositionsParams .section .impl}
[§](#impl-Freeze-for-RandomPositionsParams){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-freeze-for-randompositionsparams .code-header}
:::

::: {#impl-RefUnwindSafe-for-RandomPositionsParams .section .impl}
[§](#impl-RefUnwindSafe-for-RandomPositionsParams){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-refunwindsafe-for-randompositionsparams .code-header}
:::

::: {#impl-Send-for-RandomPositionsParams .section .impl}
[§](#impl-Send-for-RandomPositionsParams){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-send-for-randompositionsparams .code-header}
:::

::: {#impl-Sync-for-RandomPositionsParams .section .impl}
[§](#impl-Sync-for-RandomPositionsParams){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-sync-for-randompositionsparams .code-header}
:::

::: {#impl-Unpin-for-RandomPositionsParams .section .impl}
[§](#impl-Unpin-for-RandomPositionsParams){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-unpin-for-randompositionsparams .code-header}
:::

::: {#impl-UnwindSafe-for-RandomPositionsParams .section .impl}
[§](#impl-UnwindSafe-for-RandomPositionsParams){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RandomPositionsParams](struct.RandomPositionsParams.html "struct optionstratlib::chains::utils::RandomPositionsParams"){.struct} {#impl-unwindsafe-for-randompositionsparams .code-header}
:::
:::::::::
