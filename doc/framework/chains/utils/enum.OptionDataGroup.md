...
[[Source](../../../src/optionstratlib/chains/utils.rs.html#51-71){.src}
]{.sub-heading}
::::
...
### Any([Vec](https://doc.rust-lang.org/1.91.1/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}\<&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}\>) {#anyveca-optiondata .code-header}
:::
...
[Source](../../../src/optionstratlib/chains/utils.rs.html#50){.src
.rightside}[§](#impl-Debug-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-debug-for-optiondatagroupa .code-header}
:::
...
### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-freeze-for-optiondatagroupa .code-header}
:::
...
### impl\<\'a\> [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-send-for-optiondatagroupa .code-header}
:::

::: {#impl-Sync-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Sync-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-sync-for-optiondatagroupa .code-header}
:::

::: {#impl-Unpin-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Unpin-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-unpin-for-optiondatagroupa .code-header}
:::

::: {#impl-UnwindSafe-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-unwindsafe-for-optiondatagroupa .code-header}
:::
:::::::::
