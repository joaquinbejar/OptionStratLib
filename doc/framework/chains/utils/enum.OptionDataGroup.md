...
# Enum [OptionDataGroup]{.enum}Copy item path

[[Source](../../../src/optionstratlib/chains/utils.rs.html#50-70){.src}
]{.sub-heading}
::::
...
pub enum OptionDataGroup<'a> {
    ...
    Four(&'a OptionData, &'a OptionData, &'a OptionData, &'a OptionData),
...
::: docblock
Enum representing a grouping of option data references for analysis or
display purposes.

This enum provides different ways to group option data references, from
individual options to collections of various sizes. It supports holding
references to one, two, three, or four specific options, or an arbitrary
number of options through the `Any` variant.

## [§](#variants-1){.doc-anchor}Variants {#variants-1}

- `One` - Contains a reference to a single option data record.

- `Two` - Contains references to exactly two option data records,
  typically used for comparison or spread analysis.

- `Three` - Contains references to exactly three option data records,
  useful for analyzing multi-leg option strategies like butterflies.

- `Four` - Contains references to exactly four option data records,
  useful for complex option strategies like condors or iron condors.

- `Any` - Contains a vector of option data references for more flexible
  grouping when the number of options is variable or exceeds four.

## [§](#type-parameters){.doc-anchor}Type Parameters

- `'a` - The lifetime parameter ensuring that all referenced
  `OptionData` instances live at least as long as this
  `OptionDataGroup`.

## [§](#usage){.doc-anchor}Usage

This enum is typically used when analyzing multiple options together,
displaying related options in a UI, or processing option groups in
trading strategies.
:::
...
::::::::::::: variants
::: {#variant.One .section .variant}
[§](#variant.One){.anchor}

### One(&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}) {#onea-optiondata .code-header}
:::
...
::: {#variant.Two .section .variant}
[§](#variant.Two){.anchor}

### Two(&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}) {#twoa-optiondata-a-optiondata .code-header}
:::
...
::: {#variant.Three .section .variant}
[§](#variant.Three){.anchor}

### Three(&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}) {#threea-optiondata-a-optiondata-a-optiondata .code-header}
:::
...
::: {#variant.Four .section .variant}
[§](#variant.Four){.anchor}

### Four(&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}, &\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}) {#foura-optiondata-a-optiondata-a-optiondata-a-optiondata .code-header}
:::
...
::: {#variant.Any .section .variant}
[§](#variant.Any){.anchor}

### Any([Vec](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}\<&\'a [OptionData](../struct.OptionData.html "struct optionstratlib::chains::OptionData"){.struct}\>) {#anyveca-optiondata .code-header}
:::
...
::: {#impl-Debug-for-OptionDataGroup%3C'a%3E .section .impl}
[Source](../../../src/optionstratlib/chains/utils.rs.html#49){.src
.rightside}[§](#impl-Debug-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-debug-for-optiondatagroupa .code-header}
:::
...
::: {#impl-Freeze-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Freeze-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-freeze-for-optiondatagroupa .code-header}
:::

::: {#impl-RefUnwindSafe-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-RefUnwindSafe-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-refunwindsafe-for-optiondatagroupa .code-header}
:::

::: {#impl-Send-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Send-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-send-for-optiondatagroupa .code-header}
:::

::: {#impl-Sync-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Sync-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-sync-for-optiondatagroupa .code-header}
:::

::: {#impl-Unpin-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-Unpin-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-unpin-for-optiondatagroupa .code-header}
:::

::: {#impl-UnwindSafe-for-OptionDataGroup%3C'a%3E .section .impl}
[§](#impl-UnwindSafe-for-OptionDataGroup%3C'a%3E){.anchor}

### impl\<\'a\> [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [OptionDataGroup](enum.OptionDataGroup.html "enum optionstratlib::chains::utils::OptionDataGroup"){.enum}\<\'a\> {#impla-unwindsafe-for-optiondatagroupa .code-header}
:::
:::::::::
