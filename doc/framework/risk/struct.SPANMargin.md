...
# Struct [SPANMargin]{.struct} Copy item path

[[Source](../../src/optionstratlib/risk/span.rs.html#22-37){.src}
]{.sub-heading}
::::

``` {.rust .item-decl}
pub struct SPANMargin { /* private fields */ }
```
...
This structure contains the key parameters needed to calculate margin
requirements for derivatives positions using the SPAN methodology
developed by the Chicago Mercantile Exchange. These parameters control
the risk scenarios that will be evaluated when determining potential
portfolio losses.

The SPAN methodology evaluates positions under various market scenarios
combining price movements, volatility changes, and time decay effects to
determine appropriate margin requirements.
:::

## Implementations[§](#implementations){.anchor} {#implementations .section-header}

:::::::::: {#implementations-list}
::: {#impl-SPANMargin .section .impl}
[Source](../../src/optionstratlib/risk/span.rs.html#40-265){.src
.rightside}[§](#impl-SPANMargin){.anchor}

### impl [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-spanmargin .code-header}
:::

:::::::: impl-items
::: {#method.new .section .method}
[Source](../../src/optionstratlib/risk/span.rs.html#76-86){.src
.rightside}

#### pub fn [new](#method.new){.fn}( short_option_minimum: [Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, price_scan_range: [Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, volatility_scan_range: [Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, ) -\> Self {#pub-fn-new-short_option_minimum-decimal-price_scan_range-decimal-volatility_scan_range-decimal---self .code-header}
:::

:::: docblock
Creates a new SPAN margin calculator with the specified risk parameters.

This constructor initializes a SPANMargin structure with the key
parameters needed for calculating margin requirements using the Standard
Portfolio Analysis of Risk methodology.

##### [§](#parameters){.doc-anchor}Parameters

- `short_option_minimum` - The minimum charge applied to short option
  positions, typically expressed as a percentage of the underlying asset
  value.

- `price_scan_range` - The range of price movements to consider when
  generating price scenarios, expressed as a decimal percentage (e.g.,
  0.05 for 5%). Determines how far up and down the underlying price
  might move in risk analysis.

- `volatility_scan_range` - The range of volatility changes to consider
  when generating volatility scenarios, expressed as a decimal
  percentage. Controls potential implied volatility fluctuations in risk
  analysis.
...
::: {#method.calculate_margin .section .method}
[Source](../../src/optionstratlib/risk/span.rs.html#104-112){.src
.rightside}

#### pub fn [calculate_margin](#method.calculate_margin){.fn}(&self, position: &[Position](../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}) -\> [Decimal](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct} {#pub-fn-calculate_marginself-position-position---decimal .code-header}
:::

::: docblock
Calculates the margin requirement for a given position based on SPAN
methodology.

This method determines the margin requirement by:

1.  Calculating a risk array representing potential losses across
    different price and volatility scenarios
2.  Determining the minimum margin requirement for short options
    positions
3.  Taking the maximum value between the highest potential loss and the
    short option minimum

The margin requirement helps ensure traders maintain sufficient funds to
cover potential losses in adverse market conditions.

##### [§](#arguments){.doc-anchor}Arguments

- `position` - The option position for which to calculate margin
  requirements
...
::: {#impl-Clone-for-SPANMargin .section .impl}
[Source](../../src/optionstratlib/risk/span.rs.html#21){.src
.rightside}[§](#impl-Clone-for-SPANMargin){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-clone-for-spanmargin .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#fn-cloneself---spanmargin .code-header}
:::
...
::: {#impl-Debug-for-SPANMargin .section .impl}
[Source](../../src/optionstratlib/risk/span.rs.html#21){.src
.rightside}[§](#impl-Debug-for-SPANMargin){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-debug-for-spanmargin .code-header}
:::
...
::: {#impl-Freeze-for-SPANMargin .section .impl}
[§](#impl-Freeze-for-SPANMargin){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-freeze-for-spanmargin .code-header}
:::

::: {#impl-RefUnwindSafe-for-SPANMargin .section .impl}
[§](#impl-RefUnwindSafe-for-SPANMargin){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-refunwindsafe-for-spanmargin .code-header}
:::

::: {#impl-Send-for-SPANMargin .section .impl}
[§](#impl-Send-for-SPANMargin){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-send-for-spanmargin .code-header}
:::

::: {#impl-Sync-for-SPANMargin .section .impl}
[§](#impl-Sync-for-SPANMargin){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-sync-for-spanmargin .code-header}
:::

::: {#impl-Unpin-for-SPANMargin .section .impl}
[§](#impl-Unpin-for-SPANMargin){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-unpin-for-spanmargin .code-header}
:::

::: {#impl-UnwindSafe-for-SPANMargin .section .impl}
[§](#impl-UnwindSafe-for-SPANMargin){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-unwindsafe-for-spanmargin .code-header}
:::
:::::::::
