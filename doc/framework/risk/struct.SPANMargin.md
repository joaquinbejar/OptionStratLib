...
#### pub fn [new](#method.new){.fn}( short_option_minimum: Decimal, price_scan_range: Decimal, volatility_scan_range: Decimal, ) -\> Self {#pub-fn-new-short_option_minimum-decimal-price_scan_range-decimal-volatility_scan_range-decimal---self .code-header}
:::
...
#### pub fn [calculate_margin](#method.calculate_margin){.fn}(&self, position: &[Position](../model/position/struct.Position.html "struct optionstratlib::model::position::Position"){.struct}) -\> Decimal {#pub-fn-calculate_marginself-position-position---decimal .code-header}
:::
...
### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-clone-for-spanmargin .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#fn-cloneself---spanmargin .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-debug-for-spanmargin .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-freeze-for-spanmargin .code-header}
:::

::: {#impl-RefUnwindSafe-for-SPANMargin .section .impl}
[§](#impl-RefUnwindSafe-for-SPANMargin){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-refunwindsafe-for-spanmargin .code-header}
:::

::: {#impl-Send-for-SPANMargin .section .impl}
[§](#impl-Send-for-SPANMargin){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-send-for-spanmargin .code-header}
:::

::: {#impl-Sync-for-SPANMargin .section .impl}
[§](#impl-Sync-for-SPANMargin){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-sync-for-spanmargin .code-header}
:::

::: {#impl-Unpin-for-SPANMargin .section .impl}
[§](#impl-Unpin-for-SPANMargin){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-unpin-for-spanmargin .code-header}
:::

::: {#impl-UnwindSafe-for-SPANMargin .section .impl}
[§](#impl-UnwindSafe-for-SPANMargin){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [SPANMargin](struct.SPANMargin.html "struct optionstratlib::risk::SPANMargin"){.struct} {#impl-unwindsafe-for-spanmargin .code-header}
:::
:::::::::
