...
[[Source](../../src/optionstratlib/risk/model.rs.html#49-58){.src}
]{.sub-heading}
::::
...
[Source](../../src/optionstratlib/risk/model.rs.html#48){.src
.rightside}[§](#impl-Clone-for-RiskCategory){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-clone-for-riskcategory .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#fn-cloneself---riskcategory .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-debug-for-riskcategory .code-header}
:::
...
### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#implde-deserializede-for-riskcategory .code-header}
:::
...
### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-partialeq-for-riskcategory .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-riskcategory---bool .code-header}
:::
...
### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-serialize-for-riskcategory .code-header}
:::
...
### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-eq-for-riskcategory .code-header}
:::
...
### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-structuralpartialeq-for-riskcategory .code-header}
:::
:::::::::::::::::::::::::::::::
...
### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-freeze-for-riskcategory .code-header}
:::

::: {#impl-RefUnwindSafe-for-RiskCategory .section .impl}
[§](#impl-RefUnwindSafe-for-RiskCategory){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-refunwindsafe-for-riskcategory .code-header}
:::

::: {#impl-Send-for-RiskCategory .section .impl}
[§](#impl-Send-for-RiskCategory){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-send-for-riskcategory .code-header}
:::

::: {#impl-Sync-for-RiskCategory .section .impl}
[§](#impl-Sync-for-RiskCategory){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-sync-for-riskcategory .code-header}
:::

::: {#impl-Unpin-for-RiskCategory .section .impl}
[§](#impl-Unpin-for-RiskCategory){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-unpin-for-riskcategory .code-header}
:::

::: {#impl-UnwindSafe-for-RiskCategory .section .impl}
[§](#impl-UnwindSafe-for-RiskCategory){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RiskCategory](enum.RiskCategory.html "enum optionstratlib::risk::RiskCategory"){.enum} {#impl-unwindsafe-for-riskcategory .code-header}
:::
:::::::::
