...
[[Source](../../src/optionstratlib/risk/model.rs.html#13-31){.src}
]{.sub-heading}
::::
...
.field}`var_95: Decimal`]{#structfield.var_95 .structfield
.section-header}
...
.field}`var_99: Decimal`]{#structfield.var_99 .structfield
.section-header}
...
.field}`cvar_95: Decimal`]{#structfield.cvar_95 .structfield
.section-header}
...
[Source](../../src/optionstratlib/risk/model.rs.html#12){.src
.rightside}[§](#impl-Clone-for-RiskMetricsSimulation){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-clone-for-riskmetricssimulation .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#fn-cloneself---riskmetricssimulation .code-header}
:::
...
### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-debug-for-riskmetricssimulation .code-header}
:::
...
[Source](../../src/optionstratlib/risk/model.rs.html#33-44){.src
.rightside}[§](#impl-Default-for-RiskMetricsSimulation){.anchor}

### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-default-for-riskmetricssimulation .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/risk/model.rs.html#34-43){.src
...
### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#implde-deserializede-for-riskmetricssimulation .code-header}
:::
...
### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-serialize-for-riskmetricssimulation .code-header}
:::
...
### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-freeze-for-riskmetricssimulation .code-header}
:::
...
### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-send-for-riskmetricssimulation .code-header}
:::

::: {#impl-Sync-for-RiskMetricsSimulation .section .impl}
[§](#impl-Sync-for-RiskMetricsSimulation){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-sync-for-riskmetricssimulation .code-header}
:::

::: {#impl-Unpin-for-RiskMetricsSimulation .section .impl}
[§](#impl-Unpin-for-RiskMetricsSimulation){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-unpin-for-riskmetricssimulation .code-header}
:::
