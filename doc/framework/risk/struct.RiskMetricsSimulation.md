...
:::: main-heading
::: rustdoc-breadcrumbs
[optionstratlib](../index.html)::[risk](index.html)
:::

# Struct [RiskMetricsSimulation]{.struct} Copy item path

[[Source](../../src/optionstratlib/risk/model.rs.html#14-32){.src}
]{.sub-heading}
::::
...
[[§](#structfield.var_95){.anchor
.field}`var_95: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.var_95
...
[[§](#structfield.var_99){.anchor
.field}`var_99: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.var_99
.structfield .section-header}
...
[[§](#structfield.cvar_95){.anchor
.field}`cvar_95: `[`Decimal`](../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}]{#structfield.cvar_95
.structfield .section-header}

::: docblock
Conditional Value at Risk (CVaR) at 95% confidence level (Expected
Shortfall)
:::

[[§](#structfield.severe_loss_probability){.anchor
.field}`severe_loss_probability: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.severe_loss_probability
.structfield .section-header}
...
[[§](#structfield.max_drawdown){.anchor
...
::: {#impl-Clone-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-Clone-for-RiskMetricsSimulation){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-clone-for-riskmetricssimulation .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#fn-cloneself---riskmetricssimulation .code-header}
:::
...
::: {#impl-ComposeSchema-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-ComposeSchema-for-RiskMetricsSimulation){.anchor}

### impl ComposeSchema for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-composeschema-for-riskmetricssimulation .code-header}
:::
...
::: {#impl-Debug-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-Debug-for-RiskMetricsSimulation){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-debug-for-riskmetricssimulation .code-header}
:::
...
::: {#impl-Default-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#34-45){.src
.rightside}[§](#impl-Default-for-RiskMetricsSimulation){.anchor}

### impl [Default](https://doc.rust-lang.org/1.91.1/core/default/trait.Default.html "trait core::default::Default"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-default-for-riskmetricssimulation .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/risk/model.rs.html#35-44){.src
...
::: {#impl-Deserialize%3C'de%3E-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-RiskMetricsSimulation){.anchor}

### impl\<\'de\> [Deserialize](../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#implde-deserializede-for-riskmetricssimulation .code-header}
:::
...
::: {#impl-Serialize-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-Serialize-for-RiskMetricsSimulation){.anchor}

### impl [Serialize](../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-serialize-for-riskmetricssimulation .code-header}
:::
...
::: {#impl-ToSchema-for-RiskMetricsSimulation .section .impl}
[Source](../../src/optionstratlib/risk/model.rs.html#13){.src
.rightside}[§](#impl-ToSchema-for-RiskMetricsSimulation){.anchor}

### impl [ToSchema](../../utoipa/trait.ToSchema.html "trait utoipa::ToSchema"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-toschema-for-riskmetricssimulation .code-header}
:::
...
::: {#impl-Freeze-for-RiskMetricsSimulation .section .impl}
[§](#impl-Freeze-for-RiskMetricsSimulation){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-freeze-for-riskmetricssimulation .code-header}
:::

::: {#impl-RefUnwindSafe-for-RiskMetricsSimulation .section .impl}
[§](#impl-RefUnwindSafe-for-RiskMetricsSimulation){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-refunwindsafe-for-riskmetricssimulation .code-header}
:::

::: {#impl-Send-for-RiskMetricsSimulation .section .impl}
[§](#impl-Send-for-RiskMetricsSimulation){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-send-for-riskmetricssimulation .code-header}
:::

::: {#impl-Sync-for-RiskMetricsSimulation .section .impl}
[§](#impl-Sync-for-RiskMetricsSimulation){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-sync-for-riskmetricssimulation .code-header}
:::

::: {#impl-Unpin-for-RiskMetricsSimulation .section .impl}
[§](#impl-Unpin-for-RiskMetricsSimulation){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-unpin-for-riskmetricssimulation .code-header}
:::

::: {#impl-UnwindSafe-for-RiskMetricsSimulation .section .impl}
[§](#impl-UnwindSafe-for-RiskMetricsSimulation){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [RiskMetricsSimulation](struct.RiskMetricsSimulation.html "struct optionstratlib::risk::RiskMetricsSimulation"){.struct} {#impl-unwindsafe-for-riskmetricssimulation .code-header}
:::
:::::::::
