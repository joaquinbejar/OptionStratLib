...
# Enum [TransactionStatus]{.enum}Copy item path

[[Source](../../src/optionstratlib/pnl/transaction.rs.html#24-39){.src}
]{.sub-heading}
::::
...
::: docblock
## [§](#transaction-status){.doc-anchor}Transaction Status

Represents the current state of an options transaction in the system.

This enum tracks the lifecycle status of option transactions as they
move through various states from creation to completion. Each status
represents a meaningful business state that affects how the transaction
is processed, displayed, and included in profit and loss calculations.

### [§](#status-values){.doc-anchor}Status Values

- `Open` - The transaction is currently active and has not been closed
  or settled
- `Closed` - The transaction has been manually closed before expiration
- `Expired` - The transaction reached its expiration date without being
  exercised
- `Exercised` - The option was exercised, converting it to a position in
  the underlying asset
- `Assigned` - For short options, indicates the counterparty exercised
  the option
:::
...
::::::::::::: variants
::: {#variant.Open .section .variant}
[§](#variant.Open){.anchor}

### Open {#open .code-header}
:::
...
::: {#variant.Closed .section .variant}
[§](#variant.Closed){.anchor}

### Closed {#closed .code-header}
:::
...
::: {#variant.Expired .section .variant}
[§](#variant.Expired){.anchor}

### Expired {#expired .code-header}
:::
...
::: {#variant.Exercised .section .variant}
[§](#variant.Exercised){.anchor}

### Exercised {#exercised .code-header}
:::
...
::: {#variant.Assigned .section .variant}
[§](#variant.Assigned){.anchor}

### Assigned {#assigned .code-header}
:::
...
::: {#impl-Clone-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-Clone-for-TransactionStatus){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-clone-for-transactionstatus .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#fn-cloneself---transactionstatus .code-header}
:::
...
::: {#impl-Debug-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-Debug-for-TransactionStatus){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-debug-for-transactionstatus .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-TransactionStatus){.anchor}

### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#implde-deserializede-for-transactionstatus .code-header}
:::
...
::: {#impl-PartialEq-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-PartialEq-for-TransactionStatus){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-partialeq-for-transactionstatus .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-transactionstatus---bool .code-header}
:::
...
::: {#impl-Serialize-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-Serialize-for-TransactionStatus){.anchor}

### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-serialize-for-transactionstatus .code-header}
:::
...
::: {#impl-Copy-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-Copy-for-TransactionStatus){.anchor}

### impl [Copy](https://doc.rust-lang.org/1.86.0/core/marker/trait.Copy.html "trait core::marker::Copy"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-copy-for-transactionstatus .code-header}
:::

::: {#impl-StructuralPartialEq-for-TransactionStatus .section .impl}
[Source](../../src/optionstratlib/pnl/transaction.rs.html#23){.src
.rightside}[§](#impl-StructuralPartialEq-for-TransactionStatus){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-structuralpartialeq-for-transactionstatus .code-header}
:::
:::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-TransactionStatus .section .impl}
[§](#impl-Freeze-for-TransactionStatus){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-freeze-for-transactionstatus .code-header}
:::

::: {#impl-RefUnwindSafe-for-TransactionStatus .section .impl}
[§](#impl-RefUnwindSafe-for-TransactionStatus){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-refunwindsafe-for-transactionstatus .code-header}
:::

::: {#impl-Send-for-TransactionStatus .section .impl}
[§](#impl-Send-for-TransactionStatus){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-send-for-transactionstatus .code-header}
:::

::: {#impl-Sync-for-TransactionStatus .section .impl}
[§](#impl-Sync-for-TransactionStatus){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-sync-for-transactionstatus .code-header}
:::

::: {#impl-Unpin-for-TransactionStatus .section .impl}
[§](#impl-Unpin-for-TransactionStatus){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-unpin-for-transactionstatus .code-header}
:::

::: {#impl-UnwindSafe-for-TransactionStatus .section .impl}
[§](#impl-UnwindSafe-for-TransactionStatus){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [TransactionStatus](enum.TransactionStatus.html "enum optionstratlib::pnl::TransactionStatus"){.enum} {#impl-unwindsafe-for-transactionstatus .code-header}
:::
:::::::::
