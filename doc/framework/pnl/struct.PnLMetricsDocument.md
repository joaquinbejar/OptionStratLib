...
# Struct [PnLMetricsDocument]{.struct}Copy item path

[[Source](../../src/optionstratlib/pnl/metrics.rs.html#256-269){.src}
]{.sub-heading}
::::
...
This struct encapsulates the PnL metrics, symbol, fees, delta and delta
adjustments.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.days){.anchor
.field}`days: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.days
...
[[§](#structfield.fee){.anchor
.field}`fee: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.fee
.structfield .section-header}
...
[[§](#structfield.delta_adjustment_at){.anchor
.field}`delta_adjustment_at: Decimal`]{#structfield.delta_adjustment_at
.structfield .section-header}
...
[[§](#structfield.metrics){.anchor
.field}`metrics: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`PnLMetricsStep`](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct}`>`]{#structfield.metrics
.structfield .section-header}

::: docblock
- `metrics`: A vector of `PnLMetricsStep` structs, each representing a
  step in the PnL calculation.
:::

## Trait Implementations[§](#trait-implementations){.anchor} {#trait-implementations .section-header}

::::::::::::::::::::::: {#trait-implementations-list}
::: {#impl-Clone-for-PnLMetricsDocument .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#255){.src
.rightside}[§](#impl-Clone-for-PnLMetricsDocument){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-clone-for-pnlmetricsdocument .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#fn-cloneself---pnlmetricsdocument .code-header}
:::
...
::: {#impl-Debug-for-PnLMetricsDocument .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#255){.src
.rightside}[§](#impl-Debug-for-PnLMetricsDocument){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-debug-for-pnlmetricsdocument .code-header}
:::
...
::: {#impl-Deserialize%3C'de%3E-for-PnLMetricsDocument .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#255){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-PnLMetricsDocument){.anchor}

### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#implde-deserializede-for-pnlmetricsdocument .code-header}
:::
...
::: {#impl-Serialize-for-PnLMetricsDocument .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#255){.src
.rightside}[§](#impl-Serialize-for-PnLMetricsDocument){.anchor}

### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-serialize-for-pnlmetricsdocument .code-header}
:::
...
::: {#impl-Freeze-for-PnLMetricsDocument .section .impl}
[§](#impl-Freeze-for-PnLMetricsDocument){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-freeze-for-pnlmetricsdocument .code-header}
:::

::: {#impl-RefUnwindSafe-for-PnLMetricsDocument .section .impl}
[§](#impl-RefUnwindSafe-for-PnLMetricsDocument){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-refunwindsafe-for-pnlmetricsdocument .code-header}
:::

::: {#impl-Send-for-PnLMetricsDocument .section .impl}
[§](#impl-Send-for-PnLMetricsDocument){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-send-for-pnlmetricsdocument .code-header}
:::

::: {#impl-Sync-for-PnLMetricsDocument .section .impl}
[§](#impl-Sync-for-PnLMetricsDocument){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-sync-for-pnlmetricsdocument .code-header}
:::

::: {#impl-Unpin-for-PnLMetricsDocument .section .impl}
[§](#impl-Unpin-for-PnLMetricsDocument){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-unpin-for-pnlmetricsdocument .code-header}
:::

::: {#impl-UnwindSafe-for-PnLMetricsDocument .section .impl}
[§](#impl-UnwindSafe-for-PnLMetricsDocument){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PnLMetricsDocument](struct.PnLMetricsDocument.html "struct optionstratlib::pnl::PnLMetricsDocument"){.struct} {#impl-unwindsafe-for-pnlmetricsdocument .code-header}
:::
:::::::::
