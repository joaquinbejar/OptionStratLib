...
[[§](#structfield.lower){.anchor
.field}`lower: `[`i32`](https://doc.rust-lang.org/1.91.1/std/primitive.i32.html){.primitive}]{#structfield.lower
...
[[§](#structfield.upper){.anchor
.field}`upper: `[`i32`](https://doc.rust-lang.org/1.91.1/std/primitive.i32.html){.primitive}]{#structfield.upper
.structfield .section-header}
...
.rightside}[§](#impl-PnLRange){.anchor}
...
#### pub fn [new](#method.new){.fn}(lower: [i32](https://doc.rust-lang.org/1.91.1/std/primitive.i32.html){.primitive}, upper: [i32](https://doc.rust-lang.org/1.91.1/std/primitive.i32.html){.primitive}) -\> Self {#pub-fn-newlower-i32-upper-i32---self .code-header}
:::
...
#### pub fn [new_decimal](#method.new_decimal){.fn}(lower: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}, upper: [Decimal](../../prelude/struct.Decimal.html "struct optionstratlib::prelude::Decimal"){.struct}) -\> Self {#pub-fn-new_decimallower-decimal-upper-decimal---self .code-header}
:::
...
.rightside}[§](#impl-Clone-for-PnLRange){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-clone-for-pnlrange .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.91.1/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#fn-cloneself---pnlrange .code-header}
:::
...
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-Debug-for-PnLRange){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.91.1/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-debug-for-pnlrange .code-header}
:::
...
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-PnLRange){.anchor}

### impl\<\'de\> [Deserialize](../../../serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize"){.trait}\<\'de\> for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#implde-deserializede-for-pnlrange .code-header}
:::
...
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-Hash-for-PnLRange){.anchor}

### impl [Hash](https://doc.rust-lang.org/1.91.1/core/hash/trait.Hash.html "trait core::hash::Hash"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-hash-for-pnlrange .code-header}
:::
...
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-PartialEq-for-PnLRange){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-partialeq-for-pnlrange .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct}) -\> [bool](https://doc.rust-lang.org/1.91.1/std/primitive.bool.html){.primitive} {#fn-eqself-other-pnlrange---bool .code-header}
:::
...
.rightside}[§](#impl-Serialize-for-PnLRange){.anchor}

### impl [Serialize](../../../serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-serialize-for-pnlrange .code-header}
...
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-Eq-for-PnLRange){.anchor}

### impl [Eq](https://doc.rust-lang.org/1.91.1/core/cmp/trait.Eq.html "trait core::cmp::Eq"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-eq-for-pnlrange .code-header}
:::

::: {#impl-StructuralPartialEq-for-PnLRange .section .impl}
[Source](../../../src/optionstratlib/pnl/model.rs.html#21){.src
.rightside}[§](#impl-StructuralPartialEq-for-PnLRange){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.91.1/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-structuralpartialeq-for-pnlrange .code-header}
:::
::::::::::::::::::::::::::::::::::::::::
...
[§](#impl-Freeze-for-PnLRange){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.91.1/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-freeze-for-pnlrange .code-header}
:::

::: {#impl-RefUnwindSafe-for-PnLRange .section .impl}
[§](#impl-RefUnwindSafe-for-PnLRange){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-refunwindsafe-for-pnlrange .code-header}
:::

::: {#impl-Send-for-PnLRange .section .impl}
[§](#impl-Send-for-PnLRange){.anchor}

### impl [Send](https://doc.rust-lang.org/1.91.1/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-send-for-pnlrange .code-header}
:::

::: {#impl-Sync-for-PnLRange .section .impl}
[§](#impl-Sync-for-PnLRange){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.91.1/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-sync-for-pnlrange .code-header}
:::

::: {#impl-Unpin-for-PnLRange .section .impl}
[§](#impl-Unpin-for-PnLRange){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.91.1/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-unpin-for-pnlrange .code-header}
:::

::: {#impl-UnwindSafe-for-PnLRange .section .impl}
[§](#impl-UnwindSafe-for-PnLRange){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.91.1/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PnLRange](struct.PnLRange.html "struct optionstratlib::pnl::model::PnLRange"){.struct} {#impl-unwindsafe-for-pnlrange .code-header}
:::
:::::::::
