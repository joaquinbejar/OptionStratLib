...
# Struct [PnLMetricsStep]{.struct}Copy item path

[[Source](../../src/optionstratlib/pnl/metrics.rs.html#28-57){.src}
]{.sub-heading}
::::

``` {.rust .item-decl}
pub struct PnLMetricsStep {Show 14 fields
    pub pnl: PnL,
    pub win: bool,
    pub step_number: u32,
...
::: docblock
## [§](#pnlmetricsstep){.doc-anchor}PnLMetricsStep

Represents a single step in a profit and loss (PnL) metrics analysis
simulation.

This structure captures detailed financial performance data for a
specific step in a multi-step simulation of an options trading strategy.
It records not only the basic profit/loss information but also tracks
performance metrics, price changes, and position adjustments that
occurred during this particular step.

This structure is serializable and deserializable through Serde, making
it suitable for persistence and data exchange operations in trading
simulations and backtesting.
:::

## Fields[§](#fields){.anchor} {#fields .fields .section-header}

[[§](#structfield.pnl){.anchor
.field}`pnl: `[`PnL`](utils/struct.PnL.html "struct optionstratlib::pnl::utils::PnL"){.struct}]{#structfield.pnl
.structfield .section-header}

::: docblock
`pnl`: The profit and loss calculation for this step, including realized
and unrealized components.
:::

[[§](#structfield.win){.anchor
.field}`win: `[`bool`](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive}]{#structfield.win
.structfield .section-header}

::: docblock
`win`: A boolean indicating whether this step resulted in a winning
outcome.
:::

[[§](#structfield.step_number){.anchor
.field}`step_number: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.step_number
.structfield .section-header}
...
[[§](#structfield.step_duration){.anchor
.field}`step_duration: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.step_duration
.structfield .section-header}
...
[[§](#structfield.max_unrealized_pnl){.anchor
.field}`max_unrealized_pnl: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.max_unrealized_pnl
.structfield .section-header}

::: docblock
`max_unrealized_pnl`: The maximum unrealized profit and loss observed
during this step.
:::

[[§](#structfield.min_unrealized_pnl){.anchor
.field}`min_unrealized_pnl: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.min_unrealized_pnl
.structfield .section-header}

::: docblock
`min_unrealized_pnl`: The minimum unrealized profit and loss observed
during this step.
:::

[[§](#structfield.winning_steps){.anchor
.field}`winning_steps: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.winning_steps
.structfield .section-header}

::: docblock
`winning_steps`: The cumulative number of winning steps up to this point
in the simulation.
:::

[[§](#structfield.losing_steps){.anchor
.field}`losing_steps: `[`u32`](https://doc.rust-lang.org/1.86.0/std/primitive.u32.html){.primitive}]{#structfield.losing_steps
.structfield .section-header}

::: docblock
`losing_steps`: The cumulative number of losing steps up to this point
in the simulation.
:::

[[§](#structfield.initial_price){.anchor
.field}`initial_price: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.initial_price
.structfield .section-header}
...
[[§](#structfield.final_price){.anchor
.field}`final_price: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.final_price
.structfield .section-header}
...
[[§](#structfield.strikes){.anchor
.field}`strikes: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.strikes
.structfield .section-header}

::: docblock
`strikes`: A vector of strike prices relevant to the options strategy in
this step.
:::

[[§](#structfield.initial_volumes){.anchor
.field}`initial_volumes: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.initial_volumes
.structfield .section-header}

::: docblock
`initial_volumes`: A vector of initial volumes for each option in the
strategy at the start of this step.
:::

[[§](#structfield.final_volumes){.anchor
.field}`final_volumes: `[`Vec`](https://doc.rust-lang.org/1.86.0/alloc/vec/struct.Vec.html "struct alloc::vec::Vec"){.struct}`<`[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}`>`]{#structfield.final_volumes
.structfield .section-header}

::: docblock
`final_volumes`: A vector of final volumes for each option in the
strategy at the end of this step.
:::

[[§](#structfield.delta_adjustments){.anchor
.field}`delta_adjustments: `[`Positive`](../model/positive/struct.Positive.html "struct optionstratlib::model::positive::Positive"){.struct}]{#structfield.delta_adjustments
.structfield .section-header}
...
::: {#impl-Clone-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-Clone-for-PnLMetricsStep){.anchor}

### impl [Clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html "trait core::clone::Clone"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-clone-for-pnlmetricsstep .code-header}
:::
...
#### fn [clone](https://doc.rust-lang.org/1.86.0/core/clone/trait.Clone.html#tymethod.clone){.fn}(&self) -\> [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#fn-cloneself---pnlmetricsstep .code-header}
:::
...
::: {#impl-Debug-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-Debug-for-PnLMetricsStep){.anchor}

### impl [Debug](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-debug-for-pnlmetricsstep .code-header}
:::
...
::: {#impl-Default-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#59-78){.src
.rightside}[§](#impl-Default-for-PnLMetricsStep){.anchor}

### impl [Default](https://doc.rust-lang.org/1.86.0/core/default/trait.Default.html "trait core::default::Default"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-default-for-pnlmetricsstep .code-header}
:::

::::: impl-items
::: {#method.default .section .method .trait-impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#60-77){.src
...
::: {#impl-Deserialize%3C'de%3E-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-Deserialize%3C'de%3E-for-PnLMetricsStep){.anchor}

### impl\<\'de\> [Deserialize](https://docs.rs/serde/1.0.219/serde/de/trait.Deserialize.html "trait serde::de::Deserialize"){.trait}\<\'de\> for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#implde-deserializede-for-pnlmetricsstep .code-header}
:::
...
::: {#impl-Display-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#156-201){.src
.rightside}[§](#impl-Display-for-PnLMetricsStep){.anchor}

### impl [Display](https://doc.rust-lang.org/1.86.0/core/fmt/trait.Display.html "trait core::fmt::Display"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-display-for-pnlmetricsstep .code-header}
:::

::::: impl-items
::: {#method.fmt-1 .section .method .trait-impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#157-200){.src
...
::: {#impl-PartialEq-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-PartialEq-for-PnLMetricsStep){.anchor}

### impl [PartialEq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-partialeq-for-pnlmetricsstep .code-header}
:::
...
#### fn [eq](https://doc.rust-lang.org/1.86.0/core/cmp/trait.PartialEq.html#tymethod.eq){.fn}(&self, other: &[PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct}) -\> [bool](https://doc.rust-lang.org/1.86.0/std/primitive.bool.html){.primitive} {#fn-eqself-other-pnlmetricsstep---bool .code-header}
:::
...
::: {#impl-Serialize-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-Serialize-for-PnLMetricsStep){.anchor}

### impl [Serialize](https://docs.rs/serde/1.0.219/serde/ser/trait.Serialize.html "trait serde::ser::Serialize"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-serialize-for-pnlmetricsstep .code-header}
:::
...
::: {#impl-StructuralPartialEq-for-PnLMetricsStep .section .impl}
[Source](../../src/optionstratlib/pnl/metrics.rs.html#27){.src
.rightside}[§](#impl-StructuralPartialEq-for-PnLMetricsStep){.anchor}

### impl [StructuralPartialEq](https://doc.rust-lang.org/1.86.0/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-structuralpartialeq-for-pnlmetricsstep .code-header}
:::
::::::::::::::::::::::::::::::::::::::
...
::: {#impl-Freeze-for-PnLMetricsStep .section .impl}
[§](#impl-Freeze-for-PnLMetricsStep){.anchor}

### impl [Freeze](https://doc.rust-lang.org/1.86.0/core/marker/trait.Freeze.html "trait core::marker::Freeze"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-freeze-for-pnlmetricsstep .code-header}
:::

::: {#impl-RefUnwindSafe-for-PnLMetricsStep .section .impl}
[§](#impl-RefUnwindSafe-for-PnLMetricsStep){.anchor}

### impl [RefUnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-refunwindsafe-for-pnlmetricsstep .code-header}
:::

::: {#impl-Send-for-PnLMetricsStep .section .impl}
[§](#impl-Send-for-PnLMetricsStep){.anchor}

### impl [Send](https://doc.rust-lang.org/1.86.0/core/marker/trait.Send.html "trait core::marker::Send"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-send-for-pnlmetricsstep .code-header}
:::

::: {#impl-Sync-for-PnLMetricsStep .section .impl}
[§](#impl-Sync-for-PnLMetricsStep){.anchor}

### impl [Sync](https://doc.rust-lang.org/1.86.0/core/marker/trait.Sync.html "trait core::marker::Sync"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-sync-for-pnlmetricsstep .code-header}
:::

::: {#impl-Unpin-for-PnLMetricsStep .section .impl}
[§](#impl-Unpin-for-PnLMetricsStep){.anchor}

### impl [Unpin](https://doc.rust-lang.org/1.86.0/core/marker/trait.Unpin.html "trait core::marker::Unpin"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-unpin-for-pnlmetricsstep .code-header}
:::

::: {#impl-UnwindSafe-for-PnLMetricsStep .section .impl}
[§](#impl-UnwindSafe-for-PnLMetricsStep){.anchor}

### impl [UnwindSafe](https://doc.rust-lang.org/1.86.0/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"){.trait} for [PnLMetricsStep](struct.PnLMetricsStep.html "struct optionstratlib::pnl::PnLMetricsStep"){.struct} {#impl-unwindsafe-for-pnlmetricsstep .code-header}
:::
:::::::::
